...
STIG Check: V-239900
Severity: medium
Rule Title: The Cisco ASA must be configured to automatically audit account removal actions.
STIG ID: CASA-ND-000120
Rule ID: SV-239900r960786
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Cisco ASA must be configured to automatically audit account removal actions.",
