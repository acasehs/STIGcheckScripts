...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Administrators in the role of Security Administrator,  Cryptographic Administrator, or Audit Administrator must not also have the role of Audit Administrator.",
