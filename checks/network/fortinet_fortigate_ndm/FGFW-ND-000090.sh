...
# STIG Check: V-234177
# Severity: medium
# Rule Title: The FortiGate device must generate audit records when concurrent logons from different workstations occur.
# STIG ID: FGFW-ND-000090
# Rule ID: SV-234177r879877
#
# Description:
...
main() {
    ...
    #     echo "PASS: Check FGFW-ND-000090 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check FGFW-ND-000090 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for FGFW-ND-000090"
