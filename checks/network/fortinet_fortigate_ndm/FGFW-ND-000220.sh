...
# STIG Check: V-234203
# Severity: medium
# Rule Title: The FortiGate device must enforce a minimum 15-character password length.
# STIG ID: FGFW-ND-000220
# Rule ID: SV-234203r879601
#
# Description:
#     Password complexity, or strength, is a measure of the effectiveness of a password in resisting attempts at guessing and brute-force attacks. Password length is one factor of several that helps to determine strength and how long it takes to crack a password._x000D_
#     _x000D_
...
#     _x000D_
#     1. Click System._x000D_
#     2. Click Settings._x000D_
#     3. Navigate to Password Policy._x000D_
#     4. Verify Password scope is enabled for Admin._x000D_
#     5. Verify the Minimum length is set to 15._x000D_
#     _x000D_
#     If the Password scope is OFF and the Minimum length is not set to 15, this is a finding._x000D_
#     _x000D_
#     or _x000D_
#     _x000D_
#     Log in to the FortiGate GUI with Super-Admin privilege:_x000D_
#     _x000D_
#     1. Open a CLI console, via SSH or available from the GUI_x000D_
#     2. Run the following command:_x000D_
#          # show full-configuration system password-policy | grep -i minimum_x000D_
#               set minimum-length 15_x000D_
#     _x000D_
...
main() {
    ...
    #     echo "PASS: Check FGFW-ND-000220 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check FGFW-ND-000220 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for FGFW-ND-000220"
    echo "Description: Password complexity, or strength, is a measure of the effectiveness of a password in resisting attempts at guessing and brute-force attacks. Password length is one factor of several that helps to determine strength and how long it takes to crack a password._x000D_
#     _x000D_
#     The shorter the password, the lower the number of possible combinations that need to be tested before the password is compromised. Use of more characters in a password helps to exponentially increase the time and/or resources required to compromise the password."
