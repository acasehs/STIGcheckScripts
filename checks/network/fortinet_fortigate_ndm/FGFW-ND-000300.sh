...
# STIG Check: V-234219
# Severity: medium
# Rule Title: The FortiGate device must limit the number of logon and user sessions.
# STIG ID: FGFW-ND-000300
# Rule ID: SV-234219r917462
#
# Description:
