...
# STIG Check: V-234181
# Severity: medium
# Rule Title: The FortiGate device must off-load audit records on to a different system or media than the system being audited.
# STIG ID: FGFW-ND-000110
# Rule ID: SV-234181r879886
#
# Description:
...
main() {
    ...
    #     echo "PASS: Check FGFW-ND-000110 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check FGFW-ND-000110 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for FGFW-ND-000110"
    echo "Description: Information stored in one location is vulnerable to accidental or incidental deletion or alteration.
#     
#     Offloading is a common process in information systems with limited audit storage capacity."
