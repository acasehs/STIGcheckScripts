# Fortinet FortiGate Firewall NDM STIG Automation Framework

## Overview

This directory contains automation scripts for the **Fortinet FortiGate Firewall NDM** Security Technical Implementation Guide (STIG).

- **Benchmark ID**: FN_FortiGate_Firewall_NDM_STIG
- **Total Checks**: 60
