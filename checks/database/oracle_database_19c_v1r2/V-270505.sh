...
# Severity: medium
# Rule Title: Oracle Database must include organization-defined additional, more det...
#
...
QUERY="SELECT * FROM SYS.UNIFIED_AUDIT_TRAIL WHERE AUDIT_TYPE = 'FineGrainedAudit'"
