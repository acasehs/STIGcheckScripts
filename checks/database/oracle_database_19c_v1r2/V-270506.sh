...
# Severity: medium
# Rule Title: Oracle Database must allocate audit record storage capacity in accorda...
#
...
QUERY="SELECT table_name, tablespace_name FROM dba_tables WHERE table_name IN ('AUD$', 'FGA_LOG$') ORDER BY table_name"
