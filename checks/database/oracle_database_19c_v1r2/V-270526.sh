...
# Severity: medium
# Rule Title: The Oracle password file ownership and permissions should be limited a...
#
...
QUERY="select value from v$parameter where upper(name) = 'REMOTE_LOGIN_PASSWORDFILE'"
