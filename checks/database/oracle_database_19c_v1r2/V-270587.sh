...
# Severity: medium
# Rule Title: Oracle Database must, for password-based authentication, verify that w...
#
...
QUERY="SELECT * FROM SYS.DBA_PROFILES WHERE RESOURCE_NAME = 'PASSWORD_VERIFY_FUNCTION' ORDER BY PROFILE"
