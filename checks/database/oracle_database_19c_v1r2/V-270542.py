...
Check Content:
    View the cman.ora file in the ORACLE_HOME/network/admin directory.  If the file does not exist, the database is not accessed via Oracle Connection Manager and this check is not a finding.  If the entry and value for REMOTE_ADMIN is not listed or is not set to a value of NO (REMOTE_ADMIN = NO), this ...
...
SEVERITY = "medium"
RULE_TITLE = """Remote administration must be disabled for the Oracle connection manager."""
