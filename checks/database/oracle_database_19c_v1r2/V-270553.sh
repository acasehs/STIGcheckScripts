...
# Severity: medium
# Rule Title: Unused database components, database management system (DBMS) software...
#
...
QUERY="SELECT comp_id, comp_name, version, status from dba_registry WHERE comp_id not in ('CATJAVA','CATALOG','CATPROC','SDO','DV','XDB') AND status <> 'OPTION OFF'"
