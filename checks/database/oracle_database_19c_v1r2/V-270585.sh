...
# Severity: high
# Rule Title: Oracle Database software must be evaluated and patched against newly f...
#
...
QUERY="SELECT patch_id, source_version, action, status, description from dba_registry_sqlpatch;"
