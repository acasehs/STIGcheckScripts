...
STIG Check: V-270528
Severity: medium
Rule Title: System Privileges must not be granted to PUBLIC.
STIG ID: O19C-00-009600
Rule ID: SV-270528r1064862

Description:
    System privileges can be granted to users and roles and to the user group PUBLIC. All privileges granted to PUBLIC are accessible to every user in the database. Many of these privileges convey considerable authority over the database and should be granted only to those persons responsible for admini...
...
# Check metadata
VULN_ID = "V-270528"
STIG_ID = "O19C-00-009600"
SEVERITY = "medium"
RULE_TITLE = """System Privileges must not be granted to PUBLIC."""
