...
Check Content:
    IP address restriction may be defined for the database listener, by use of the Oracle Connection Manager or by an external network device.  Identify the method used to enforce address restriction (interview database administrator [DBA]) or review system documentation).  If enforced by the database l...
...
SEVERITY = "medium"
RULE_TITLE = """Network access to Oracle Database must be restricted to authorized personnel."""
