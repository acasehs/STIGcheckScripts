...
# Severity: medium
# Rule Title: Oracle Database default demonstration and sample databases, database o...
#
...
QUERY="select distinct(username) from dba_users where username in ('BI','HR','OE','PM','IX','SH','SCOTT')"
