...
# Severity: medium
# Rule Title: Oracle Database must limit the number of concurrent sessions for each ...
#
...
QUERY="SELECT * FROM SYS.DBA_PROFILES WHERE RESOURCE_NAME = 'SESSIONS_PER_USER'"
