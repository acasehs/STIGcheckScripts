...
STIG ID: CNTR-K8-000320
Rule ID: SV-242386r960792
...
If the setting "--insecure-port" is not set to "0" or is not configured i...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API server must have the insecure port flag disabled.",
