...
STIG ID: CNTR-K8-003320
Rule ID: SV-242465r961863
...
If the setting audit-log-path is not set in the Kubernetes API Server ma...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API Server audit log path must be set.",
