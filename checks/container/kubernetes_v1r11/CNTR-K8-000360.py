...
While there are instances where anonymous connections may be needed (e.g., health ch
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API server must have anonymous authentication disabled.",
