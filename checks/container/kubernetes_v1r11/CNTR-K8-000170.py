...
STIG ID: CNTR-K8-000170
Rule ID: SV-242378r960759
...
If the setting "tls-min-version" is not configured in the Kubernetes AP...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API Server must use TLS 1.2, at a minimum, to protect the confidentiality of sensitive data during electronic dissemination.",
