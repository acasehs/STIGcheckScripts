...
STIG ID: CNTR-K8-001550
Rule ID: SV-242433r1043178
...
The communication session is protected by utilizing tr
...
If the setting "peer-key-file" is not set in the Kubernetes etcd manifest f...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes etcd must have a peer-key-file set for secure communication.",
