...
STIG ID: CNTR-K8-002630
Rule ID: SV-245543r961632
...
If "--token-auth-file" is set in the Kubernetes API server manifest fil...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes API Server must disable token authentication to protect information in transit.",
