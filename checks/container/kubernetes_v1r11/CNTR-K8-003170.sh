...
# STIG ID: CNTR-K8-003170
# Rule ID: SV-242450r961863
#
# Description:
...
#     
#     If the command returns any non root:root file permissions, this is a fin
#
# Exit Codes:
...
main() {
    ...
    #     echo "PASS: Check CNTR-K8-003170 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check CNTR-K8-003170 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for CNTR-K8-003170"
