...
If the setting "cert-file" is not configured in the Kubernetes etcd manifest f...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes etcd must have a certificate for communication.",
