...
If the setting "--etcd-cafile" is not configured in the Kubernetes API Serve...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes etcd must have the SSL Certificate Authority set.",
