...
_x000D_
Run the command:_x000D_
stat -c %a <path_to_client_ca_file>_x000D_
_x000D_
If the client ca file has permissions more permissive than
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes Kubelet certificate authority file must have file permissions set to 644 or more restrictive.",
