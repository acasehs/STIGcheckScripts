...
If the setting "audit-log-maxage" is not set in the Kubernetes API Ser...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API Server audit log retention must be set.",
