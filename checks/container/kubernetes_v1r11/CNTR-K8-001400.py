...
If the setting feature tls-cipher-suites is not set in the Kubernetes ...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API server must use approved cipher suites.",
