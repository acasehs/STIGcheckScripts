...
STIG ID: CNTR-K8-002600
Rule ID: SV-242438r961620
...
If Kubernetes API Server manifest file does not exist, this is a findin...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes API Server must configure timeouts to limit attack surface.",
