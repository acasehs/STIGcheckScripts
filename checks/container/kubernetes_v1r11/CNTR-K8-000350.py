...
If the setting "--secure-port" is set to "0" or is not configured in the Ku...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes API server must have the secure port set.",
