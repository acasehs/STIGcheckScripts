...
STIG ID: CNTR-K8-001450
Rule ID: SV-242423r1043178
...
If the setting client-cert-auth is not configured in the Kubernetes et...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes etcd must enable client authentication to secure service.",
