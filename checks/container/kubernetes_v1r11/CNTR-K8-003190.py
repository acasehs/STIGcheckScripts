...
STIG Check: V-242452
Severity: medium
Rule Title: The Kubernetes kubelet KubeConfig must have file permissions set to 644 or more restrictive.
STIG ID: CNTR-K8-003190
Rule ID: SV-242452r961863
...
If any of the files are have permissions more permissive than "644", this is a fi...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Kubernetes kubelet KubeConfig must have file permissions set to 644 or more restrictive.",
