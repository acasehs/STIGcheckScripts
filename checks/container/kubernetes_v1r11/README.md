# Kubernetes STIG Automation Framework

## Overview

This directory contains automation scripts for the **Kubernetes** Security Technical Implementation Guide (STIG).

- **Benchmark ID**: Kubernetes_STIG
- **Version**: v1r11
- **Platform**: Linux
- **Primary Command**: `kubectl`
...
### Command-Line Tools
- `kubectl` - Primary tool for Kubernetes
...
1. Specific CLI commands for the check (kubectl)
