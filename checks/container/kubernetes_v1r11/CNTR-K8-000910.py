...
If the setting "profiling" is not configured in the Kubernetes Controller Man...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes Controller Manager must disable profiling.",
