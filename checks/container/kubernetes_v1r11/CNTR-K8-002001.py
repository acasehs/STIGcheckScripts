...
_x000D_
To enable PodSecurity admission controller 
...
_x000D_
If the "--feature-gates" option exists, this is a finding. _x000D_
_
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes must enable PodSecurity admission controller on static pods and Kubelets.",
