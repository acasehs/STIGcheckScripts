...
If the setting feature client-ca-file is not set in the Kubernetes API se...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Kubernetes API Server must have the SSL Certificate Authority set.",
