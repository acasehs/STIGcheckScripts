...
STIG Check: V-235813
Severity: high
Rule Title: Docker Enterprise exec commands must not be used with privileged option.
STIG ID: DKER-EE-002080
Rule ID: SV-235813r960963
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise exec commands must not be used with privileged option.",
