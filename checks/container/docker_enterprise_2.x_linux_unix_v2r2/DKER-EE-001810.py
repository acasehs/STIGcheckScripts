...
STIG Check: V-235790
Severity: medium
Rule Title: On Linux, a non-AUFS storage driver in the Docker Engine - Enterprise component of Docker Enterprise must be used.
STIG ID: DKER-EE-001810
Rule ID: SV-235790r960963
...
*NOTE: disabling these capabilities negatively
...
def perform_check(config):
    ...
    # Check Content: This check only applies to the Docker Engine - Enterprise component of Docker Enterprise and only when it is used on a Linux host operating system.

via CLI:

Linux: As a trusted user on the underlyin...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - On Linux, a non-AUFS storage driver in the Docker Engine - Enterprise component of Docker Enterprise must be used.",
