...
If the applied RBAC policy sets in UCP are not configured 
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - A policy set using the built-in role-based access control (RBAC) capabilities in the Universal Control Plane (UCP) component of Docker Enterprise must be configured.",
