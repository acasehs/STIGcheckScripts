...
STIG Check: V-235797
Severity: medium
Rule Title: Periodic data usage and analytics reporting in Universal Control Plane (UCP) must be disabled in Docker Enterprise.
STIG ID: DKER-EE-001910
Rule ID: SV-235797r960963
...
Linux (requires curl and jq): As a Docker EE Admin, execute the following commands on a machine tha
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Periodic data usage and analytics reporting in Universal Control Plane (UCP) must be disabled in Docker Enterprise.",
