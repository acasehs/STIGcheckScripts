...
Linux: As a Docker EE Admin, execute the following commands u...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Only trusted, signed images must be on Universal Control Plane (UCP) in Docker Enterprise.",
