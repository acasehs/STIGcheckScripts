...
STIG Check: V-235817
Severity: high
Rule Title: The Docker Enterprise hosts user namespace must not be shared.
STIG ID: DKER-EE-002120
Rule ID: SV-235817r960963
...
Ensure that it does not return any value for UsernsMode. If it re
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Docker Enterprise hosts user namespace must not be shared.",
