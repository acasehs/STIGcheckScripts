...
STIG Check: V-235854
Severity: medium
Rule Title: Docker Enterprise docker.socket file permissions must be set to 644 or more restrictive.
STIG ID: DKER-EE-005200
Rule ID: SV-235854r961863
...
If the file permissions are not set to 644 or a more restrictive permission, this 
...
def perform_check(config):
    ...
    # Check Content: Ensure that docker.socket file permissions are set to 644 or more restrictive.

Step 1: Find out the file location:

systemctl show -p FragmentPath docker.socket

Step 2: If the file does not exist, t...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise docker.socket file permissions must be set to 644 or more restrictive.",
