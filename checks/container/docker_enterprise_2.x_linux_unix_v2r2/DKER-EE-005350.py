...
STIG Check: V-235869
Severity: high
Rule Title: Docker Enterprise /etc/default/docker file ownership must be set to root:root.
STIG ID: DKER-EE-005350
Rule ID: SV-235869r961863
...
Execute the below command to verify that the file is owned and group-owned...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise /etc/default/docker file ownership must be set to root:root.",
