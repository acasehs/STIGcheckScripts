...
By default, the permissions for Docker server certificate key file might not be 400. The default file permissio
...
def perform_check(config):
    ...
    # Check Content: Ensure that Docker server certificate key file permissions are set to 400.
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise server certificate key file permissions must be set to 400.",
