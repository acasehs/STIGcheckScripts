...
STIG Check: V-235802
Severity: medium
Rule Title: Privileged Linux containers must not be used for Docker Enterprise.
STIG ID: DKER-EE-001960
Rule ID: SV-235802r960963
...
Verify that no containers are run...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Privileged Linux containers must not be used for Docker Enterprise.",
