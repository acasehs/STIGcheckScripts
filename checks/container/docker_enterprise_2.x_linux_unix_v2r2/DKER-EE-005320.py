...
def perform_check(config):
    ...
    # Check Content: Ensure that Docker socket file permissions are set to 660 or more restrictive.
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise socket file permissions must be set to 660 or more restrictive.",
