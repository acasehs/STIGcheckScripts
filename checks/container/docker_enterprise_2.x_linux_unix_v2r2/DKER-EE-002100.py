...
STIG Check: V-235815
Severity: medium
Rule Title: cgroup usage must be confirmed in Docker Enterprise.
STIG ID: DKER-EE-002100
Rule ID: SV-235815r960963
...
If the cgroup is blank, the container is running under defau
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - cgroup usage must be confirmed in Docker Enterprise.",
