...
STIG Check: V-235870
Severity: high
Rule Title: Docker Enterprise /etc/default/docker file permissions must be set to 644 or more restrictive.
STIG ID: DKER-EE-005360
Rule ID: SV-235870r961863
...
def perform_check(config):
    ...
    # Check Content: This requirement applies to Ubuntu Linux systems only. 

Ensure that /etc/default/docker file permissions are set to 644 or more restrictive.

Execute the below command to verify that the file permiss...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise /etc/default/docker file permissions must be set to 644 or more restrictive.",
