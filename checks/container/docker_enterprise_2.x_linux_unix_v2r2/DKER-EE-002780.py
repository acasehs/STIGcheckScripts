...
STIG Check: V-235828
Severity: medium
Rule Title: PIDs cgroup limits must be used in Docker Enterprise.
STIG ID: DKER-EE-002780
Rule ID: SV-235828r961155
...
The Default value for --pids-limit is 0 which means there is no restriction on the number of forks. Also, note tha
...
Ensure that PidsLimit is not set to 0 or -1. A PidsLimit of 0 or -1 means that any number of processes can be forked inside the contai
...
Linux: As a Docker EE Admin, execute the following comm...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - PIDs cgroup limits must be used in Docker Enterprise.",
