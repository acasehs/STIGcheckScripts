...
The UCP component of Docker Enter
...
Linux: Execute the following command and ver
...
def perform_check(config):
    ...
    # Check Content: This check only applies to the UCP component of Docker Enterprise.

Check that UCP has been integrated with a trusted CA.

via UI:

In the UCP web console, navigate to "Admin Settings" | "Certificates...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise Universal Control Plane (UCP) must be integrated with a trusted certificate authority (CA).",
