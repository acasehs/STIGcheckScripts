...
STIG Check: V-235814
Severity: medium
Rule Title: Docker Enterprise exec commands must not be used with the user option.
STIG ID: DKER-EE-002090
Rule ID: SV-235814r960963
...
By default, docker exec command runs without -
...
Ensure docker exec commands are n...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise exec commands must not be used with the user option.",
