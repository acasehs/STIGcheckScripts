...
This control is only configurable for the Docker Engine - Enterprise component of Docker Enterprise as only the Engine includes FIPS-validated cryp
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - FIPS mode must be enabled on all Docker Engine - Enterprise nodes.",
