...
STIG Check: V-235799
Severity: medium
Rule Title: An appropriate AppArmor profile must be enabled on Ubuntu systems for Docker Enterprise.
STIG ID: DKER-EE-001930
Rule ID: SV-235799r960963
...
Verify that all containers include a valid AppArmor Pro
...
def perform_check(config):
    ...
    # Check Content: This check only applies to the use of Docker Engine - Enterprise on the Ubuntu host operating system and should be executed on all nodes in a Docker Enterprise cluster.

Verify that all running contai...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - An appropriate AppArmor profile must be enabled on Ubuntu systems for Docker Enterprise.",
