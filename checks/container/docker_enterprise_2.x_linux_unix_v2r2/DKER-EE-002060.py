...
If the above command returns host, it means the host UTS 
...
Ensure the host's UTS namespace i...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Docker Enterprise hosts UTS namespace must not be shared.",
