...
def perform_check(config):
    ...
    # Check Content: Execute the below command to verify that the directory has permissions of 755 or more restrictive:
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise /etc/docker directory permissions must be set to 755 or more restrictive.",
