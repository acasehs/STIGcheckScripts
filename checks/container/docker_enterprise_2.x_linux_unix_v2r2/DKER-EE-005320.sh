...
# STIG Check: V-235866
# Severity: high
# Rule Title: Docker Enterprise socket file permissions must be set to 660 or more restrictive.
# STIG ID: DKER-EE-005320
# Rule ID: SV-235866r961863
#
# Description:
...
main() {
    ...
    #     echo "PASS: Check DKER-EE-005320 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check DKER-EE-005320 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for DKER-EE-005320"
    echo "Description: Verify that the Docker socket file has permissions of 660 or more restrictive.
#     
#     Only root and members of docker group should be allowed to read and write to default Docker UNIX socket. Hence, the Docket socket file must have permissions of 660 or more restrictive.
#     
#     By default, the permissions for Docker socket file is correctly set to 660."
