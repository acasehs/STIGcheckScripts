...
#     
#     Ask the sys admin to demonstrate how the login driver that is being used is configured to send log events to
#
# Exit Codes:
...
main() {
    ...
    #     echo "PASS: Check DKER-EE-003320 - Compliant"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "PASS" "Compliant" "$output"
    #     exit 0
    # else
    #     echo "FAIL: Check DKER-EE-003320 - Finding"
    #     [[ -n "$OUTPUT_JSON" ]] && output_json "FAIL" "Non-compliant" "$output"
    #     exit 1
    # fi

    echo "TODO: Implement check logic for DKER-EE-003320"
