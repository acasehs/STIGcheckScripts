...
STIG Check: V-235798
Severity: medium
Rule Title: Periodic data usage and analytics reporting in Docker Trusted Registry (DTR) must be disabled in Docker Enterprise.
STIG ID: DKER-EE-001920
Rule ID: SV-235798r960963
...
curl -k -H "Authorization: Bearer $AUTHTOKEN"" -X GET ""https://[dtr_url]/api/v0/meta/se
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Periodic data usage and analytics reporting in Docker Trusted Registry (DTR) must be disabled in Docker Enterprise.",
