...
STIG Check: V-235825
Severity: medium
Rule Title: The Lifetime Minutes and Renewal Threshold Minutes Login Session Controls must be set to 10 and 0 respectively in Docker Enterprise.
STIG ID: DKER-EE-002490
Rule ID: SV-235825r961068
...
Check Content:
    Verify that the "Lifetime Minutes" and "Renewal Threshold Minutes" Login Session Controls in the Universal Control Plane (UCP) Admin Settings to "10" and "0" respectively.
...
Linux (requires curl and jq): As a Docker EE Admin, execute the follow
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The Lifetime Minutes and Renewal Threshold Minutes Login Session Controls must be set to 10 and 0 respectively in Docker Enterprise.",
