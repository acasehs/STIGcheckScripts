...
This is potentially dangerous. It allows the container process to open low-numbered ports like any other root process. It also allows the container to access net
...
def perform_check(config):
    ...
    # Check Content: Ensure the host's network namespace is not shared.
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise hosts network namespace must not be shared.",
