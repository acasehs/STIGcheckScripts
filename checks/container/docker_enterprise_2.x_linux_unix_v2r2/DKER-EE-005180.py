...
STIG Check: V-235852
Severity: medium
Rule Title: Docker Enterprise docker.service file permissions must be set to 644 or more restrictive.
STIG ID: DKER-EE-005180
Rule ID: SV-235852r961863
...
If the file permissions are not set to 644 or a more restrictive permission, 
...
def perform_check(config):
    ...
    # Check Content: Ensure that docker.service file permissions are set to 644 or more restrictive.

Step 1: Find out the file location:

systemctl show -p FragmentPath docker.service

Step 2: If the file does not exist,...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise docker.service file permissions must be set to 644 or more restrictive.",
