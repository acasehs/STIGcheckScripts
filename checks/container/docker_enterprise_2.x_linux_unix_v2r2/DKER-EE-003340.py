...
STIG Check: V-235835
Severity: medium
Rule Title: Log aggregation/SIEM systems must be configured to notify SA and ISSO on Docker Engine - Enterprise audit failure events.
STIG ID: DKER-EE-003340
Rule ID: SV-235835r961401
...
def perform_check(config):
    ...
    # STIG ID: DKER-EE-003340
    # Check Type: unknown
    # Check Content: Work with the SIEM administrator to determine if an alert is configured to notify the SA and ISSO when audit failure events occur.
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Log aggregation/SIEM systems must be configured to notify SA and ISSO on Docker Engine - Enterprise audit failure events.",
