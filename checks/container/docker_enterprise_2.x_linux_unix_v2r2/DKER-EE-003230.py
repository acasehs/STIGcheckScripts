...
Verify that the "log-driver" property is set to one o...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - An appropriate Docker Engine - Enterprise log driver plugin must be configured to collect audit events from Universal Control Plane (UCP) and Docker Trusted Registry (DTR).",
