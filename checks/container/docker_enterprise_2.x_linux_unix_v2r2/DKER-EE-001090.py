...
STIG Check: V-235779
Severity: medium
Rule Title: The host operating systems auditing policies for the Docker Engine - Enterprise component of Docker Enterprise must be set.
STIG ID: DKER-EE-001090
Rule ID: SV-235779r960765
...
auditctl -l | grep -e /usr/bin/docker -e /var/lib/docker -e /etc/docker -e /etc/default/do
...
def perform_check(config):
    ...
    # Check Content: This check only applies to the underlying host operating system on which the Docker Engine - Enterprise instance is running.

Verify that the auditing capabilities provided by the underlying host have...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The host operating systems auditing policies for the Docker Engine - Enterprise component of Docker Enterprise must be set.",
