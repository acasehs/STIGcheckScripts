...
Satisfies: SRG-APP-000149, SRG-APP-000150, SRG-APP-000151, SRG-APP-000152, SRG-APP-000153, SRG-APP-000391, SRG-APP-000
...
Linux (requires curl and jq): As a Docker EE Admin, execute the following commands from a machine with connectivity to the UCP management console. Replace [ucp_url]
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - SAML integration must be enabled in Docker Enterprise.",
