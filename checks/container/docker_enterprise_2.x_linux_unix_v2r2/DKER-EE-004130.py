...
def perform_check(config):
    ...
    # Check Content: Verify that all outdated UCP and DTR container images have been removed from all nodes in the cluster.
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise older Universal Control Plane (UCP) and Docker Trusted Registry (DTR) images must be removed from all cluster nodes upon upgrading.",
