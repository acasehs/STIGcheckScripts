...
STIG Check: V-235868
Severity: high
Rule Title: Docker Enterprise daemon.json file permissions must be set to 644 or more restrictive.
STIG ID: DKER-EE-005340
Rule ID: SV-235868r961863
...
def perform_check(config):
    ...
    # Check Content: The docker.daemon file is not created on installation and must be created. Ensure that daemon.json file permissions are set to 644 or more restrictive.

Execute the below command to verify that the fi...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Docker Enterprise daemon.json file permissions must be set to 644 or more restrictive.",
