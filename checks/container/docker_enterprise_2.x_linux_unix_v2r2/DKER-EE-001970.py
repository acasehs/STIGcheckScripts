...
STIG Check: V-235803
Severity: medium
Rule Title: SSH must not run within Linux containers for Docker Enterprise.
STIG ID: DKER-EE-001970
Rule ID: SV-235803r960963
...
- It is possible to have shell access to a container w
...
Verify that no running containers...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - SSH must not run within Linux containers for Docker Enterprise.",
