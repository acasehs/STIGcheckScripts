...
STIG Check: V-235816
Severity: high
Rule Title: All Docker Enterprise containers must be restricted from acquiring additional privileges.
STIG ID: DKER-EE-002110
Rule ID: SV-235816r960963
...
no_new_priv prevents LSMs like SELinux from transiti
...
Ensure all containers are restric...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - All Docker Enterprise containers must be restricted from acquiring additional privileges.",
