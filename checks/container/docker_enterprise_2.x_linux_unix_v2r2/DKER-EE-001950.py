...
docker ps --quiet --all | xargs docker inspect --format '{{ .Id }}: C
...
Verify that the added and dropped...
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - Linux Kernel capabilities must be restricted within containers as defined in the System Security Plan (SSP) for Docker Enterprise.",
