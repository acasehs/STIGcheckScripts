...
STIG Check: V-265885
Severity: high
Rule Title: The version of Docker Enterprise Edition running on the system must be a supported version.
STIG ID: DKER-EE-999999
Rule ID: SV-265885r999859
...
def perform_check(config):
    ...
    # STIG ID: DKER-EE-999999
    # Check Type: unknown
    # Check Content: Docker Enterprise Edition 2.x is no longer supported by the vendor. If the system is running Docker Enterprise Edition 2.x, this is a finding....
...
def main():
    parser = argparse.ArgumentParser(
        description=f"STIG Check {STIG_ID} - The version of Docker Enterprise Edition running on the system must be a supported version.",
