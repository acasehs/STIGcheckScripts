...
If temporary accounts are used, OL 8 must be configured t
#
# Check Content:
...
main() {
    ...
    echo "Rule: OL 8 temporary user accounts must be provisioned with an expiration time of 72 hours or less."
