...
#
# Check Content:
#     Verify OL 8 restricts the use of "ptrace" to descendant processes with the following commands:    $ sudo sysctl kernel.yama.ptrace_scope    kernel.yama.ptrace_scope = 1    If the returned line does not have a value of "1" or a line is not returned, this is a finding.  Check that the configuration fi...
#
# Exit Codes:
...
echo "TODO: Implement check for V-248890"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must restrict the use of "ptrace" to descendant processes.",
  "status": "$STATUS",
