...
echo "TODO: Implement check for V-248613"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must not permit direct logons to the root account using remote access via SSH.",
  "status": "$STATUS",
