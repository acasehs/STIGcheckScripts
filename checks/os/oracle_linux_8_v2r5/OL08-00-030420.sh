...
The \"creat\" system call is used to op
#
# Check Content:
...
main() {
    ...
    echo "Rule: OL 8 must generate audit records for any use of the \"truncate\", \"ftruncate\", \"creat\", \"open\", \"openat\", and \"open_by_handle_at\" system calls."
