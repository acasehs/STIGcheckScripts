...
echo "TODO: Implement check for V-248647"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "All OL 8 files and directories must have a valid group owner.",
  "status": "$STATUS",
