# Oracle Linux 8 v2r5 - STIG Automation Framework

## Overview

Automated STIG compliance checks for **Oracle Linux 8 Version 2 Release 5**.
...
1. Domain expertise for Oracle Linux 8
...
1. Open the check script (V-248519.sh or V-248519.py)
...
oracle_linux_8_v2r5/
├── README.md (this file)
├── V-248519.sh (bash check)
├── V-248519.py (python check)
└── ... (374 checks total)
```
