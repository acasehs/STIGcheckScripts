...
echo "TODO: Implement check for V-248650"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must not allow users to override SSH environment variables.",
  "status": "$STATUS",
