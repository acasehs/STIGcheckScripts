...
echo "TODO: Implement check for V-248715"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must not allow blank or null passwords in the system-auth file.",
  "status": "$STATUS",
