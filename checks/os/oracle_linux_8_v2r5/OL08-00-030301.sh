...
When a user logs on, the AUID is set to the UID of the account that is being aut
#
# Check Content:
...
main() {
    ...
    echo "Rule: OL 8 must generate audit records for any use of the \"umount\" command."
