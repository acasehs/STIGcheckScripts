...
echo "TODO: Implement check for V-248716"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must not allow blank or null passwords in the password-auth file.",
  "status": "$STATUS",
