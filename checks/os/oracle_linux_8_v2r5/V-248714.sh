...
echo "TODO: Implement check for V-248714"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 8 must not allow accounts configured with blank or null passwords.",
  "status": "$STATUS",
