...
def main():
    parser = argparse.ArgumentParser(description='Windows 11 must use multifactor authentication for local and network access to privileged and nonprivileged accounts.')
