...
Authentication Policy Change records events related to chan
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Policy Change - Authentication Policy Change successes.')
