...
Sensitive Privilege Use records events related to use of se
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Privilege Use - Sensitive Privilege Use successes.')
