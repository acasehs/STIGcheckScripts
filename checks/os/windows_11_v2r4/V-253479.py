...
def main():
    parser = argparse.ArgumentParser(description='The "Access Credential Manager as a trusted caller" user right must not be assigned to any groups or accounts.')
