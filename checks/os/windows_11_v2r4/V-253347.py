...
Audit Detailed File Share allows the user to audit attempts
...
def main():
    parser = argparse.ArgumentParser(description='Windows 11 must be configured to audit Detailed File Share Failures.')
