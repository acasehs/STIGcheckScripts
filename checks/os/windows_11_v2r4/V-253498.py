...
def main():
    parser = argparse.ArgumentParser(description='The "Impersonate a client after authentication" user right must only be assigned to Administrators, Service, Local Service, and Network Service.')
