...
Security System Extension records events related to extensi
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit System - Security System Extension successes.')
