...
Logon records user logons. If this is an interactive logon,
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Logon/Logoff - Logon successes.')
