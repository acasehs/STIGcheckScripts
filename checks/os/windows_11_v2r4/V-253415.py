...
Enabling PowerShell Transcription will record detailed info
...
def main():
    parser = argparse.ArgumentParser(description='PowerShell Transcription must be enabled on Windows 11.')
