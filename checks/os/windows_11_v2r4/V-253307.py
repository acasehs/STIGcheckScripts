...
Credential validation records events related to validation 
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Account Logon - Credential Validation successes.')
