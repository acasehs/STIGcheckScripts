...
Enabling "Include command line data for process creation ev
...
def main():
    parser = argparse.ArgumentParser(description='Command line data must be included in process creation events.')
