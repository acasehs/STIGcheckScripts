...
System Integrity records events related to violations of in
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit System - System Integrity successes.')
