...
Logoff records user logoffs. If this is an interactive logo
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Logon/Logoff - Logoff successes.')
