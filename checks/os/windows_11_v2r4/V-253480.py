...
def main():
    parser = argparse.ArgumentParser(description='The "Access this computer from the network" user right must only be assigned to the Administrators and Remote Desktop Users groups.')
