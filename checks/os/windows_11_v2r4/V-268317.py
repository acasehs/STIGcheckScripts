...
Severity: medium
Rule Title: Copilot in Windows must be disabled for Windows 11
...
def main():
    parser = argparse.ArgumentParser(description='Copilot in Windows must be disabled for Windows 11')
