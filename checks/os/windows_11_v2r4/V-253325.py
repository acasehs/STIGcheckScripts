...
Audit Policy Change records events related to changes in au
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Policy Change - Audit Policy Change successes.')
