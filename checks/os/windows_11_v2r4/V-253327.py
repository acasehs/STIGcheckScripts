...
Authorization Policy Change records events related to chang
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Policy Change - Authorization Policy Change successes.')
