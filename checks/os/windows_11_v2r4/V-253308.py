...
Security Group Management records events such as creating, 
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Account Management - Security Group Management successes.')
