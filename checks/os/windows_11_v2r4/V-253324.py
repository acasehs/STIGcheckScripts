...
Auditing object access for removable media records events r
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Object Access - Removable Storage successes.')
