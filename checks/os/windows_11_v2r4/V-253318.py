...
Special Logon records special logons which have administrat
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Logon/Logoff - Special Logon successes.')
