...
.EXAMPLE
    .\V-254441.ps1
    .\V-254441.ps1 -ConfigFile stig-config.json
    .\V-254441.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254441"
$Severity = "high"
$StigID = "WN22-MS-000140"
$RuleTitle = "Windows Server 2022 must be running Credential Guard on domain-joined member servers."
