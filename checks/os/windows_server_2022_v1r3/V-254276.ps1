...
.EXAMPLE
    .\V-254276.ps1
    .\V-254276.ps1 -ConfigFile stig-config.json
    .\V-254276.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254276"
$Severity = "medium"
$StigID = "WN22-00-000390"
$RuleTitle = "Windows Server 2022 must have the Server Message Block (SMB) v1 protocol disabled on the SMB server."
