...
.EXAMPLE
    .\V-254396.ps1
    .\V-254396.ps1 -ConfigFile stig-config.json
    .\V-254396.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254396"
$Severity = "medium"
$StigID = "WN22-DC-000120"
$RuleTitle = "Windows Server 2022 data files owned by users must be on a different logical partition from the directory server data files."
