...
.EXAMPLE
    .\V-254486.ps1
    .\V-254486.ps1 -ConfigFile stig-config.json
    .\V-254486.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254486"
$Severity = "medium"
$StigID = "WN22-SO-000420"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must be configured to detect application installations and prompt for elevation."
