...
.EXAMPLE
    .\V-254369.ps1
    .\V-254369.ps1 -ConfigFile stig-config.json
    .\V-254369.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254369"
$Severity = "medium"
$StigID = "WN22-CC-000380"
$RuleTitle = "Windows Server 2022 Remote Desktop Services must be configured with the client connection encryption set to High Level."
