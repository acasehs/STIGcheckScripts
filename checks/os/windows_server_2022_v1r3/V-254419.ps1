...
# TODO: Implement check logic for V-254419
Write-Host "TODO: Implement check for V-254419"
Write-Host "Rule: Windows Server 2022 Add workstations to domain user right must only be assigned to the Administrator"
exit 3
