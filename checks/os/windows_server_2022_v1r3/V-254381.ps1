...
.EXAMPLE
    .\V-254381.ps1
    .\V-254381.ps1 -ConfigFile stig-config.json
    .\V-254381.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254381"
$Severity = "high"
$StigID = "WN22-CC-000500"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) service must not use Basic authentication."
