...
.EXAMPLE
    .\V-254483.ps1
    .\V-254483.ps1 -ConfigFile stig-config.json
    .\V-254483.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254483"
$Severity = "medium"
$StigID = "WN22-SO-000390"
$RuleTitle = "Windows Server 2022 UIAccess applications must not be allowed to prompt for elevation without using the secure desktop."
