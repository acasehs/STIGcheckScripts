...
.EXAMPLE
    .\V-254451.ps1
    .\V-254451.ps1 -ConfigFile stig-config.json
    .\V-254451.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254451"
$Severity = "medium"
$StigID = "WN22-SO-000070"
$RuleTitle = "Windows Server 2022 setting Domain member: Digitally encrypt secure channel data (when possible) must be configured to Enabled."
