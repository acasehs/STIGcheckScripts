...
.EXAMPLE
    .\V-254431.ps1
    .\V-254431.ps1 -ConfigFile stig-config.json
    .\V-254431.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254431"
$Severity = "medium"
$StigID = "WN22-MS-000040"
$RuleTitle = "Windows Server 2022 must restrict unauthenticated Remote Procedure Call (RPC) clients from connecting to the RPC server on domain-joined member servers and standalone or nondomain-joined systems."
