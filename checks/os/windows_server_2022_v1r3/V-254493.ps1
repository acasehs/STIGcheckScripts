...
# TODO: Implement check logic for V-254493
Write-Host "TODO: Implement check for V-254493"
Write-Host "Rule: Windows Server 2022 Allow log on locally user right must only be assigned to the Administrators grou"
exit 3
