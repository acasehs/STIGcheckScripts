...
.EXAMPLE
    .\V-254488.ps1
    .\V-254488.ps1 -ConfigFile stig-config.json
    .\V-254488.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254488"
$Severity = "medium"
$StigID = "WN22-SO-000440"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must run all administrators in Admin Approval Mode, enabling UAC."
