...
.EXAMPLE
    .\V-254335.ps1
    .\V-254335.ps1 -ConfigFile stig-config.json
    .\V-254335.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254335"
$Severity = "low"
$StigID = "WN22-CC-000030"
$RuleTitle = "Windows Server 2022 Internet Protocol version 6 (IPv6) source routing must be configured to the highest protection level to prevent IP source routing."
