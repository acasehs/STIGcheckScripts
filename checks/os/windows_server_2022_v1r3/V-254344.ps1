...
.EXAMPLE
    .\V-254344.ps1
    .\V-254344.ps1 -ConfigFile stig-config.json
    .\V-254344.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254344"
$Severity = "medium"
$StigID = "WN22-CC-000130"
$RuleTitle = "Windows Server 2022 Early Launch Antimalware, Boot-Start Driver Initialization Policy must prevent boot drivers identified as bad."
