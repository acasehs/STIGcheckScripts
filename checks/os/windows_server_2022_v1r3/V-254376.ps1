...
.EXAMPLE
    .\V-254376.ps1
    .\V-254376.ps1 -ConfigFile stig-config.json
    .\V-254376.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254376"
$Severity = "medium"
$StigID = "WN22-CC-000450"
$RuleTitle = "Windows Server 2022 must disable automatically signing in the last interactive user after a system-initiated restart."
