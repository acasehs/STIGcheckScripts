...
.EXAMPLE
    .\V-254375.ps1
    .\V-254375.ps1 -ConfigFile stig-config.json
    .\V-254375.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254375"
$Severity = "medium"
$StigID = "WN22-CC-000440"
$RuleTitle = "Windows Server 2022 users must be notified if a web-based program attempts to install software."
