...
.EXAMPLE
    .\V-254489.ps1
    .\V-254489.ps1 -ConfigFile stig-config.json
    .\V-254489.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254489"
$Severity = "medium"
$StigID = "WN22-SO-000450"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must virtualize file and registry write failures to per-user locations."
