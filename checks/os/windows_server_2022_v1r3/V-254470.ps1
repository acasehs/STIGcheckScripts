...
.EXAMPLE
    .\V-254470.ps1
    .\V-254470.ps1 -ConfigFile stig-config.json
    .\V-254470.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254470"
$Severity = "medium"
$StigID = "WN22-SO-000260"
$RuleTitle = "Windows Server 2022 services using Local System that use Negotiate when reverting to NTLM authentication must use the computer identity instead of authenticating anonymously."
