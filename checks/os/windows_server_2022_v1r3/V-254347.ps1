...
.EXAMPLE
    .\V-254347.ps1
    .\V-254347.ps1 -ConfigFile stig-config.json
    .\V-254347.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254347"
$Severity = "medium"
$StigID = "WN22-CC-000160"
$RuleTitle = "Windows Server 2022 printing over HTTP must be turned off."
