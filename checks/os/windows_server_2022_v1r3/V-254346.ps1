...
.EXAMPLE
    .\V-254346.ps1
    .\V-254346.ps1 -ConfigFile stig-config.json
    .\V-254346.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254346"
$Severity = "medium"
$StigID = "WN22-CC-000150"
$RuleTitle = "Windows Server 2022 downloading print driver packages over HTTP must be turned off."
