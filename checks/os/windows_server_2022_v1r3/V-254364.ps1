...
.EXAMPLE
    .\V-254364.ps1
    .\V-254364.ps1 -ConfigFile stig-config.json
    .\V-254364.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254364"
$Severity = "medium"
$StigID = "WN22-CC-000330"
$RuleTitle = "Windows Server 2022 File Explorer shell protocol must run in protected mode."
