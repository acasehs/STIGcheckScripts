...
.EXAMPLE
    .\V-254382.ps1
    .\V-254382.ps1 -ConfigFile stig-config.json
    .\V-254382.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254382"
$Severity = "medium"
$StigID = "WN22-CC-000510"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) service must not allow unencrypted traffic."
