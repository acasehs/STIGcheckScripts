...
.EXAMPLE
    .\V-254367.ps1
    .\V-254367.ps1 -ConfigFile stig-config.json
    .\V-254367.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254367"
$Severity = "medium"
$StigID = "WN22-CC-000360"
$RuleTitle = "Windows Server 2022 Remote Desktop Services must always prompt a client for passwords upon connection."
