...
.EXAMPLE
    .\V-254356.ps1
    .\V-254356.ps1 -ConfigFile stig-config.json
    .\V-254356.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254356"
$Severity = "medium"
$StigID = "WN22-CC-000250"
$RuleTitle = "Windows Server 2022 Diagnostic Data must be configured to send "required diagnostic data" or "optional diagnostic data"."
