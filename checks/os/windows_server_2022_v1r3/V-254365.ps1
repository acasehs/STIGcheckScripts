...
.EXAMPLE
    .\V-254365.ps1
    .\V-254365.ps1 -ConfigFile stig-config.json
    .\V-254365.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254365"
$Severity = "medium"
$StigID = "WN22-CC-000340"
$RuleTitle = "Windows Server 2022 must not save passwords in the Remote Desktop Client."
