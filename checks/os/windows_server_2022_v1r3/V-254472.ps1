...
.EXAMPLE
    .\V-254472.ps1
    .\V-254472.ps1 -ConfigFile stig-config.json
    .\V-254472.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254472"
$Severity = "medium"
$StigID = "WN22-SO-000280"
$RuleTitle = "Windows Server 2022 must prevent PKU2U authentication using online identities."
