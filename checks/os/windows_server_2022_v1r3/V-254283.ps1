...
# TODO: Implement check logic for V-254283
Write-Host "TODO: Implement check for V-254283"
Write-Host "Rule: Windows Server 2022 systems must have Unified Extensible Firmware Interface (UEFI) firmware and be c"
exit 3
