...
.EXAMPLE
    .\V-254480.ps1
    .\V-254480.ps1 -ConfigFile stig-config.json
    .\V-254480.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254480"
$Severity = "medium"
$StigID = "WN22-SO-000360"
$RuleTitle = "Windows Server 2022 must be configured to use FIPS-compliant algorithms for encryption, hashing, and signing."
