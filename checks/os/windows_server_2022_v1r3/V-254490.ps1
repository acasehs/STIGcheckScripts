...
.EXAMPLE
    .\V-254490.ps1
    .\V-254490.ps1 -ConfigFile stig-config.json
    .\V-254490.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254490"
$Severity = "medium"
$StigID = "WN22-UC-000010"
$RuleTitle = "Windows Server 2022 must preserve zone information when saving attachments."
