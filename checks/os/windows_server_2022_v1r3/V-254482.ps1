...
.EXAMPLE
    .\V-254482.ps1
    .\V-254482.ps1 -ConfigFile stig-config.json
    .\V-254482.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254482"
$Severity = "medium"
$StigID = "WN22-SO-000380"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) approval mode for the built-in Administrator must be enabled."
