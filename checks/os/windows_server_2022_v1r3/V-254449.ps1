...
.EXAMPLE
    .\V-254449.ps1
    .\V-254449.ps1 -ConfigFile stig-config.json
    .\V-254449.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254449"
$Severity = "medium"
$StigID = "WN22-SO-000050"
$RuleTitle = "Windows Server 2022 must force audit policy subcategory settings to override audit policy category settings."
