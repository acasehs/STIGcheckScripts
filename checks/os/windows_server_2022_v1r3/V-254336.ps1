...
.EXAMPLE
    .\V-254336.ps1
    .\V-254336.ps1 -ConfigFile stig-config.json
    .\V-254336.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254336"
$Severity = "low"
$StigID = "WN22-CC-000040"
$RuleTitle = "Windows Server 2022 source routing must be configured to the highest protection level to prevent Internet Protocol (IP) source routing."
