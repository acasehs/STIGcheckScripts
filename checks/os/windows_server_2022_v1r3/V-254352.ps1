...
.EXAMPLE
    .\V-254352.ps1
    .\V-254352.ps1 -ConfigFile stig-config.json
    .\V-254352.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254352"
$Severity = "high"
$StigID = "WN22-CC-000210"
$RuleTitle = "Windows Server 2022 Autoplay must be turned off for nonvolume devices."
