...
.EXAMPLE
    .\V-254378.ps1
    .\V-254378.ps1 -ConfigFile stig-config.json
    .\V-254378.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254378"
$Severity = "high"
$StigID = "WN22-CC-000470"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) client must not use Basic authentication."
