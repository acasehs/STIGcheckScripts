...
.EXAMPLE
    .\V-254355.ps1
    .\V-254355.ps1 -ConfigFile stig-config.json
    .\V-254355.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254355"
$Severity = "medium"
$StigID = "WN22-CC-000240"
$RuleTitle = "Windows Server 2022 administrator accounts must not be enumerated during elevation."
