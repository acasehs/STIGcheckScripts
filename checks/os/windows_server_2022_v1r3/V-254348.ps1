...
.EXAMPLE
    .\V-254348.ps1
    .\V-254348.ps1 -ConfigFile stig-config.json
    .\V-254348.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254348"
$Severity = "medium"
$StigID = "WN22-CC-000170"
$RuleTitle = "Windows Server 2022 network selection user interface (UI) must not be displayed on the logon screen."
