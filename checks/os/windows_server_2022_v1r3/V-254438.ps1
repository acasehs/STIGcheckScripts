...
# TODO: Implement check logic for V-254438
Write-Host "TODO: Implement check for V-254438"
Write-Host "Rule: Windows Server 2022 Deny log on locally user right on domain-joined member servers must be configure"
exit 3
