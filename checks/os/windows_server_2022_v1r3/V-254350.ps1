...
.EXAMPLE
    .\V-254350.ps1
    .\V-254350.ps1 -ConfigFile stig-config.json
    .\V-254350.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254350"
$Severity = "medium"
$StigID = "WN22-CC-000190"
$RuleTitle = "Windows Server 2022 users must be prompted to authenticate when the system wakes from sleep (plugged in)."
