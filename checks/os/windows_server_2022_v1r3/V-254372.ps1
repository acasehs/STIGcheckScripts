...
.EXAMPLE
    .\V-254372.ps1
    .\V-254372.ps1 -ConfigFile stig-config.json
    .\V-254372.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254372"
$Severity = "medium"
$StigID = "WN22-CC-000410"
$RuleTitle = "Windows Server 2022 must prevent Indexing of encrypted files."
