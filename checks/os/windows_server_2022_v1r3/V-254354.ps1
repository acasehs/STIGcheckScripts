...
.EXAMPLE
    .\V-254354.ps1
    .\V-254354.ps1 -ConfigFile stig-config.json
    .\V-254354.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254354"
$Severity = "high"
$StigID = "WN22-CC-000230"
$RuleTitle = "Windows Server 2022 AutoPlay must be disabled for all drives."
