...
.EXAMPLE
    .\V-254473.ps1
    .\V-254473.ps1 -ConfigFile stig-config.json
    .\V-254473.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254473"
$Severity = "medium"
$StigID = "WN22-SO-000290"
$RuleTitle = "Windows Server 2022 Kerberos encryption types must be configured to prevent the use of DES and RC4 encryption suites."
