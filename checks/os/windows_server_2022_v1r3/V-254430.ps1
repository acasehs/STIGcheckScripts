...
.EXAMPLE
    .\V-254430.ps1
    .\V-254430.ps1 -ConfigFile stig-config.json
    .\V-254430.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254430"
$Severity = "medium"
$StigID = "WN22-MS-000030"
$RuleTitle = "Windows Server 2022 local users on domain-joined member servers must not be enumerated."
