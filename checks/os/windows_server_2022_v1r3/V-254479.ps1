...
.EXAMPLE
    .\V-254479.ps1
    .\V-254479.ps1 -ConfigFile stig-config.json
    .\V-254479.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254479"
$Severity = "medium"
$StigID = "WN22-SO-000350"
$RuleTitle = "Windows Server 2022 users must be required to enter a password to access private keys stored on the computer."
