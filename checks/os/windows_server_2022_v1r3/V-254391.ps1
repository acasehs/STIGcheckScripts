...
.EXAMPLE
    .\V-254391.ps1
    .\V-254391.ps1 -ConfigFile stig-config.json
    .\V-254391.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$RuleTitle = "Windows Server 2022 permissions on the Active Directory data files must only allow System and Administrators access."
