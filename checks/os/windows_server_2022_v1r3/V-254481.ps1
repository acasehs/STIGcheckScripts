...
.EXAMPLE
    .\V-254481.ps1
    .\V-254481.ps1 -ConfigFile stig-config.json
    .\V-254481.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254481"
$Severity = "low"
$StigID = "WN22-SO-000370"
$RuleTitle = "Windows Server 2022 default permissions of global system objects must be strengthened."
