...
# TODO: Implement check logic for V-254420
Write-Host "TODO: Implement check for V-254420"
Write-Host "Rule: Windows Server 2022 Allow log on through Remote Desktop Services user right must only be assigned to"
exit 3
