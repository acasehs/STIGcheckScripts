...
.EXAMPLE
    .\V-254467.ps1
    .\V-254467.ps1 -ConfigFile stig-config.json
    .\V-254467.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254467"
$Severity = "high"
$StigID = "WN22-SO-000230"
$RuleTitle = "Windows Server 2022 must not allow anonymous enumeration of shares."
