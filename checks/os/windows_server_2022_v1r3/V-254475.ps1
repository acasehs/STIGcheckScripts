...
.EXAMPLE
    .\V-254475.ps1
    .\V-254475.ps1 -ConfigFile stig-config.json
    .\V-254475.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254475"
$Severity = "high"
$StigID = "WN22-SO-000310"
$RuleTitle = "Windows Server 2022 LAN Manager authentication level must be configured to send NTLMv2 response only and to refuse LM and NTLM."
