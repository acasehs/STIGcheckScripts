...
.EXAMPLE
    .\V-254417.ps1
    .\V-254417.ps1 -ConfigFile stig-config.json
    .\V-254417.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254417"
$Severity = "medium"
$StigID = "WN22-DC-000330"
$RuleTitle = "Windows Server 2022 domain controllers must be configured to allow reset of machine account passwords."
