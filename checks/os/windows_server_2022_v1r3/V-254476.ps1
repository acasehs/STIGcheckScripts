...
.EXAMPLE
    .\V-254476.ps1
    .\V-254476.ps1 -ConfigFile stig-config.json
    .\V-254476.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254476"
$Severity = "medium"
$StigID = "WN22-SO-000320"
$RuleTitle = "Windows Server 2022 must be configured to at least negotiate signing for LDAP client signing."
