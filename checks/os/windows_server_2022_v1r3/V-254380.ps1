...
.EXAMPLE
    .\V-254380.ps1
    .\V-254380.ps1 -ConfigFile stig-config.json
    .\V-254380.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254380"
$Severity = "medium"
$StigID = "WN22-CC-000490"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) client must not use Digest authentication."
