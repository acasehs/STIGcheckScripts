...
.EXAMPLE
    .\V-254433.ps1
    .\V-254433.ps1 -ConfigFile stig-config.json
    .\V-254433.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254433"
$Severity = "medium"
$StigID = "WN22-MS-000060"
$RuleTitle = "Windows Server 2022 must restrict remote calls to the Security Account Manager (SAM) to Administrators on domain-joined member servers and standalone or nondomain-joined systems."
