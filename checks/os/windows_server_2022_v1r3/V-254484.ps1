...
.EXAMPLE
    .\V-254484.ps1
    .\V-254484.ps1 -ConfigFile stig-config.json
    .\V-254484.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254484"
$Severity = "medium"
$StigID = "WN22-SO-000400"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must, at a minimum, prompt administrators for consent on the secure desktop."
