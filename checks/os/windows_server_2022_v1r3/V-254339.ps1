...
.EXAMPLE
    .\V-254339.ps1
    .\V-254339.ps1 -ConfigFile stig-config.json
    .\V-254339.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254339"
$Severity = "medium"
$StigID = "WN22-CC-000070"
$RuleTitle = "Windows Server 2022 insecure logons to an SMB server must be disabled."
