...
.EXAMPLE
    .\V-254453.ps1
    .\V-254453.ps1 -ConfigFile stig-config.json
    .\V-254453.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254453"
$Severity = "medium"
$StigID = "WN22-SO-000090"
$RuleTitle = "Windows Server 2022 computer account password must not be prevented from being reset."
