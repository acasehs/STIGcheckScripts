...
.EXAMPLE
    .\V-254340.ps1
    .\V-254340.ps1 -ConfigFile stig-config.json
    .\V-254340.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254340"
$Severity = "medium"
$StigID = "WN22-CC-000080"
$RuleTitle = "Windows Server 2022 hardened Universal Naming Convention (UNC) paths must be defined to require mutual authentication and integrity for at least the \\*\SYSVOL and \\*\NETLOGON shares."
