...
# TODO: Implement check logic for V-254426
Write-Host "TODO: Implement check for V-254426"
Write-Host "Rule: Windows Server 2022 Enable computer and user accounts to be trusted for delegation user right must o"
exit 3
