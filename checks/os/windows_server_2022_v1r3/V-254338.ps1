...
.EXAMPLE
    .\V-254338.ps1
    .\V-254338.ps1 -ConfigFile stig-config.json
    .\V-254338.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254338"
$Severity = "low"
$StigID = "WN22-CC-000060"
$RuleTitle = "Windows Server 2022 must be configured to ignore NetBIOS name release requests except from WINS servers."
