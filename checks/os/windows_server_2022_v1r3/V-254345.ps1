...
.EXAMPLE
    .\V-254345.ps1
    .\V-254345.ps1 -ConfigFile stig-config.json
    .\V-254345.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254345"
$Severity = "medium"
$StigID = "WN22-CC-000140"
$RuleTitle = "Windows Server 2022 group policy objects must be reprocessed even if they have not changed."
