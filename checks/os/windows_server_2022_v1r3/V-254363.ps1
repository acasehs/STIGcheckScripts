...
.EXAMPLE
    .\V-254363.ps1
    .\V-254363.ps1 -ConfigFile stig-config.json
    .\V-254363.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254363"
$Severity = "low"
$StigID = "WN22-CC-000320"
$RuleTitle = "Windows Server 2022 Turning off File Explorer heap termination on corruption must be disabled."
