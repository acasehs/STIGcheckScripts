...
.EXAMPLE
    .\V-254458.ps1
    .\V-254458.ps1 -ConfigFile stig-config.json
    .\V-254458.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254458"
$Severity = "low"
$StigID = "WN22-SO-000140"
$RuleTitle = "Windows Server 2022 title for legal banner dialog box must be configured with the appropriate text."
