...
.EXAMPLE
    .\V-254455.ps1
    .\V-254455.ps1 -ConfigFile stig-config.json
    .\V-254455.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254455"
$Severity = "medium"
$StigID = "WN22-SO-000110"
$RuleTitle = "Windows Server 2022 must be configured to require a strong session key."
