...
.EXAMPLE
    .\V-254359.ps1
    .\V-254359.ps1 -ConfigFile stig-config.json
    .\V-254359.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254359"
$Severity = "medium"
$StigID = "WN22-CC-000280"
$RuleTitle = "Windows Server 2022 Security event log size must be configured to 196608 KB or greater."
