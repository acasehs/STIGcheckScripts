...
.EXAMPLE
    .\V-254416.ps1
    .\V-254416.ps1 -ConfigFile stig-config.json
    .\V-254416.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254416"
$Severity = "medium"
$StigID = "WN22-DC-000320"
$RuleTitle = "Windows Server 2022 domain controllers must require LDAP access signing."
