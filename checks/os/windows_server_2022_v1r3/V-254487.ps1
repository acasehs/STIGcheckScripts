...
.EXAMPLE
    .\V-254487.ps1
    .\V-254487.ps1 -ConfigFile stig-config.json
    .\V-254487.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254487"
$Severity = "medium"
$StigID = "WN22-SO-000430"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must only elevate UIAccess applications that are installed in secure locations."
