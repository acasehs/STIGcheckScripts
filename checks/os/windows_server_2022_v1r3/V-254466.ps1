...
.EXAMPLE
    .\V-254466.ps1
    .\V-254466.ps1 -ConfigFile stig-config.json
    .\V-254466.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254466"
$Severity = "high"
$StigID = "WN22-SO-000220"
$RuleTitle = "Windows Server 2022 must not allow anonymous enumeration of Security Account Manager (SAM) accounts."
