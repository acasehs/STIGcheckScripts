...
.EXAMPLE
    .\V-254478.ps1
    .\V-254478.ps1 -ConfigFile stig-config.json
    .\V-254478.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254478"
$Severity = "medium"
$StigID = "WN22-SO-000340"
$RuleTitle = "Windows Server 2022 session security for NTLM SSP-based servers must be configured to require NTLMv2 session security and 128-bit encryption."
