...
.EXAMPLE
    .\V-254360.ps1
    .\V-254360.ps1 -ConfigFile stig-config.json
    .\V-254360.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254360"
$Severity = "medium"
$StigID = "WN22-CC-000290"
$RuleTitle = "Windows Server 2022 System event log size must be configured to 32768 KB or greater."
