...
.EXAMPLE
    .\V-254362.ps1
    .\V-254362.ps1 -ConfigFile stig-config.json
    .\V-254362.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254362"
$Severity = "medium"
$StigID = "WN22-CC-000310"
$RuleTitle = "Windows Server 2022 Explorer Data Execution Prevention must be enabled."
