...
.EXAMPLE
    .\V-254462.ps1
    .\V-254462.ps1 -ConfigFile stig-config.json
    .\V-254462.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254462"
$Severity = "medium"
$StigID = "WN22-SO-000180"
$RuleTitle = "Windows Server 2022 unencrypted passwords must not be sent to third-party Server Message Block (SMB) servers."
