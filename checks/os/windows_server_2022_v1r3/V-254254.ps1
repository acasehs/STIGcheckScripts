...
.EXAMPLE
    .\V-254254.ps1
    .\V-254254.ps1 -ConfigFile stig-config.json
    .\V-254254.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254254"
$Severity = "medium"
$StigID = "WN22-00-000170"
$RuleTitle = "Windows Server 2022 default permissions for the HKEY_LOCAL_MACHINE registry hive must be maintained."
