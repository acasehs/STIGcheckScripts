...
.EXAMPLE
    .\V-254379.ps1
    .\V-254379.ps1 -ConfigFile stig-config.json
    .\V-254379.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254379"
$Severity = "medium"
$StigID = "WN22-CC-000480"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) client must not allow unencrypted traffic."
