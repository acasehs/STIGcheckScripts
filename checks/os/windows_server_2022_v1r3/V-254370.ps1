...
.EXAMPLE
    .\V-254370.ps1
    .\V-254370.ps1 -ConfigFile stig-config.json
    .\V-254370.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254370"
$Severity = "medium"
$StigID = "WN22-CC-000390"
$RuleTitle = "Windows Server 2022 must prevent attachments from being downloaded from RSS feeds."
