...
.EXAMPLE
    .\V-254474.ps1
    .\V-254474.ps1 -ConfigFile stig-config.json
    .\V-254474.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254474"
$Severity = "high"
$StigID = "WN22-SO-000300"
$RuleTitle = "Windows Server 2022 must be configured to prevent the storage of the LAN Manager hash of passwords."
