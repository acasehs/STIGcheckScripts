...
# TODO: Implement check logic for V-254425
Write-Host "TODO: Implement check for V-254425"
Write-Host "Rule: Windows Server 2022 Deny log on through Remote Desktop Services user right on domain controllers mus"
exit 3
