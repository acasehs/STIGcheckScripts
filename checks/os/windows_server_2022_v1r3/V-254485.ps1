...
.EXAMPLE
    .\V-254485.ps1
    .\V-254485.ps1 -ConfigFile stig-config.json
    .\V-254485.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254485"
$Severity = "medium"
$StigID = "WN22-SO-000410"
$RuleTitle = "Windows Server 2022 User Account Control (UAC) must automatically deny standard user requests for elevation."
