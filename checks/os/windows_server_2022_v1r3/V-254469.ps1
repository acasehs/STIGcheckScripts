...
.EXAMPLE
    .\V-254469.ps1
    .\V-254469.ps1 -ConfigFile stig-config.json
    .\V-254469.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254469"
$Severity = "high"
$StigID = "WN22-SO-000250"
$RuleTitle = "Windows Server 2022 must restrict anonymous access to Named Pipes and Shares."
