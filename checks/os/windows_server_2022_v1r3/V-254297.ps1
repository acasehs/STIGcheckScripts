...
# TODO: Implement check logic for V-254297
Write-Host "TODO: Implement check for V-254297"
Write-Host "Rule: Windows Server 2022 permissions for the Security event log must prevent access by nonprivileged acco"
exit 3
