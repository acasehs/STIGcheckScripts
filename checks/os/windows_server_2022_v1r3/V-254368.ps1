...
.EXAMPLE
    .\V-254368.ps1
    .\V-254368.ps1 -ConfigFile stig-config.json
    .\V-254368.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254368"
$Severity = "medium"
$StigID = "WN22-CC-000370"
$RuleTitle = "Windows Server 2022 Remote Desktop Services must require secure Remote Procedure Call (RPC) communications."
