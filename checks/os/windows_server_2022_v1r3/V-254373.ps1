...
.EXAMPLE
    .\V-254373.ps1
    .\V-254373.ps1 -ConfigFile stig-config.json
    .\V-254373.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254373"
$Severity = "medium"
$StigID = "WN22-CC-000420"
$RuleTitle = "Windows Server 2022 must prevent users from changing installation options."
