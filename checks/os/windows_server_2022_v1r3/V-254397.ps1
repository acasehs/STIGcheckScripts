...
# TODO: Implement check logic for V-254397
Write-Host "TODO: Implement check for V-254397"
Write-Host "Rule: Windows Server 2022 domain controllers must run on a machine dedicated to that function."
exit 3
