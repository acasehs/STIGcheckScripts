...
.EXAMPLE
    .\V-254383.ps1
    .\V-254383.ps1 -ConfigFile stig-config.json
    .\V-254383.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254383"
$Severity = "medium"
$StigID = "WN22-CC-000520"
$RuleTitle = "Windows Server 2022 Windows Remote Management (WinRM) service must not store RunAs credentials."
