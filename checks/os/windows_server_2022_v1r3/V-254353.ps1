...
.EXAMPLE
    .\V-254353.ps1
    .\V-254353.ps1 -ConfigFile stig-config.json
    .\V-254353.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254353"
$Severity = "high"
$StigID = "WN22-CC-000220"
$RuleTitle = "Windows Server 2022 default AutoRun behavior must be configured to prevent AutoRun commands."
