...
# TODO: Implement check logic for V-254424
Write-Host "TODO: Implement check for V-254424"
Write-Host "Rule: Windows Server 2022 Deny log on locally user right on domain controllers must be configured to preve"
exit 3
