...
.EXAMPLE
    .\V-254358.ps1
    .\V-254358.ps1 -ConfigFile stig-config.json
    .\V-254358.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254358"
$Severity = "medium"
$StigID = "WN22-CC-000270"
$RuleTitle = "Windows Server 2022 Application event log size must be configured to 32768 KB or greater."
