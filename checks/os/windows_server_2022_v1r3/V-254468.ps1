...
.EXAMPLE
    .\V-254468.ps1
    .\V-254468.ps1 -ConfigFile stig-config.json
    .\V-254468.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254468"
$Severity = "medium"
$StigID = "WN22-SO-000240"
$RuleTitle = "Windows Server 2022 must be configured to prevent anonymous users from having the same permissions as the Everyone group."
