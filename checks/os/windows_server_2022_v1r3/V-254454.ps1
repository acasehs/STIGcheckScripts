...
.EXAMPLE
    .\V-254454.ps1
    .\V-254454.ps1 -ConfigFile stig-config.json
    .\V-254454.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254454"
$Severity = "medium"
$StigID = "WN22-SO-000100"
$RuleTitle = "Windows Server 2022 maximum age for machine account passwords must be configured to 30 days or less."
