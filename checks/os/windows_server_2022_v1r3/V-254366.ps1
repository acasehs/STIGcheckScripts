...
.EXAMPLE
    .\V-254366.ps1
    .\V-254366.ps1 -ConfigFile stig-config.json
    .\V-254366.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254366"
$Severity = "medium"
$StigID = "WN22-CC-000350"
$RuleTitle = "Windows Server 2022 Remote Desktop Services must prevent drive redirection."
