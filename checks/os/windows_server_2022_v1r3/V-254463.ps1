...
.EXAMPLE
    .\V-254463.ps1
    .\V-254463.ps1 -ConfigFile stig-config.json
    .\V-254463.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254463"
$Severity = "medium"
$StigID = "WN22-SO-000190"
$RuleTitle = "Windows Server 2022 setting Microsoft network server: Digitally sign communications (always) must be configured to Enabled."
