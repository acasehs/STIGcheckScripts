...
.EXAMPLE
    .\V-254446.ps1
    .\V-254446.ps1 -ConfigFile stig-config.json
    .\V-254446.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254446"
$Severity = "high"
$StigID = "WN22-SO-000020"
$RuleTitle = "Windows Server 2022 must prevent local accounts with blank passwords from being used from the network."
