...
.EXAMPLE
    .\V-254459.ps1
    .\V-254459.ps1 -ConfigFile stig-config.json
    .\V-254459.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254459"
$Severity = "medium"
$StigID = "WN22-SO-000150"
$RuleTitle = "Windows Server 2022 Smart Card removal option must be configured to Force Logoff or Lock Workstation."
