...
.EXAMPLE
    .\V-254461.ps1
    .\V-254461.ps1 -ConfigFile stig-config.json
    .\V-254461.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254461"
$Severity = "medium"
$StigID = "WN22-SO-000170"
$RuleTitle = "Windows Server 2022 setting Microsoft network client: Digitally sign communications (if server agrees) must be configured to Enabled."
