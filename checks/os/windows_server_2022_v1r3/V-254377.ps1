...
.EXAMPLE
    .\V-254377.ps1
    .\V-254377.ps1 -ConfigFile stig-config.json
    .\V-254377.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254377"
$Severity = "medium"
$StigID = "WN22-CC-000460"
$RuleTitle = "Windows Server 2022 PowerShell script block logging must be enabled."
