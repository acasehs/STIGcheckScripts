...
.EXAMPLE
    .\V-254432.ps1
    .\V-254432.ps1 -ConfigFile stig-config.json
    .\V-254432.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254432"
$Severity = "medium"
$StigID = "WN22-MS-000050"
$RuleTitle = "Windows Server 2022 must limit the caching of logon credentials to four or less on domain-joined member servers."
