...
.EXAMPLE
    .\V-254456.ps1
    .\V-254456.ps1 -ConfigFile stig-config.json
    .\V-254456.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$RuleTitle = "Windows Server 2022 machine inactivity limit must be set to 15 minutes or less, locking the system with the screen saver."
