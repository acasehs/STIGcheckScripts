...
# TODO: Implement check logic for V-254298
Write-Host "TODO: Implement check for V-254298"
Write-Host "Rule: Windows Server 2022 permissions for the System event log must prevent access by nonprivileged accoun"
exit 3
