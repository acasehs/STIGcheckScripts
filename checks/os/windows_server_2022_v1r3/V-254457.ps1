...
.EXAMPLE
    .\V-254457.ps1
    .\V-254457.ps1 -ConfigFile stig-config.json
    .\V-254457.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254457"
$Severity = "medium"
$StigID = "WN22-SO-000130"
$RuleTitle = "Windows Server 2022 required legal notice must be configured to display before console logon."
