...
.EXAMPLE
    .\V-254351.ps1
    .\V-254351.ps1 -ConfigFile stig-config.json
    .\V-254351.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254351"
$Severity = "low"
$StigID = "WN22-CC-000200"
$RuleTitle = "Windows Server 2022 Application Compatibility Program Inventory must be prevented from collecting data and sending the information to Microsoft."
