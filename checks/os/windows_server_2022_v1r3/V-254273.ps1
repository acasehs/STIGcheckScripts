...
# TODO: Implement check logic for V-254273
Write-Host "TODO: Implement check for V-254273"
Write-Host "Rule: Windows Server 2022 must not have the Telnet Client installed."
exit 3
