...
.EXAMPLE
    .\V-254374.ps1
    .\V-254374.ps1 -ConfigFile stig-config.json
    .\V-254374.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254374"
$Severity = "high"
$StigID = "WN22-CC-000430"
$RuleTitle = "Windows Server 2022 must disable the Windows Installer Always install with elevated privileges option."
