...
.EXAMPLE
    .\V-254361.ps1
    .\V-254361.ps1 -ConfigFile stig-config.json
    .\V-254361.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254361"
$Severity = "medium"
$StigID = "WN22-CC-000300"
$RuleTitle = "Windows Server 2022 Microsoft Defender antivirus SmartScreen must be enabled."
