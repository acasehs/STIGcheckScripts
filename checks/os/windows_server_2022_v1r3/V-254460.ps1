...
.EXAMPLE
    .\V-254460.ps1
    .\V-254460.ps1 -ConfigFile stig-config.json
    .\V-254460.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254460"
$Severity = "medium"
$StigID = "WN22-SO-000160"
$RuleTitle = "Windows Server 2022 setting Microsoft network client: Digitally sign communications (always) must be configured to Enabled."
