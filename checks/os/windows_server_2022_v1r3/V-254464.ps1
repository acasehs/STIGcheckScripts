...
.EXAMPLE
    .\V-254464.ps1
    .\V-254464.ps1 -ConfigFile stig-config.json
    .\V-254464.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254464"
$Severity = "medium"
$StigID = "WN22-SO-000200"
$RuleTitle = "Windows Server 2022 setting Microsoft network server: Digitally sign communications (if client agrees) must be configured to Enabled."
