...
.EXAMPLE
    .\V-254384.ps1
    .\V-254384.ps1 -ConfigFile stig-config.json
    .\V-254384.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254384"
$Severity = "medium"
$StigID = "WN22-CC-000530"
$RuleTitle = "Windows Server 2022 must have PowerShell Transcription enabled."
