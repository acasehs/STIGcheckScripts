...
.EXAMPLE
    .\V-254334.ps1
    .\V-254334.ps1 -ConfigFile stig-config.json
    .\V-254334.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254334"
$Severity = "medium"
$StigID = "WN22-CC-000020"
$RuleTitle = "Windows Server 2022 must have WDigest Authentication disabled."
