...
.EXAMPLE
    .\V-254371.ps1
    .\V-254371.ps1 -ConfigFile stig-config.json
    .\V-254371.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254371"
$Severity = "medium"
$StigID = "WN22-CC-000400"
$RuleTitle = "Windows Server 2022 must disable Basic authentication for RSS feeds over HTTP."
