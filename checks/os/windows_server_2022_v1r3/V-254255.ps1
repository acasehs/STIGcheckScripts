...
# TODO: Implement check logic for V-254255
Write-Host "TODO: Implement check for V-254255"
Write-Host "Rule: Windows Server 2022 nonadministrative accounts or groups must only have print permissions on printer"
exit 3
