...
.EXAMPLE
    .\V-254333.ps1
    .\V-254333.ps1 -ConfigFile stig-config.json
    .\V-254333.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254333"
$Severity = "medium"
$StigID = "WN22-CC-000010"
$RuleTitle = "Windows Server 2022 must prevent the display of slide shows on the lock screen."
