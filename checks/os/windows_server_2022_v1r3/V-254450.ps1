...
.EXAMPLE
    .\V-254450.ps1
    .\V-254450.ps1 -ConfigFile stig-config.json
    .\V-254450.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254450"
$Severity = "medium"
$StigID = "WN22-SO-000060"
$RuleTitle = "Windows Server 2022 setting Domain member: Digitally encrypt or sign secure channel data (always) must be configured to Enabled."
