...
.EXAMPLE
    .\V-254357.ps1
    .\V-254357.ps1 -ConfigFile stig-config.json
    .\V-254357.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254357"
$Severity = "low"
$StigID = "WN22-CC-000260"
$RuleTitle = "Windows Server 2022 Windows Update must not obtain updates from other PCs on the internet."
