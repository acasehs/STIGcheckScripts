...
.EXAMPLE
    .\V-254341.ps1
    .\V-254341.ps1 -ConfigFile stig-config.json
    .\V-254341.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254341"
$Severity = "medium"
$StigID = "WN22-CC-000090"
$RuleTitle = "Windows Server 2022 command line data must be included in process creation events."
