...
.EXAMPLE
    .\V-254342.ps1
    .\V-254342.ps1 -ConfigFile stig-config.json
    .\V-254342.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-254342"
$Severity = "medium"
$StigID = "WN22-CC-000100"
$RuleTitle = "Windows Server 2022 must be configured to enable Remote host allows delegation of nonexportable credentials."
