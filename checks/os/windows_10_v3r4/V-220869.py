...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must be configured to prevent Windows apps from being activated by voice while the system is locked.')
