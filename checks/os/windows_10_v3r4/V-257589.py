...
Severity: medium
Rule Title: Windows 10 must have command line process auditing events enabled for failures.
...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must have command line process auditing events enabled for failures.')
