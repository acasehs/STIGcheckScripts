...
def main():
    parser = argparse.ArgumentParser(description='The Enable computer and user accounts to be trusted for delegation user right must not be assigned to any groups or accounts.')
