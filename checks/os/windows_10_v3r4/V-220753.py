...
Plug and Play activity records events related to the succes
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Detailed Tracking - PNP Activity successes.')
