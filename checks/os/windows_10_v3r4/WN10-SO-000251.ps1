...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Windows 10 must use multifactor authentication for local and network a...
...
$RegPath = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Cryptography\Calais\Readers"
