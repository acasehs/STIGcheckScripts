...
Account Lockout events can be used to identify potentially 
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Logon/Logoff - Account Lockout failures.')
