...
Audit MPSSVC Rule-Level Policy Change determines whether th
...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must be configured to audit MPSSVC Rule-Level Policy Change Successes.')
