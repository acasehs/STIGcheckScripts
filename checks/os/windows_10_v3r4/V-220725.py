...
def main():
    parser = argparse.ArgumentParser(description='Inbound exceptions to the firewall on Windows 10 domain workstations must only allow authorized remote management hosts.')
