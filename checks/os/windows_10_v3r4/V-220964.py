...
def main():
    parser = argparse.ArgumentParser(description='The Create global objects user right must only be assigned to Administrators, Service, Local Service, and Network Service.')
