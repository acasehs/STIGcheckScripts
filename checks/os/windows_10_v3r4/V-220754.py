...
Process creation records events related to the creation of 
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Detailed Tracking - Process Creation successes.')
