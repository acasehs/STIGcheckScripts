...
def main():
    parser = argparse.ArgumentParser(description='The Change the system time user right must only be assigned to Administrators and Local Service and NT SERVICE\autotimesvc.')
