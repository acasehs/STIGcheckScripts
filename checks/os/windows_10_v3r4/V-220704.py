...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 systems must use a BitLocker PIN with a minimum length of six digits for pre-boot authentication.')
