...
Auditing file shares records events related to connection t
...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must be configured to audit Object Access - File Share successes.')
