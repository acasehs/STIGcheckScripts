...
def main():
    parser = argparse.ArgumentParser(description='Kerberos encryption types must be configured to prevent the use of DES and RC4 encryption suites.')
