...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 systems must have Unified Extensible Firmware Interface (UEFI) firmware and be configured to run in UEFI mode, not Legacy BIOS.')
