...
Auditing for other object access records events related to 
...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must be configured to audit Object Access - Other Object Access Events successes.')
