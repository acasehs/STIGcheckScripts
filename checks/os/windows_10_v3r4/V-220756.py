...
Audit Group Membership records information related to the g
...
def main():
    parser = argparse.ArgumentParser(description='The system must be configured to audit Logon/Logoff - Group Membership successes.')
