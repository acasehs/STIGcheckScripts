...
Audit Detailed File Share allows the auditing of attempts t
...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 must be configured to audit Detailed File Share Failures.')
