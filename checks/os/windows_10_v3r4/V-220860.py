...
Enabling PowerShell script block logging will record detail
...
def main():
    parser = argparse.ArgumentParser(description='PowerShell script block logging must be enabled on Windows 10.')
