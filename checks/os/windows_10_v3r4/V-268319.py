...
def main():
    parser = argparse.ArgumentParser(description='Windows 10 systems must use either Group Policy or an approved Mobile Device Management (MDM) product to enforce STIG compliance.')
