...
.EXAMPLE
    .\V-205921.ps1
    .\V-205921.ps1 -ConfigFile stig-config.json
    .\V-205921.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205921"
$Severity = "medium"
$StigID = "WN19-SO-000330"
$RuleTitle = "Windows Server 2019 session security for NTLM SSP-based clients must be configured to require NTLMv2 session security and 128-bit encryption."
