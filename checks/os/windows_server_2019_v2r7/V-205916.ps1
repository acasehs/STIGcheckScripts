...
.EXAMPLE
    .\V-205916.ps1
    .\V-205916.ps1 -ConfigFile stig-config.json
    .\V-205916.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205916"
$Severity = "medium"
$StigID = "WN19-SO-000260"
$RuleTitle = "Windows Server 2019 services using Local System that use Negotiate when reverting to NTLM authentication must use the computer identity instead of authenticating anonymously."
