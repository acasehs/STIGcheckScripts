...
.EXAMPLE
    .\V-205816.ps1
    .\V-205816.ps1 -ConfigFile stig-config.json
    .\V-205816.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205816"
$Severity = "medium"
$StigID = "WN19-CC-000480"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) client must not allow unencrypted traffic."
