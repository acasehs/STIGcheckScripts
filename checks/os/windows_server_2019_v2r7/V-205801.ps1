...
.EXAMPLE
    .\V-205801.ps1
    .\V-205801.ps1 -ConfigFile stig-config.json
    .\V-205801.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205801"
$Severity = "medium"
$StigID = "WN19-CC-000420"
$RuleTitle = "Windows Server 2019 must prevent users from changing installation options."
