...
# TODO: Implement check logic for V-205669
Write-Host "TODO: Implement check for V-205669"
Write-Host "Rule: Windows Server 2019 Deny log on as a service user right must be configured to include no accounts or"
exit 3
