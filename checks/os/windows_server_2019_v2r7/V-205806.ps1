...
.EXAMPLE
    .\V-205806.ps1
    .\V-205806.ps1 -ConfigFile stig-config.json
    .\V-205806.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205806"
$Severity = "high"
$StigID = "WN19-CC-000230"
$RuleTitle = "Windows Server 2019 AutoPlay must be disabled for all drives."
