...
.EXAMPLE
    .\V-205747.ps1
    .\V-205747.ps1 -ConfigFile stig-config.json
    .\V-205747.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205747"
$Severity = "medium"
$StigID = "WN19-MS-000060"
$RuleTitle = "Windows Server 2019 must restrict remote calls to the Security Account Manager (SAM) to Administrators on domain-joined member servers and standalone or nondomain-joined systems."
