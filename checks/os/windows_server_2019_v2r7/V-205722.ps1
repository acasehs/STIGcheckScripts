...
.EXAMPLE
    .\V-205722.ps1
    .\V-205722.ps1 -ConfigFile stig-config.json
    .\V-205722.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205722"
$Severity = "medium"
$StigID = "WN19-CC-000350"
$RuleTitle = "Windows Server 2019 Remote Desktop Services must prevent drive redirection."
