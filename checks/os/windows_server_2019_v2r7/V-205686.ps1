...
.EXAMPLE
    .\V-205686.ps1
    .\V-205686.ps1 -ConfigFile stig-config.json
    .\V-205686.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205686"
$Severity = "medium"
$StigID = "WN19-CC-000010"
$RuleTitle = "Windows Server 2019 must prevent the display of slide shows on the lock screen."
