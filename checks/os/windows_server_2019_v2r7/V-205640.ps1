...
# TODO: Implement check logic for V-205640
Write-Host "TODO: Implement check for V-205640"
Write-Host "Rule: Windows Server 2019 permissions for the Application event log must prevent access by non-privileged "
exit 3
