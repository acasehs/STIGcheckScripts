...
.EXAMPLE
    .\V-205924.ps1
    .\V-205924.ps1 -ConfigFile stig-config.json
    .\V-205924.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205924"
$Severity = "medium"
$StigID = "WN19-UC-000010"
$RuleTitle = "Windows Server 2019 must preserve zone information when saving attachments."
