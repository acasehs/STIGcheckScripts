...
.EXAMPLE
    .\V-205874.ps1
    .\V-205874.ps1 -ConfigFile stig-config.json
    .\V-205874.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205874"
$Severity = "medium"
$StigID = "WN19-CC-000440"
$RuleTitle = "Windows Server 2019 users must be notified if a web-based program attempts to install software."
