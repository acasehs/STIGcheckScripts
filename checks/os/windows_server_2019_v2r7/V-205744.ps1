...
# TODO: Implement check logic for V-205744
Write-Host "TODO: Implement check for V-205744"
Write-Host "Rule: Windows Server 2019 Add workstations to domain user right must only be assigned to the Administrator"
exit 3
