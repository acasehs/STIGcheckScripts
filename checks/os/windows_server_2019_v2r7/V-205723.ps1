...
.EXAMPLE
    .\V-205723.ps1
    .\V-205723.ps1 -ConfigFile stig-config.json
    .\V-205723.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205723"
$Severity = "medium"
$StigID = "WN19-DC-000120"
$RuleTitle = "Windows Server 2019 data files owned by users must be on a different logical partition from the directory server data files."
