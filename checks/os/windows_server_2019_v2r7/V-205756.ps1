...
# TODO: Implement check logic for V-205756
Write-Host "TODO: Implement check for V-205756"
Write-Host "Rule: Windows Server 2019 Create symbolic links user right must only be assigned to the Administrators gro"
exit 3
