...
.EXAMPLE
    .\V-205717.ps1
    .\V-205717.ps1 -ConfigFile stig-config.json
    .\V-205717.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205717"
$Severity = "medium"
$StigID = "WN19-SO-000400"
$RuleTitle = "Windows Server 2019 User Account Control must, at a minimum, prompt administrators for consent on the secure desktop."
