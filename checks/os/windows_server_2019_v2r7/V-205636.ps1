...
.EXAMPLE
    .\V-205636.ps1
    .\V-205636.ps1 -ConfigFile stig-config.json
    .\V-205636.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205636"
$Severity = "medium"
$StigID = "WN19-CC-000370"
$RuleTitle = "Windows Server 2019 Remote Desktop Services must require secure Remote Procedure Call (RPC) communications."
