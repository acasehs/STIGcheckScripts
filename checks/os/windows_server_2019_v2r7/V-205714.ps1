...
.EXAMPLE
    .\V-205714.ps1
    .\V-205714.ps1 -ConfigFile stig-config.json
    .\V-205714.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205714"
$Severity = "medium"
$StigID = "WN19-CC-000240"
$RuleTitle = "Windows Server 2019 administrator accounts must not be enumerated during elevation."
