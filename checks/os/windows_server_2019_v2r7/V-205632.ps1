...
.EXAMPLE
    .\V-205632.ps1
    .\V-205632.ps1 -ConfigFile stig-config.json
    .\V-205632.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205632"
$Severity = "low"
$StigID = "WN19-SO-000140"
$RuleTitle = "Windows Server 2019 title for legal banner dialog box must be configured with the appropriate text."
