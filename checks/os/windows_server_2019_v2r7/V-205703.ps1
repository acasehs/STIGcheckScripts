...
# TODO: Implement check logic for V-205703
Write-Host "TODO: Implement check for V-205703"
Write-Host "Rule: Windows Server 2019 Kerberos service ticket maximum lifetime must be limited to 600 minutes or less."
exit 3
