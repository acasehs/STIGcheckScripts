...
.EXAMPLE
    .\V-205876.ps1
    .\V-205876.ps1 -ConfigFile stig-config.json
    .\V-205876.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205876"
$Severity = "medium"
$StigID = "WN19-DC-000330"
$RuleTitle = "Windows Server 2019 domain controllers must be configured to allow reset of machine account passwords."
