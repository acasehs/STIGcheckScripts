...
.EXAMPLE
    .\V-205802.ps1
    .\V-205802.ps1 -ConfigFile stig-config.json
    .\V-205802.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205802"
$Severity = "high"
$StigID = "WN19-CC-000430"
$RuleTitle = "Windows Server 2019 must disable the Windows Installer Always install with elevated privileges option."
