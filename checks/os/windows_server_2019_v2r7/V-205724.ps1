...
.EXAMPLE
    .\V-205724.ps1
    .\V-205724.ps1 -ConfigFile stig-config.json
    .\V-205724.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205724"
$Severity = "high"
$StigID = "WN19-SO-000230"
$RuleTitle = "Windows Server 2019 must not allow anonymous enumeration of shares."
