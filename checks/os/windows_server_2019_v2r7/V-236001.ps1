...
.EXAMPLE
    .\V-236001.ps1
    .\V-236001.ps1 -ConfigFile stig-config.json
    .\V-236001.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-236001"
$Severity = "medium"
$StigID = "WN19-CC-000451"
$RuleTitle = "The Windows Explorer Preview pane must be disabled for Windows Server 2019."
