...
.EXAMPLE
    .\V-205865.ps1
    .\V-205865.ps1 -ConfigFile stig-config.json
    .\V-205865.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205865"
$Severity = "medium"
$StigID = "WN19-CC-000130"
$RuleTitle = "Windows Server 2019 Early Launch Antimalware, Boot-Start Driver Initialization Policy must prevent boot drivers identified as bad."
