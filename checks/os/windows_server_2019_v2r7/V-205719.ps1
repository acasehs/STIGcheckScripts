...
.EXAMPLE
    .\V-205719.ps1
    .\V-205719.ps1 -ConfigFile stig-config.json
    .\V-205719.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205719"
$Severity = "medium"
$StigID = "WN19-SO-000430"
$RuleTitle = "Windows Server 2019 User Account Control (UAC) must only elevate UIAccess applications that are installed in secure locations."
