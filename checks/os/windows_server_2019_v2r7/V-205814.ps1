...
.EXAMPLE
    .\V-205814.ps1
    .\V-205814.ps1 -ConfigFile stig-config.json
    .\V-205814.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205814"
$Severity = "medium"
$StigID = "WN19-MS-000040"
$RuleTitle = "Windows Server 2019 must restrict unauthenticated Remote Procedure Call (RPC) clients from connecting to the RPC server on domain-joined member servers and standalone or nondomain-joined systems."
