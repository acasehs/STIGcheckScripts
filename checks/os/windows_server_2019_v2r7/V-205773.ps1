...
# TODO: Implement check logic for V-205773
Write-Host "TODO: Implement check for V-205773"
Write-Host "Rule: Windows Server 2019 must be configured to audit Policy Change - Authentication Policy Change success"
exit 3
