...
.EXAMPLE
    .\V-205842.ps1
    .\V-205842.ps1 -ConfigFile stig-config.json
    .\V-205842.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205842"
$Severity = "medium"
$StigID = "WN19-SO-000360"
$RuleTitle = "Windows Server 2019 must be configured to use FIPS-compliant algorithms for encryption, hashing, and signing."
