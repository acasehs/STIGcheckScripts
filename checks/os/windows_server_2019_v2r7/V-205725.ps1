...
.EXAMPLE
    .\V-205725.ps1
    .\V-205725.ps1 -ConfigFile stig-config.json
    .\V-205725.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205725"
$Severity = "high"
$StigID = "WN19-SO-000250"
$RuleTitle = "Windows Server 2019 must restrict anonymous access to Named Pipes and Shares."
