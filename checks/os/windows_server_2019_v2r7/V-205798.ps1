...
.EXAMPLE
    .\V-205798.ps1
    .\V-205798.ps1 -ConfigFile stig-config.json
    .\V-205798.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205798"
$Severity = "medium"
$StigID = "WN19-CC-000290"
$RuleTitle = "Windows Server 2019 System event log size must be configured to 32768 KB or greater."
