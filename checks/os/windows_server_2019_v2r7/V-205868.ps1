...
.EXAMPLE
    .\V-205868.ps1
    .\V-205868.ps1 -ConfigFile stig-config.json
    .\V-205868.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205868"
$Severity = "medium"
$StigID = "WN19-CC-000190"
$RuleTitle = "Windows Server 2019 users must be prompted to authenticate when the system wakes from sleep (plugged in)."
