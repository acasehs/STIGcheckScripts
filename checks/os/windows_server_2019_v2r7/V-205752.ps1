...
# TODO: Implement check logic for V-205752
Write-Host "TODO: Implement check for V-205752"
Write-Host "Rule: Windows Server 2019 Create a pagefile user right must only be assigned to the Administrators group."
exit 3
