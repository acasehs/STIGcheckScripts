...
.EXAMPLE
    .\V-205683.ps1
    .\V-205683.ps1 -ConfigFile stig-config.json
    .\V-205683.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205683"
$Severity = "medium"
$StigID = "WN19-00-000390"
$RuleTitle = "Windows Server 2019 must have the Server Message Block (SMB) v1 protocol disabled on the SMB server."
