...
.EXAMPLE
    .\V-205827.ps1
    .\V-205827.ps1 -ConfigFile stig-config.json
    .\V-205827.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205827"
$Severity = "medium"
$StigID = "WN19-SO-000190"
$RuleTitle = "Windows Server 2019 setting Microsoft network server: Digitally sign communications (always) must be configured to Enabled."
