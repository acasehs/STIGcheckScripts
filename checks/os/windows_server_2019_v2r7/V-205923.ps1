...
.EXAMPLE
    .\V-205923.ps1
    .\V-205923.ps1 -ConfigFile stig-config.json
    .\V-205923.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205923"
$Severity = "low"
$StigID = "WN19-SO-000370"
$RuleTitle = "Windows Server 2019 default permissions of global system objects must be strengthened."
