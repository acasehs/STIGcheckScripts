...
# TODO: Implement check logic for V-205652
Write-Host "TODO: Implement check for V-205652"
Write-Host "Rule: Windows Server 2019 must have the built-in Windows password complexity policy enabled."
exit 3
