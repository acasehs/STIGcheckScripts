...
.EXAMPLE
    .\V-205713.ps1
    .\V-205713.ps1 -ConfigFile stig-config.json
    .\V-205713.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205713"
$Severity = "high"
$StigID = "WN19-CC-000500"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) service must not use Basic authentication."
