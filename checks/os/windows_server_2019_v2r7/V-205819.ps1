...
.EXAMPLE
    .\V-205819.ps1
    .\V-205819.ps1 -ConfigFile stig-config.json
    .\V-205819.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205819"
$Severity = "low"
$StigID = "WN19-CC-000060"
$RuleTitle = "Windows Server 2019 must be configured to ignore NetBIOS name release requests except from WINS servers."
