...
.EXAMPLE
    .\V-205712.ps1
    .\V-205712.ps1 -ConfigFile stig-config.json
    .\V-205712.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205712"
$Severity = "medium"
$StigID = "WN19-CC-000490"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) client must not use Digest authentication."
