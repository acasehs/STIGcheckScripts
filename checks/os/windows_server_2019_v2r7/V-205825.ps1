...
.EXAMPLE
    .\V-205825.ps1
    .\V-205825.ps1 -ConfigFile stig-config.json
    .\V-205825.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205825"
$Severity = "medium"
$StigID = "WN19-SO-000160"
$RuleTitle = "Windows Server 2019 setting Microsoft network client: Digitally sign communications (always) must be configured to Enabled."
