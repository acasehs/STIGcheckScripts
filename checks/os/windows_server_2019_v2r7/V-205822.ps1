...
.EXAMPLE
    .\V-205822.ps1
    .\V-205822.ps1 -ConfigFile stig-config.json
    .\V-205822.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205822"
$Severity = "medium"
$StigID = "WN19-SO-000070"
$RuleTitle = "Windows Server 2019 setting Domain member: Digitally encrypt secure channel data (when possible) must be configured to enabled."
