...
.EXAMPLE
    .\V-205810.ps1
    .\V-205810.ps1 -ConfigFile stig-config.json
    .\V-205810.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205810"
$Severity = "medium"
$StigID = "WN19-CC-000520"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) service must not store RunAs credentials."
