...
.EXAMPLE
    .\V-205737.ps1
    .\V-205737.ps1 -ConfigFile stig-config.json
    .\V-205737.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205737"
$Severity = "medium"
$StigID = "WN19-00-000170"
$RuleTitle = "Windows Server 2019 default permissions for the HKEY_LOCAL_MACHINE registry hive must be maintained."
