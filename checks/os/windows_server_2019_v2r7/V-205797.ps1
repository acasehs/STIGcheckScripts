...
.EXAMPLE
    .\V-205797.ps1
    .\V-205797.ps1 -ConfigFile stig-config.json
    .\V-205797.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205797"
$Severity = "medium"
$StigID = "WN19-CC-000280"
$RuleTitle = "Windows Server 2019 Security event log size must be configured to 196608 KB or greater."
