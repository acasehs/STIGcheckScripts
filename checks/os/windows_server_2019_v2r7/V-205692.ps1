...
.EXAMPLE
    .\V-205692.ps1
    .\V-205692.ps1 -ConfigFile stig-config.json
    .\V-205692.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205692"
$Severity = "medium"
$StigID = "WN19-CC-000300"
$RuleTitle = "Windows Server 2019 Windows Defender SmartScreen must be enabled."
