...
.EXAMPLE
    .\V-205804.ps1
    .\V-205804.ps1 -ConfigFile stig-config.json
    .\V-205804.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205804"
$Severity = "high"
$StigID = "WN19-CC-000210"
$RuleTitle = "Windows Server 2019 Autoplay must be turned off for non-volume devices."
