...
.EXAMPLE
    .\V-205866.ps1
    .\V-205866.ps1 -ConfigFile stig-config.json
    .\V-205866.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205866"
$Severity = "medium"
$StigID = "WN19-CC-000140"
$RuleTitle = "Windows Server 2019 group policy objects must be reprocessed even if they have not changed."
