...
.EXAMPLE
    .\V-205809.ps1
    .\V-205809.ps1 -ConfigFile stig-config.json
    .\V-205809.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205809"
$Severity = "medium"
$StigID = "WN19-CC-000360"
$RuleTitle = "Windows Server 2019 Remote Desktop Services must always prompt a client for passwords upon connection."
