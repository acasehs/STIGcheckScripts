...
.EXAMPLE
    .\V-205689.ps1
    .\V-205689.ps1 -ConfigFile stig-config.json
    .\V-205689.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205689"
$Severity = "medium"
$StigID = "WN19-CC-000160"
$RuleTitle = "Windows Server 2019 printing over HTTP must be turned off."
