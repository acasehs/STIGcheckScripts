...
# TODO: Implement check logic for V-205681
Write-Host "TODO: Implement check for V-205681"
Write-Host "Rule: Windows Server 2019 must not have the TFTP Client installed."
exit 3
