...
.EXAMPLE
    .\V-205651.ps1
    .\V-205651.ps1 -ConfigFile stig-config.json
    .\V-205651.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205651"
$Severity = "medium"
$StigID = "WN19-SO-000350"
$RuleTitle = "Windows Server 2019 users must be required to enter a password to access private keys stored on the computer."
