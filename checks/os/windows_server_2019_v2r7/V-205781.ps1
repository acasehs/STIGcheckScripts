...
# TODO: Implement check logic for V-205781
Write-Host "TODO: Implement check for V-205781"
Write-Host "Rule: Windows Server 2019 must be configured to audit System - Security State Change successes."
exit 3
