...
.EXAMPLE
    .\V-205922.ps1
    .\V-205922.ps1 -ConfigFile stig-config.json
    .\V-205922.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205922"
$Severity = "medium"
$StigID = "WN19-SO-000340"
$RuleTitle = "Windows Server 2019 session security for NTLM SSP-based servers must be configured to require NTLMv2 session security and 128-bit encryption."
