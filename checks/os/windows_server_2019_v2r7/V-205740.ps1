...
# TODO: Implement check logic for V-205740
Write-Host "TODO: Implement check for V-205740"
Write-Host "Rule: Windows Server 2019 Active Directory SYSVOL directory must have the proper access control permission"
exit 3
