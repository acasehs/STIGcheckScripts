...
.EXAMPLE
    .\V-205811.ps1
    .\V-205811.ps1 -ConfigFile stig-config.json
    .\V-205811.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205811"
$Severity = "medium"
$StigID = "WN19-SO-000380"
$RuleTitle = "Windows Server 2019 User Account Control approval mode for the built-in Administrator must be enabled."
