...
.EXAMPLE
    .\V-205805.ps1
    .\V-205805.ps1 -ConfigFile stig-config.json
    .\V-205805.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205805"
$Severity = "high"
$StigID = "WN19-CC-000220"
$RuleTitle = "Windows Server 2019 default AutoRun behavior must be configured to prevent AutoRun commands."
