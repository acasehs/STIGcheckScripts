...
.EXAMPLE
    .\V-205915.ps1
    .\V-205915.ps1 -ConfigFile stig-config.json
    .\V-205915.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205915"
$Severity = "medium"
$StigID = "WN19-SO-000240"
$RuleTitle = "Windows Server 2019 must be configured to prevent anonymous users from having the same permissions as the Everyone group."
