...
.EXAMPLE
    .\V-205684.ps1
    .\V-205684.ps1 -ConfigFile stig-config.json
    .\V-205684.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205684"
$Severity = "medium"
$StigID = "WN19-00-000400"
$RuleTitle = "Windows Server 2019 must have the Server Message Block (SMB) v1 protocol disabled on the SMB client."
