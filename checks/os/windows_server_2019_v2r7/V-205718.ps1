...
.EXAMPLE
    .\V-205718.ps1
    .\V-205718.ps1 -ConfigFile stig-config.json
    .\V-205718.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205718"
$Severity = "medium"
$StigID = "WN19-SO-000420"
$RuleTitle = "Windows Server 2019 User Account Control must be configured to detect application installations and prompt for elevation."
