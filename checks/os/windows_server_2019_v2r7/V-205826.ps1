...
.EXAMPLE
    .\V-205826.ps1
    .\V-205826.ps1 -ConfigFile stig-config.json
    .\V-205826.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205826"
$Severity = "medium"
$StigID = "WN19-SO-000170"
$RuleTitle = "Windows Server 2019 setting Microsoft network client: Digitally sign communications (if server agrees) must be configured to Enabled."
