...
.EXAMPLE
    .\V-205639.ps1
    .\V-205639.ps1 -ConfigFile stig-config.json
    .\V-205639.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205639"
$Severity = "medium"
$StigID = "WN19-CC-000460"
$RuleTitle = "Windows Server 2019 PowerShell script block logging must be enabled."
