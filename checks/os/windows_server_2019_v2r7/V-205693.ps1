...
.EXAMPLE
    .\V-205693.ps1
    .\V-205693.ps1 -ConfigFile stig-config.json
    .\V-205693.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205693"
$Severity = "medium"
$StigID = "WN19-CC-000400"
$RuleTitle = "Windows Server 2019 must disable Basic authentication for RSS feeds over HTTP."
