...
# TODO: Implement check logic for V-205856
Write-Host "TODO: Implement check for V-205856"
Write-Host "Rule: Windows Server 2019 systems must have Unified Extensible Firmware Interface (UEFI) firmware and be c"
exit 3
