...
# TODO: Implement check logic for V-205910
Write-Host "TODO: Implement check for V-205910"
Write-Host "Rule: Windows Server 2019 built-in guest account must be renamed."
exit 3
