...
.EXAMPLE
    .\V-205872.ps1
    .\V-205872.ps1 -ConfigFile stig-config.json
    .\V-205872.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205872"
$Severity = "medium"
$StigID = "WN19-CC-000330"
$RuleTitle = "Windows Server 2019 File Explorer shell protocol must run in protected mode."
