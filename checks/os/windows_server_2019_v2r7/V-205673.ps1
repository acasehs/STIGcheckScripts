...
# TODO: Implement check logic for V-205673
Write-Host "TODO: Implement check for V-205673"
Write-Host "Rule: Windows Server 2019 "Deny log on as a batch job" user right on domain-joined member servers must be "
exit 3
