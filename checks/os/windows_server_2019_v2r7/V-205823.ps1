...
.EXAMPLE
    .\V-205823.ps1
    .\V-205823.ps1 -ConfigFile stig-config.json
    .\V-205823.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205823"
$Severity = "medium"
$StigID = "WN19-SO-000080"
$RuleTitle = "Windows Server 2019 setting Domain member: Digitally sign secure channel data (when possible) must be configured to Enabled."
