...
.EXAMPLE
    .\V-205925.ps1
    .\V-205925.ps1 -ConfigFile stig-config.json
    .\V-205925.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205925"
$Severity = "medium"
$StigID = "WN19-CC-000450"
$RuleTitle = "Windows Server 2019 must disable automatically signing in the last interactive user after a system-initiated restart."
