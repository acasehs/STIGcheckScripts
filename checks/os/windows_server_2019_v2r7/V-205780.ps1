...
# TODO: Implement check logic for V-205780
Write-Host "TODO: Implement check for V-205780"
Write-Host "Rule: Windows Server 2019 must be configured to audit System - Other System Events failures."
exit 3
