...
.EXAMPLE
    .\V-205808.ps1
    .\V-205808.ps1 -ConfigFile stig-config.json
    .\V-205808.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205808"
$Severity = "medium"
$StigID = "WN19-CC-000340"
$RuleTitle = "Windows Server 2019 must not save passwords in the Remote Desktop Client."
