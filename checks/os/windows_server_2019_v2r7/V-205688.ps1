...
.EXAMPLE
    .\V-205688.ps1
    .\V-205688.ps1 -ConfigFile stig-config.json
    .\V-205688.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205688"
$Severity = "medium"
$StigID = "WN19-CC-000150"
$RuleTitle = "Windows Server 2019 downloading print driver packages over HTTP must be turned off."
