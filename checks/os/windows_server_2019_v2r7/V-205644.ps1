...
.EXAMPLE
    .\V-205644.ps1
    .\V-205644.ps1 -ConfigFile stig-config.json
    .\V-205644.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205644"
$Severity = "medium"
$StigID = "WN19-SO-000050"
$RuleTitle = "Windows Server 2019 must force audit policy subcategory settings to override audit policy category settings."
