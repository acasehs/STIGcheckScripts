...
.EXAMPLE
    .\V-205858.ps1
    .\V-205858.ps1 -ConfigFile stig-config.json
    .\V-205858.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205858"
$Severity = "low"
$StigID = "WN19-CC-000030"
$RuleTitle = "Windows Server 2019 Internet Protocol version 6 (IPv6) source routing must be configured to the highest protection level to prevent IP source routing."
