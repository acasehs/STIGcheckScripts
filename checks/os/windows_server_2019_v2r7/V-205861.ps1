...
.EXAMPLE
    .\V-205861.ps1
    .\V-205861.ps1 -ConfigFile stig-config.json
    .\V-205861.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205861"
$Severity = "medium"
$StigID = "WN19-CC-000070"
$RuleTitle = "Windows Server 2019 insecure logons to an SMB server must be disabled."
