...
.EXAMPLE
    .\V-205817.ps1
    .\V-205817.ps1 -ConfigFile stig-config.json
    .\V-205817.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205817"
$Severity = "medium"
$StigID = "WN19-CC-000510"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) service must not allow unencrypted traffic."
