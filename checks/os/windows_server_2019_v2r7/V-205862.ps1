...
.EXAMPLE
    .\V-205862.ps1
    .\V-205862.ps1 -ConfigFile stig-config.json
    .\V-205862.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205862"
$Severity = "medium"
$StigID = "WN19-CC-000080"
$RuleTitle = "Windows Server 2019 hardened Universal Naming Convention (UNC) paths must be defined to require mutual authentication and integrity for at least the \\*\SYSVOL and \\*\NETLOGON shares."
