...
.EXAMPLE
    .\V-205815.ps1
    .\V-205815.ps1 -ConfigFile stig-config.json
    .\V-205815.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205815"
$Severity = "medium"
$StigID = "WN19-SO-000090"
$RuleTitle = "Windows Server 2019 computer account password must not be prevented from being reset."
