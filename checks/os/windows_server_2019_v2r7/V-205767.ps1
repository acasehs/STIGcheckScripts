...
# TODO: Implement check logic for V-205767
Write-Host "TODO: Implement check for V-205767"
Write-Host "Rule: Windows Server 2019 Restore files and directories user right must only be assigned to the Administra"
exit 3
