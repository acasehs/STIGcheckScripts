...
# TODO: Implement check logic for V-205678
Write-Host "TODO: Implement check for V-205678"
Write-Host "Rule: Windows Server 2019 must not have the Fax Server role installed."
exit 3
