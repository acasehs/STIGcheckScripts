...
# TODO: Implement check logic for V-205760
Write-Host "TODO: Implement check for V-205760"
Write-Host "Rule: Windows Server 2019 Impersonate a client after authentication user right must only be assigned to Ad"
exit 3
