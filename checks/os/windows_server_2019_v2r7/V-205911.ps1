...
.EXAMPLE
    .\V-205911.ps1
    .\V-205911.ps1 -ConfigFile stig-config.json
    .\V-205911.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205911"
$Severity = "medium"
$StigID = "WN19-SO-000100"
$RuleTitle = "Windows Server 2019 maximum age for machine account passwords must be configured to 30 days or less."
