...
.EXAMPLE
    .\V-205637.ps1
    .\V-205637.ps1 -ConfigFile stig-config.json
    .\V-205637.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205637"
$Severity = "medium"
$StigID = "WN19-CC-000380"
$RuleTitle = "Windows Server 2019 Remote Desktop Services must be configured with the client connection encryption set to High Level."
