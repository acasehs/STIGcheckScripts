...
# TODO: Implement check logic for V-205628
Write-Host "TODO: Implement check for V-205628"
Write-Host "Rule: Windows Server 2019 must be configured to audit Account Management - Computer Account Management suc"
exit 3
