...
.EXAMPLE
    .\V-205867.ps1
    .\V-205867.ps1 -ConfigFile stig-config.json
    .\V-205867.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205867"
$Severity = "medium"
$StigID = "WN19-CC-000180"
$RuleTitle = "Windows Server 2019 users must be prompted to authenticate when the system wakes from sleep (on battery)."
