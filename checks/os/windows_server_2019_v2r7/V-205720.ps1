...
.EXAMPLE
    .\V-205720.ps1
    .\V-205720.ps1 -ConfigFile stig-config.json
    .\V-205720.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205720"
$Severity = "medium"
$StigID = "WN19-SO-000450"
$RuleTitle = "Windows Server 2019 User Account Control (UAC) must virtualize file and registry write failures to per-user locations."
