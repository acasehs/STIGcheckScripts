...
# TODO: Implement check logic for V-205732
Write-Host "TODO: Implement check for V-205732"
Write-Host "Rule: Windows Server 2019 Deny log on through Remote Desktop Services user right on domain controllers mus"
exit 3
