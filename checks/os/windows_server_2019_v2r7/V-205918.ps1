...
.EXAMPLE
    .\V-205918.ps1
    .\V-205918.ps1 -ConfigFile stig-config.json
    .\V-205918.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205918"
$Severity = "medium"
$StigID = "WN19-SO-000280"
$RuleTitle = "Windows Server 2019 must prevent PKU2U authentication using online identities."
