...
.EXAMPLE
    .\V-205870.ps1
    .\V-205870.ps1 -ConfigFile stig-config.json
    .\V-205870.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205870"
$Severity = "low"
$StigID = "WN19-CC-000260"
$RuleTitle = "Windows Server 2019 Windows Update must not obtain updates from other PCs on the Internet."
