...
# TODO: Implement check logic for V-205834
Write-Host "TODO: Implement check for V-205834"
Write-Host "Rule: Windows Server 2019 must be configured to audit Logon/Logoff - Group Membership successes."
exit 3
