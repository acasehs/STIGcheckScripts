...
.EXAMPLE
    .\V-205654.ps1
    .\V-205654.ps1 -ConfigFile stig-config.json
    .\V-205654.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205654"
$Severity = "high"
$StigID = "WN19-SO-000300"
$RuleTitle = "Windows Server 2019 must be configured to prevent the storage of the LAN Manager hash of passwords."
