...
.EXAMPLE
    .\V-205830.ps1
    .\V-205830.ps1 -ConfigFile stig-config.json
    .\V-205830.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205830"
$Severity = "medium"
$StigID = "WN19-CC-000310"
$RuleTitle = "Windows Server 2019 Explorer Data Execution Prevention must be enabled."
