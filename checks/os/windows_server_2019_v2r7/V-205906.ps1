...
.EXAMPLE
    .\V-205906.ps1
    .\V-205906.ps1 -ConfigFile stig-config.json
    .\V-205906.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205906"
$Severity = "medium"
$StigID = "WN19-MS-000050"
$RuleTitle = "Windows Server 2019 must limit the caching of logon credentials to four or less on domain-joined member servers."
