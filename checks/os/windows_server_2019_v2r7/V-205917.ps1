...
.EXAMPLE
    .\V-205917.ps1
    .\V-205917.ps1 -ConfigFile stig-config.json
    .\V-205917.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205917"
$Severity = "medium"
$StigID = "WN19-SO-000270"
$RuleTitle = "Windows Server 2019 must prevent NTLM from falling back to a Null session."
