...
.EXAMPLE
    .\V-205687.ps1
    .\V-205687.ps1 -ConfigFile stig-config.json
    .\V-205687.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205687"
$Severity = "medium"
$StigID = "WN19-CC-000020"
$RuleTitle = "Windows Server 2019 must have WDigest Authentication disabled."
