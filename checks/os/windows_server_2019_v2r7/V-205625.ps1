...
# TODO: Implement check logic for V-205625
Write-Host "TODO: Implement check for V-205625"
Write-Host "Rule: Windows Server 2019 must be configured to audit Account Management - Security Group Management succe"
exit 3
