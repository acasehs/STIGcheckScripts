...
.EXAMPLE
    .\V-205871.ps1
    .\V-205871.ps1 -ConfigFile stig-config.json
    .\V-205871.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205871"
$Severity = "low"
$StigID = "WN19-CC-000320"
$RuleTitle = "Windows Server 2019 Turning off File Explorer heap termination on corruption must be disabled."
