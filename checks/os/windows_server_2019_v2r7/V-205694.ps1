...
.EXAMPLE
    .\V-205694.ps1
    .\V-205694.ps1 -ConfigFile stig-config.json
    .\V-205694.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205694"
$Severity = "medium"
$StigID = "WN19-CC-000410"
$RuleTitle = "Windows Server 2019 must prevent Indexing of encrypted files."
