...
.EXAMPLE
    .\V-205863.ps1
    .\V-205863.ps1 -ConfigFile stig-config.json
    .\V-205863.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205863"
$Severity = "medium"
$StigID = "WN19-CC-000100"
$RuleTitle = "Windows Server 2019 must be configured to enable Remote host allows delegation of non-exportable credentials."
