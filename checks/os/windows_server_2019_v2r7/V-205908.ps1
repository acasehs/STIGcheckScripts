...
.EXAMPLE
    .\V-205908.ps1
    .\V-205908.ps1 -ConfigFile stig-config.json
    .\V-205908.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205908"
$Severity = "high"
$StigID = "WN19-SO-000020"
$RuleTitle = "Windows Server 2019 must prevent local accounts with blank passwords from being used from the network."
