...
.EXAMPLE
    .\V-205864.ps1
    .\V-205864.ps1 -ConfigFile stig-config.json
    .\V-205864.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205864"
$Severity = "medium"
$StigID = "WN19-CC-000110"
$RuleTitle = "Windows Server 2019 virtualization-based security must be enabled with the platform security level configured to Secure Boot or Secure Boot with DMA Protection."
