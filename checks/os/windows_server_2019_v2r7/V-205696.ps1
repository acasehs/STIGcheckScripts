...
.EXAMPLE
    .\V-205696.ps1
    .\V-205696.ps1 -ConfigFile stig-config.json
    .\V-205696.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205696"
$Severity = "medium"
$StigID = "WN19-MS-000030"
$RuleTitle = "Windows Server 2019 local users on domain-joined member servers must not be enumerated."
