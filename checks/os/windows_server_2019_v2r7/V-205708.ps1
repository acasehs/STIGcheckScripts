...
.EXAMPLE
    .\V-205708.ps1
    .\V-205708.ps1 -ConfigFile stig-config.json
    .\V-205708.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205708"
$Severity = "medium"
$StigID = "WN19-SO-000290"
$RuleTitle = "Windows Server 2019 Kerberos encryption types must be configured to prevent the use of DES and RC4 encryption suites."
