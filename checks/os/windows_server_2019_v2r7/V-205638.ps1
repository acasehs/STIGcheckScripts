...
.EXAMPLE
    .\V-205638.ps1
    .\V-205638.ps1 -ConfigFile stig-config.json
    .\V-205638.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205638"
$Severity = "medium"
$StigID = "WN19-CC-000090"
$RuleTitle = "Windows Server 2019 command line data must be included in process creation events."
