...
# TODO: Implement check logic for V-205775
Write-Host "TODO: Implement check for V-205775"
Write-Host "Rule: Windows Server 2019 must be configured to audit Privilege Use - Sensitive Privilege Use successes."
exit 3
