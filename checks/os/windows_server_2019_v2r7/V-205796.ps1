...
.EXAMPLE
    .\V-205796.ps1
    .\V-205796.ps1 -ConfigFile stig-config.json
    .\V-205796.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205796"
$Severity = "medium"
$StigID = "WN19-CC-000270"
$RuleTitle = "Windows Server 2019 Application event log size must be configured to 32768 KB or greater."
