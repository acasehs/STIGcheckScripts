...
# TODO: Implement check logic for V-205647
Write-Host "TODO: Implement check for V-205647"
Write-Host "Rule: Windows Server 2019 PKI certificates associated with user accounts must be issued by a DoD PKI or an"
exit 3
