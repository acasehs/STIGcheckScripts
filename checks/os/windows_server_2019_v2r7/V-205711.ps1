...
.EXAMPLE
    .\V-205711.ps1
    .\V-205711.ps1 -ConfigFile stig-config.json
    .\V-205711.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205711"
$Severity = "high"
$StigID = "WN19-CC-000470"
$RuleTitle = "Windows Server 2019 Windows Remote Management (WinRM) client must not use Basic authentication."
