...
.EXAMPLE
    .\V-205907.ps1
    .\V-205907.ps1 -ConfigFile stig-config.json
    .\V-205907.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205907"
$Severity = "high"
$StigID = "WN19-MS-000140"
$RuleTitle = "Windows Server 2019 must be running Credential Guard on domain-joined member servers."
