...
.EXAMPLE
    .\V-205859.ps1
    .\V-205859.ps1 -ConfigFile stig-config.json
    .\V-205859.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205859"
$Severity = "low"
$StigID = "WN19-CC-000040"
$RuleTitle = "Windows Server 2019 source routing must be configured to the highest protection level to prevent Internet Protocol (IP) source routing."
