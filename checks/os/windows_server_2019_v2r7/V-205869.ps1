...
.EXAMPLE
    .\V-205869.ps1
    .\V-205869.ps1 -ConfigFile stig-config.json
    .\V-205869.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205869"
$Severity = "medium"
$StigID = "WN19-CC-000250"
$RuleTitle = "Windows Server 2019 Telemetry must be configured to Security or Basic."
