...
.EXAMPLE
    .\V-205691.ps1
    .\V-205691.ps1 -ConfigFile stig-config.json
    .\V-205691.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205691"
$Severity = "low"
$StigID = "WN19-CC-000200"
$RuleTitle = "Windows Server 2019 Application Compatibility Program Inventory must be prevented from collecting data and sending the information to Microsoft."
