...
# TODO: Implement check logic for V-205766
Write-Host "TODO: Implement check for V-205766"
Write-Host "Rule: Windows Server 2019 Profile single process user right must only be assigned to the Administrators gr"
exit 3
