...
.EXAMPLE
    .\V-205690.ps1
    .\V-205690.ps1 -ConfigFile stig-config.json
    .\V-205690.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205690"
$Severity = "medium"
$StigID = "WN19-CC-000170"
$RuleTitle = "Windows Server 2019 network selection user interface (UI) must not be displayed on the logon screen."
