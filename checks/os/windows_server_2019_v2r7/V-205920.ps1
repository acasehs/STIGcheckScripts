...
.EXAMPLE
    .\V-205920.ps1
    .\V-205920.ps1 -ConfigFile stig-config.json
    .\V-205920.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205920"
$Severity = "medium"
$StigID = "WN19-SO-000320"
$RuleTitle = "Windows Server 2019 must be configured to at least negotiate signing for LDAP client signing."
