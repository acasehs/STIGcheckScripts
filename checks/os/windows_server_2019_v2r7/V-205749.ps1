...
# TODO: Implement check logic for V-205749
Write-Host "TODO: Implement check for V-205749"
Write-Host "Rule: Windows Server 2019 Access Credential Manager as a trusted caller user right must not be assigned to"
exit 3
