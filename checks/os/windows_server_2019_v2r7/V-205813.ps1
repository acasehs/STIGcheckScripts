...
.EXAMPLE
    .\V-205813.ps1
    .\V-205813.ps1 -ConfigFile stig-config.json
    .\V-205813.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205813"
$Severity = "medium"
$StigID = "WN19-SO-000440"
$RuleTitle = "Windows Server 2019 User Account Control must run all administrators in Admin Approval Mode, enabling UAC."
