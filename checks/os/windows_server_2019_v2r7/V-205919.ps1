...
.EXAMPLE
    .\V-205919.ps1
    .\V-205919.ps1 -ConfigFile stig-config.json
    .\V-205919.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205919"
$Severity = "high"
$StigID = "WN19-SO-000310"
$RuleTitle = "Windows Server 2019 LAN Manager authentication level must be configured to send NTLMv2 response only and to refuse LM and NTLM."
