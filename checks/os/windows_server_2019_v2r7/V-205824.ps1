...
.EXAMPLE
    .\V-205824.ps1
    .\V-205824.ps1 -ConfigFile stig-config.json
    .\V-205824.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205824"
$Severity = "medium"
$StigID = "WN19-SO-000110"
$RuleTitle = "Windows Server 2019 must be configured to require a strong session key."
