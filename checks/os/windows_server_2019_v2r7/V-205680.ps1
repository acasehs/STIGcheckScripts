...
# TODO: Implement check logic for V-205680
Write-Host "TODO: Implement check for V-205680"
Write-Host "Rule: Windows Server 2019 must not have Simple TCP/IP Services installed."
exit 3
