...
.EXAMPLE
    .\V-205821.ps1
    .\V-205821.ps1 -ConfigFile stig-config.json
    .\V-205821.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205821"
$Severity = "medium"
$StigID = "WN19-SO-000060"
$RuleTitle = "Windows Server 2019 setting Domain member: Digitally encrypt or sign secure channel data (always) must be configured to Enabled."
