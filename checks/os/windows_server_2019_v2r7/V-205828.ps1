...
.EXAMPLE
    .\V-205828.ps1
    .\V-205828.ps1 -ConfigFile stig-config.json
    .\V-205828.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205828"
$Severity = "medium"
$StigID = "WN19-SO-000200"
$RuleTitle = "Windows Server 2019 setting Microsoft network server: Digitally sign communications (if client agrees) must be configured to Enabled."
