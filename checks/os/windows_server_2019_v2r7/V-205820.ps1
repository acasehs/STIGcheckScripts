...
.EXAMPLE
    .\V-205820.ps1
    .\V-205820.ps1 -ConfigFile stig-config.json
    .\V-205820.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205820"
$Severity = "medium"
$StigID = "WN19-DC-000320"
$RuleTitle = "Windows Server 2019 domain controllers must require LDAP access signing."
