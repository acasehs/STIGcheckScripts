...
.EXAMPLE
    .\V-205716.ps1
    .\V-205716.ps1 -ConfigFile stig-config.json
    .\V-205716.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205716"
$Severity = "medium"
$StigID = "WN19-SO-000390"
$RuleTitle = "Windows Server 2019 UIAccess applications must not be allowed to prompt for elevation without using the secure desktop."
