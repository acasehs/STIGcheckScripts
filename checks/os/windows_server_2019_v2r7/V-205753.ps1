...
# TODO: Implement check logic for V-205753
Write-Host "TODO: Implement check for V-205753"
Write-Host "Rule: Windows Server 2019 Create a token object user right must not be assigned to any groups or accounts."
exit 3
