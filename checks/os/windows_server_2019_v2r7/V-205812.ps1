...
.EXAMPLE
    .\V-205812.ps1
    .\V-205812.ps1 -ConfigFile stig-config.json
    .\V-205812.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205812"
$Severity = "medium"
$StigID = "WN19-SO-000410"
$RuleTitle = "Windows Server 2019 User Account Control must automatically deny standard user requests for elevation."
