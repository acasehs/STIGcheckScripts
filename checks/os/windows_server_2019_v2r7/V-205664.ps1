...
# TODO: Implement check logic for V-205664
Write-Host "TODO: Implement check for V-205664"
Write-Host "Rule: Windows Server 2019 non-administrative accounts or groups must only have print permissions on printe"
exit 3
