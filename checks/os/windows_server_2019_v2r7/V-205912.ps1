...
.EXAMPLE
    .\V-205912.ps1
    .\V-205912.ps1 -ConfigFile stig-config.json
    .\V-205912.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205912"
$Severity = "medium"
$StigID = "WN19-SO-000150"
$RuleTitle = "Windows Server 2019 Smart Card removal option must be configured to Force Logoff or Lock Workstation."
