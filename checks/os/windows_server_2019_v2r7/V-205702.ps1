...
# TODO: Implement check logic for V-205702
Write-Host "TODO: Implement check for V-205702"
Write-Host "Rule: Windows Server 2019 Kerberos user logon restrictions must be enforced."
exit 3
