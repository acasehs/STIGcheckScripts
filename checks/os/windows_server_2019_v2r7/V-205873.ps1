...
.EXAMPLE
    .\V-205873.ps1
    .\V-205873.ps1 -ConfigFile stig-config.json
    .\V-205873.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205873"
$Severity = "medium"
$StigID = "WN19-CC-000390"
$RuleTitle = "Windows Server 2019 must prevent attachments from being downloaded from RSS feeds."
