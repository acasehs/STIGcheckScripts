...
.EXAMPLE
    .\V-205633.ps1
    .\V-205633.ps1 -ConfigFile stig-config.json
    .\V-205633.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205633"
$Severity = "medium"
$StigID = "WN19-SO-000120"
$RuleTitle = "Windows Server 2019 machine inactivity limit must be set to 15 minutes or less, locking the system with the screen saver."
