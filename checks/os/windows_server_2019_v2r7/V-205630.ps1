...
# TODO: Implement check logic for V-205630
Write-Host "TODO: Implement check for V-205630"
Write-Host "Rule: Windows Server 2019 must have the period of time before the bad logon counter is reset configured to"
exit 3
