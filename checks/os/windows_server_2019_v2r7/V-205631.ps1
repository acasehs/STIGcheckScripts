...
.EXAMPLE
    .\V-205631.ps1
    .\V-205631.ps1 -ConfigFile stig-config.json
    .\V-205631.ps1 -ConfigFile stig-config.json -OutputJson results.json
#>
...
$VulnID = "V-205631"
$Severity = "medium"
$StigID = "WN19-SO-000130"
$RuleTitle = "Windows Server 2019 required legal notice must be configured to display before console logon."
