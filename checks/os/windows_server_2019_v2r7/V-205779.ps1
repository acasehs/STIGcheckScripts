...
# TODO: Implement check logic for V-205779
Write-Host "TODO: Implement check for V-205779"
Write-Host "Rule: Windows Server 2019 must be configured to audit System - Other System Events successes."
exit 3
