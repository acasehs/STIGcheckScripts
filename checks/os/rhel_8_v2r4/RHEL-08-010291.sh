...
#
# Check Content:
#     Verify the SSH server is configured to use only ciphers employing FIPS 140-3 approved algorithms._x000D_
_x000D_
To verify the ciphers in the systemwide SSH configuration file, use the following command:_x000D_
_x000D_
$ sudo grep -i ciphers /etc/crypto-policies/back-ends/opensshserver.config _x000D_
-oCiphers=aes256-gcm@openssh.com,aes128-gcm@openssh.com,aes256-ctr,aes128-ctr_x000D_
_x000D_
