...
When a user logs on, the AUID is set to the UID of the account that is b
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the delete_module command in RHEL 8 must generate an audit record."
