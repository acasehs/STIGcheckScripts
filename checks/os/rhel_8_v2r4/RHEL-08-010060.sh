...
The banner must be formatted in accordance with applicable DoD 
#
# Check Content:
...
â€œYou are accessing a U.S. Government (USG) Information System (IS) that is provided for USG-authorized use only.
...
-Communications using, or data stored on, this IS are not private, are subject to ro
#
# Exit Codes:
