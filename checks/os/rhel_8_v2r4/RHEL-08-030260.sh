...
When a user logs on, the AUID is set to the UID of the account tha
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the chcon command in RHEL 8 must generate an audit record."
