...
If the root ca file is not a DoD-issued certificate w
#
# Exit Codes:
...
main() {
    ...
    echo "Rule: RHEL 8, for PKI-based authentication, must validate certificates by constructing a certification path (which includes status information) to an accepted trust anchor."
