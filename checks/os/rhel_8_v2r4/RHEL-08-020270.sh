...
#
# Check Content:
#     Note: If temporary accounts do not exist or are not used this is not applicable.
...
main() {
    ...
    echo "Rule: RHEL 8 must automatically expire temporary accounts within 72 hours."
