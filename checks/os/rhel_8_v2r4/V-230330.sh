...
echo "TODO: Implement check for V-230330"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 8 must not allow users to override SSH environment variables.",
  "status": "$STATUS",
