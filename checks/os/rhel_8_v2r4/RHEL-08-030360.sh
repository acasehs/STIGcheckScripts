...
When a user logs on, the AUID is set to the UID o
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the init_module and finit_module system calls in RHEL 8 must generate an audit record."
