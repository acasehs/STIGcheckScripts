...
#
# Check Content:
#     Verify the iprutils package has not been installed on the system with the following commands:  $ sudo yum list installed iprutils  iprutils.x86_64                                                     2.4.18.1-1.el8                                                  @anaconda  If the iprutils package is...
#
# Exit Codes:
...
echo "TODO: Implement check for V-230560"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "The iprutils package must not be installed unless mission essential on RHEL 8.",
  "status": "$STATUS",
