...
When a user logs on, the AUID is set to the UID of the account that is being authent
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the mount syscall in RHEL 8 must generate an audit record."
