...
_x000D_
Remote access (e.g., RDP) is access to DOD nonpublic information systems by an authorized user (or an information system) communicating through an external, non-organizationally controlled network. Remote access methods include, for example, dial-up, broadband, and wireless._x000D_
_x000D_
Cryptographic mechanisms used for protecting the integrity of information include
#
# Check Content:
#     Verify the SSH client is configured to use only MACs employing FIPS 140-3 approved algorithms with the following command:_x000D_
_x000D_
$ grep -i macs /etc/crypto-policies/back-ends/openssh.config_x000D_
_x000D_
