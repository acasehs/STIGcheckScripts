...
#
# Check Content:
#     Verify the tuned package has not been installed on the system with the following commands:  $ sudo yum list installed tuned  tuned.noarch                                                     2.12.0-3.el8                                                  @anaconda  If the tuned package is installed and...
#
# Exit Codes:
...
echo "TODO: Implement check for V-230561"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "The tuned package must not be installed unless mission essential on RHEL 8.",
  "status": "$STATUS",
