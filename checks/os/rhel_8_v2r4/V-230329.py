...
Rule ID: SV-230329r1017140

Description:
    Failure to restrict system access to authenticated users negatively impacts operating system security.

Check Content:
    Verify the operating system does not allow an unattended or automatic logon to the system via a graphical user interface.  Note: This requirement assumes the use of the RHEL 8 default graphical user interface, Gnome Shell. If the system does not have any graphical user interface installed, this requ...
...
SEVERITY = "high"
RULE_TITLE = """Unattended or automatic logon via the RHEL 8 graphical user interface must not be allowed."""
