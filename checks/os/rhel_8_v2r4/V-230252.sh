...
#
# Check Content:
#     Verify the SSH server is configured to use only ciphers employing FIPS 140-3 approved algorithms._x000D_ _x000D_ To verify the ciphers in the systemwide SSH configuration file, use the following command:_x000D_ _x000D_ $ sudo grep -i ciphers /etc/crypto-policies/back-ends/opensshserver.config _x000D...
#
# Exit Codes:
...
echo "TODO: Implement check for V-230252"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "The RHEL 8 operating system must implement DOD-approved encryption to protect the confidentiality of SSH server connections.",
  "status": "$STATUS",
