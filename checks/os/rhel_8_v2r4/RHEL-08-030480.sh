...
The \"fchown\" system call is used to change the ownership of a file referr
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the chown, fchown, fchownat, and lchown system calls in RHEL 8 must generate an audit record."
