...
When a user logs on, the AUID is set to the UID of the 
#
# Check Content:
...
main() {
    ...
    echo "Rule: Successful/unsuccessful uses of the chage command in RHEL 8 must generate an audit record."
