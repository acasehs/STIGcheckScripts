...
echo "TODO: Implement check for V-230394"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 8 must label all off-loaded audit logs before sending them to the central log server.",
  "status": "$STATUS",
