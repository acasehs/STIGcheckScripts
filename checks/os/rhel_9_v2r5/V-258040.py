...
Check Content:
    Verify there are no wireless interfaces configured on the system with the following command:  Note: This requirement is Not Applicable for systems that do not have physical wireless network radios.  $ nmcli device status  DEVICE                    TYPE            STATE                    CONNECTION ...
...
SEVERITY = "medium"
RULE_TITLE = """RHEL 9 wireless network adapters must be disabled."""
