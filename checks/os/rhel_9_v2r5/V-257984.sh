...
echo "TODO: Implement check for V-257984"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 9 SSHD must not allow blank passwords.",
  "status": "$STATUS",
