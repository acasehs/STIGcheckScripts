...
$Â sudoÂ auditctlÂ -lÂ |Â grepÂ /var/log/tallylog

-wÂ /var/log/tallylogÂ -pÂ waÂ -kÂ logins

IfÂ theÂ commandÂ doesÂ notÂ returnÂ aÂ line,Â orÂ theÂ lineÂ isÂ commentedÂ out, is a finding.
#
# Exit Codes:
...
main() {
    ...
    echo "Rule: RHEL 9 must generate audit records for all account creations, modifications, disabling, and termination events that affect /var/log/tallylog."
