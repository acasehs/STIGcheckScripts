...
Check Content:
    Note: This requirement assumes the use of the RHEL 9 default graphical user interface, the GNOME desktop environment. If the system does not have any graphical user interface installed, this requirement is Not Applicable.  Verify RHEL 9 does not allow an unattended or automatic logon to the system v...
...
SEVERITY = "high"
RULE_TITLE = """RHEL 9 must not allow unattended or automatic logon via the graphical user interface."""
