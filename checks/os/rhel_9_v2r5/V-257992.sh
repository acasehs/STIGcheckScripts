...
echo "TODO: Implement check for V-257992"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 9 must not allow a noncertificate trusted host SSH logon to the system.",
  "status": "$STATUS",
