...
echo "TODO: Implement check for V-258005"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 9 SSH daemon must not allow rhosts authentication.",
  "status": "$STATUS",
