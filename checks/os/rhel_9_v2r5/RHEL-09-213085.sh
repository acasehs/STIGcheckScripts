...
Enabling core dumps on production systems is not recommended; however, there may be overriding operational requirements to enable advanced debugging. Permitting temporary enablement of core dumps during such situations must be reviewed through local needs and p
#
# Check Content:
#     Verify RHEL 9 disables core dump backtraces by issuing the following command:_x000D_
_x000D_
$ grep -i ProcessSizeMax /etc/systemd/coredump.conf_x000D_
_x000D_
ProcessSizeMax=0_x000D_
_x000D_
...
main() {
    CONFIG="/etc/systemd/coredump.conf_x000D_"
