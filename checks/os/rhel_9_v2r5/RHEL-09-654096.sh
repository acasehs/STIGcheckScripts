...
#
# Check Content:
#     Verify RHEL 9 is configured to audit the execution of any system call made by cron as root or as any privileged user.
...
main() {
    ...
    echo "Rule: RHEL 9 must audit any script or executable called by cron as root or by any privileged user."
