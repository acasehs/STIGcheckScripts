...
Utilizing an allowlist provides a configuration management method for allowing the execution of only authorized software. Using only authorized software decreases risk by limiting the number of potential vulnerabilities. Verification of 
#
# Check Content:
...
main() {
    ...
    echo "Rule: RHEL 9 fapolicy module must be enabled."
