...
echo "TODO: Implement check for V-258006"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "RHEL 9 SSH daemon must not allow known hosts authentication.",
  "status": "$STATUS",
