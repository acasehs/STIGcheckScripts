...
echo "TODO: Implement check for V-271868"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must use reverse path filtering on all IPv4 interfaces.",
  "status": "$STATUS",
