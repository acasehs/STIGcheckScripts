...
echo "TODO: Implement check for V-271777"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 SSH server configuration file must be owned by root.",
  "status": "$STATUS",
