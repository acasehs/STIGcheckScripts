...
echo "TODO: Implement check for V-271832"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 duplicate User IDs (UIDs) must not exist for interactive users.",
  "status": "$STATUS",
