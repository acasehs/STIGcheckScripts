...
#
# Check Content:
#     Verify that OL 9 has USBGuard installed on the operating system with the following command:  $ dnf list --installed usbguard Installed Packages usbguard.x86_64                                       1.0.0-15.el9                                        @ol9_appstream  If the USBGuard package is not ins...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271503"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must have the USBGuard package installed.",
  "status": "$STATUS",
