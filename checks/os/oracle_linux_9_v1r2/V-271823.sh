...
#
# Check Content:
#     Verify that OL 9 configures the "/var/log/messages" file to have a mode of "0640" or less permissive with the following command:  $ ls -la /var/log/messages rw-------. 1 root root 564223 July 11 11:34 /var/log/messages  If "/var/log/messages" does not have a mode of "0640" or less permissive, this i...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271823"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 /var/log/messages file must have mode 0640 or less permissive.",
  "status": "$STATUS",
