...
#
# Check Content:
#     Verify that OL 9 system-wide shared library files contained in the following directories have mode "755" or less permissive with the following command:  $ sudo find -L /lib /lib64 /usr/lib /usr/lib64 -perm /022 -type f -exec ls -l {} \;  If any system-wide shared library file is found to be group-wr...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271791"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 library files must have mode 755 or less permissive.",
  "status": "$STATUS",
