...
echo "TODO: Implement check for V-271476"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must restrict privilege elevation to authorized personnel.",
  "status": "$STATUS",
