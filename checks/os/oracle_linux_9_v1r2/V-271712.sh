...
echo "TODO: Implement check for V-271712"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 SSH daemon must not allow known hosts authentication.",
  "status": "$STATUS",
