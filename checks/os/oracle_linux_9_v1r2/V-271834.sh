...
echo "TODO: Implement check for V-271834"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 interactive users must have a primary group that exists.",
  "status": "$STATUS",
