...
echo "TODO: Implement check for V-271509"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must be configured so that the rsyslog service is active.",
  "status": "$STATUS",
