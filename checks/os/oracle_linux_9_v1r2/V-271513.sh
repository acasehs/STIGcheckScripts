...
#
# Check Content:
#     Verify that OL 9 has the nss-tools package installed with the following command:  $ dnf list --installed nss-tools Installed Packages nss-tools.x86_64                                     3.101.0-7.el9_2                                      @ol9_appstream  If the nss-tools package is not installed, t...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271513"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must have the nss-tools package installed.",
  "status": "$STATUS",
