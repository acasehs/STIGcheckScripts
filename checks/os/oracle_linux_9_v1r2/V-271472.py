...
Check Content:
    Verify that OL 9 controls remote access methods.  Inspect the list of enabled firewall ports and verify they are configured correctly by running the following command:  $ sudo firewall-cmd --list-all   Ask the system administrator for the site or program Ports, Protocols, and Services Management Com...
...
SEVERITY = "medium"
RULE_TITLE = """OL 9 must control remote access methods."""
