...
The structure and content of error messages must be carefully considered by the organization and developme
#
# Check Content:
...
main() {
    ...
    echo "Rule: OL 9 /var/log/messages file must have mode 0640 or less permissive."
