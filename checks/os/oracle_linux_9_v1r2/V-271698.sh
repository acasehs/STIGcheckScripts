...
echo "TODO: Implement check for V-271698"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must disable network management of the chrony daemon.",
  "status": "$STATUS",
