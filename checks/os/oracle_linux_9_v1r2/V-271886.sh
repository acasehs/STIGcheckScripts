...
# Rule ID: SV-271886r1092370
#
# Description:
#     Unauthorized disclosure of audit records can reveal system and configuration data to attackers, thus compromising its confidentiality.  Audit information includes all information (e.g., audit records, audit settings, audit reports) needed to successfully audit OL 9 system activity.  In immutable mod...
#
# Check Content:
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 audit system must protect auditing rules from unauthorized change.",
  "status": "$STATUS",
