...
#
# Check Content:
#     Verify that OL 9 has the chrony package installed with the following command:  $ dnf list --installed chrony Installed Packages chrony.x86_64                                      4.5-1.0.2.el9                                      @ol9_baseos_latest          If the chrony package is not installed, th...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271501"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must have the chrony package installed.",
  "status": "$STATUS",
