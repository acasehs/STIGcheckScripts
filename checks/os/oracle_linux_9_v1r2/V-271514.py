...
Rule ID: SV-271514r1091254

Description:
    The pcsc-lite package must be installed if it is to be available for multifactor authentication using smart cards.

Check Content:
    Verify that OL 9 has the pcsc-lite package installed with the following command:  $ dnf list --installed pcsc-lite Installed Packages pcsc-lite.x86_64                                     1.9.4-1.el9                                      @ol9_baseos_latest  If the pcsc-lite package is not installed, t...
...
# Check metadata
VULN_ID = "V-271514"
STIG_ID = "OL09-00-000390"
SEVERITY = "medium"
RULE_TITLE = """OL 9 must have the pcsc-lite package installed."""
