...
echo "TODO: Implement check for V-271725"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must require users to provide a password for privilege escalation.",
  "status": "$STATUS",
