...
echo "TODO: Implement check for V-271778"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 SSH server configuration file must have mode 0600 or less permissive.",
  "status": "$STATUS",
