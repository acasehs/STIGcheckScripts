...
Check Content:
    Verify that OL 9 disables automatic mounting of the USB storage kernel module with the following command:  $ grep usb-storage /etc/modprobe.d/* | grep "/bin/true"  install usb-storage /bin/true  If the command does not return any output, or the line is commented out, this is a finding.  Verify the o...
...
# Check metadata
VULN_ID = "V-271702"
STIG_ID = "OL09-00-002332"
SEVERITY = "medium"
RULE_TITLE = """OL 9 must disable automatic mounting of Universal Serial Bus (USB) mass storage driver."""
