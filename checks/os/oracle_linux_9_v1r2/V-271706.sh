...
echo "TODO: Implement check for V-271706"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 SSHD must not allow blank passwords.",
  "status": "$STATUS",
