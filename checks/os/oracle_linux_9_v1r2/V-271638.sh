...
echo "TODO: Implement check for V-271638"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must not have accounts configured with blank or null passwords.",
  "status": "$STATUS",
