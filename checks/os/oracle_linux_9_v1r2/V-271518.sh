...
#
# Check Content:
#     Verify that OL 9 has the gnutls-utils package installed with the following command:  $ dnf list --installed gnutls-utils Installed Packages gnutls-utils.x86_64                                     3.8.3-4.el9_4                                     @ol9_appstream  If the gnutls-utils package is not ins...
#
# Exit Codes:
...
echo "TODO: Implement check for V-271518"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 must have the gnutls-utils package installed.",
  "status": "$STATUS",
