...
Check Content:
    Verify that OL 9 has the sudo package installed with the following command:  $ dnf list --installed sudo Installed Packages sudo.x86_64                                          1.9.5p2-10.el9_3                                          @anaconda  If the sudo package is not installed, this is a findin...
...
# Check metadata
VULN_ID = "V-271474"
STIG_ID = "OL09-00-000230"
SEVERITY = "medium"
RULE_TITLE = """OL 9 must have the sudo package installed."""
