...
echo "TODO: Implement check for V-271780"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 local files and directories must have a valid group owner.",
  "status": "$STATUS",
