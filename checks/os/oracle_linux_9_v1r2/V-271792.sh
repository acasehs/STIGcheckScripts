...
echo "TODO: Implement check for V-271792"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OL 9 /boot/grub2/grub.cfg file must be group-owned by root.",
  "status": "$STATUS",
