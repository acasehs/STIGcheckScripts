...
def perform_check(config):
    ...
    # Check Content: Verify the system commands contained in the following directories are owned by "root", or a required system account, by using the following command:  
  
     $ sudo find /bin /sbin /usr/bin /usr/sbin
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must have system commands owned by "root" or a system account.')
