...
def perform_check(config):
    ...
    # Check Content: Verify Ubuntu 22.04 LTS enforces a delay of at least four seconds between logon prompts following a failed logon attempt by using the following command:  
  
     $ grep pam_faildelay /etc/pam.d/commo
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must enforce a delay of at least four seconds between logon prompts following a failed logon attempt.')
