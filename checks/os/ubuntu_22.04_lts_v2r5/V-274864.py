...
Multifactor authentication requires using two or more factors to achieve authenticati
...
def perform_check(config):
    ...
    # Check Content: Verify Ubuntu 22.04 LTS has the packages required for multifactor authentication installed with the following command:

$ dpkg -l | grep sssd
ii  sssd     2.9.4-1.1ubuntu6.1     amd64     System Secur
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must have the "SSSD" package installed.')
