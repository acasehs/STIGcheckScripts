...
def perform_check(config):
    ...
    # Check Content: Verify the "chrony" package is installed using the following command: 
  
     $ dpkg -l | grep chrony 
     ii     chrony     4.2-2ubuntu2     amd64     Versatile implementation of the Network Time P
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must have the "chrony" package installed.')
