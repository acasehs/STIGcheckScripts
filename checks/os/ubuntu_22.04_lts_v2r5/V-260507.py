...
def perform_check(config):
    ...
    # Check Content: Verify Ubuntu 22.04 LTS configures the audit tools to be owned by "root" to prevent any unauthorized access with the following command:  
  
     $ stat -c "%n %U" /sbin/auditctl /sbin/aureport /sbin/
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must configure audit tools to be owned by "root".')
