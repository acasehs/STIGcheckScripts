...
When operating systems provide the capability to escalate a functional capability, it i
...
def perform_check(config):
    ...
    # Check Content: Verify the "/etc/sudoers" file has no occurrences of "NOPASSWD" or "!authenticate" by using the following command:
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must require users to reauthenticate for privilege escalation or when changing roles.')
