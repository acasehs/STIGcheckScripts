...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must use DOD PKI-established certificate authorities for verification of the establishment of protected sessions.')
