...
def perform_check(config):
    ...
    # Check Content: Verify that all public directories have the public sticky bit set by using the following command:   
  
     $ sudo find / -type d -perm -002 ! -perm -1000 
  
If any public directories are found miss
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must set a sticky bit on all public directories to prevent unauthorized and unintended information transferred via shared system resources.')
