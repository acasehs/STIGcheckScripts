...
def perform_check(config):
    ...
    # Check Content: Verify the audit log files are owned by "root" account.  
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must be configured to permit only authorized users ownership of the audit log files.')
