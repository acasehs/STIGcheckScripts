...
def perform_check(config):
    ...
    # Check Content: Verify the "ssh.service" is enabled and active by using the following commands:  
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must use SSH to protect the confidentiality and integrity of transmitted information.')
