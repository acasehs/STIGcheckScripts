...
def perform_check(config):
    ...
    # Check Content: Verify the "auditd" package is installed by using the following command:  
  
     $ dpkg -l | grep auditd 
     ii     libauditd     1:3.0.7-1build1     amd64     User space tools for security auditi
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS must have the "auditd" package installed.')
