...
def perform_check(config):
    ...
    # Check Content: Verify the systemwide shared library files contained in the directories "/lib", "/lib64", "/usr/lib", and "/usr/lib64" have mode 0755 or less permissive.

Check that the systemwide shared library file
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS library files must have mode "755" or less permissive.')
