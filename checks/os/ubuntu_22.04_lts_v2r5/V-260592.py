...
def perform_check(config):
    ...
    # Check Content: Verify the audit event multiplexor is configured to offload audit records to a different system from the system being audited.  
...
def main():
    parser = argparse.ArgumentParser(description='Ubuntu 22.04 LTS audit event multiplexor must be configured to offload audit logs onto a different system from the system being audited.')
