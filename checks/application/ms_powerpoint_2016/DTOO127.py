#!/usr/bin/env python3
"""
DTOO127 - Add-ins to Office applications must be signed by a Trusted Publisher._x000D_

STIG ID: DTOO127
Rule Title: Add-ins to Office applications must be signed by a Trusted Publisher._x000D_
Severity: medium
Vuln ID: V-70655
Rule ID: SV-85277r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO127",
        "Rule_Title": "Add-ins to Office applications must be signed by a Trusted Publisher._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO127 - Add-ins to Office applications must be signed by a Trusted Publisher._x000D_",
