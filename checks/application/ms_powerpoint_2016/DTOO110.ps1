...
.EXAMPLE
    .\DTOO110.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO110.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO110"
    Rule_Title = "Blocking as default file block opening behavior must be enforced."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regValueName = "OpenInProtectedView"
    $expectedValue = 0
