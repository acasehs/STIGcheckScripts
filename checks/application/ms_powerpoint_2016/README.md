# Microsoft PowerPoint 2016 STIG Automation Framework

## Overview

This directory contains automated compliance check scripts for the Microsoft PowerPoint 2016 Security Technical Implementation Guide (STIG).
...
- **Office Version:** PowerPoint 2016
- **PowerShell:** 5.1 or higher (for .ps1 scripts)
- **Python:** 3.6 or higher (for .py fallback scripts)

## Office Installation Detection

Before running checks, ensure that PowerPoint 2016 is installed on the system. Checks primarily validate:
...
Most PowerPoint 2016 STIG checks validate Windows Registry settings. Common registry locations include:
...
Most PowerPoint 2016 STIG checks are **highly automatable** because they primarily involve:
