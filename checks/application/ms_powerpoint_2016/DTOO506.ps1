<#
.SYNOPSIS
    DTOO506 - Add-on Management functionality must be allowed in PowerPoint Viewer._x000D_

.DESCRIPTION
    STIG ID: DTOO506
    Rule Title: Add-on Management functionality must be allowed in PowerPoint Viewer._x000D_
    Severity: medium
    Vuln ID: V-70693
    Rule ID: SV-85317r1
...
.EXAMPLE
    .\DTOO506.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO506.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKLM\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_ADDON_MANAGEMENT_x000D_
#>
...
$result = @{
    STIG_ID = "DTOO506"
    Rule_Title = "Add-on Management functionality must be allowed in PowerPoint Viewer._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_ADDON_MANAGEMENT_x000D_"
