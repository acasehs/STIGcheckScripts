<#
.SYNOPSIS
    DTOO117 - The Saved from URL mark must be selected to enforce Internet zone processing in PowerPoint._x000D_

.DESCRIPTION
    STIG ID: DTOO117
    Rule Title: The Saved from URL mark must be selected to enforce Internet zone processing in PowerPoint._x000D_
    Severity: medium
    Vuln ID: V-70647
    Rule ID: SV-85269r1
...
.EXAMPLE
    .\DTOO117.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO117.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO117"
    Rule_Title = "The Saved from URL mark must be selected to enforce Internet zone processing in PowerPoint._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
