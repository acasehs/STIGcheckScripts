#!/usr/bin/env python3
"""
DTOO104 - Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint._x000D_

STIG ID: DTOO104
Rule Title: Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint._x000D_
Severity: medium
Vuln ID: V-70641
Rule ID: SV-85263r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO104",
        "Rule_Title": "Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO104 - Disabling of user name and password syntax from being used in URLs must be enforced in PowerPoint._x000D_",
