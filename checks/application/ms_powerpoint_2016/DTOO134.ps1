...
.EXAMPLE
    .\DTOO134.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO134.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\trusted locations_x000D_"
    $regValueName = "AllowNetworkLocations"
    $expectedValue = 0
