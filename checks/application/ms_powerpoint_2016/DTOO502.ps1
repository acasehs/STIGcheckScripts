<#
.SYNOPSIS
    DTOO502 - The Internet Explorer Bind to Object functionality must be enabled in PowerPoint Viewer._x000D_

.DESCRIPTION
    STIG ID: DTOO502
    Rule Title: The Internet Explorer Bind to Object functionality must be enabled in PowerPoint Viewer._x000D_
    Severity: medium
    Vuln ID: V-70685
    Rule ID: SV-85309r1
...
.EXAMPLE
    .\DTOO502.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO502.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKLM\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_SAFE_BINDTOOBJECT_x000D_
#>
...
$result = @{
    STIG_ID = "DTOO502"
    Rule_Title = "The Internet Explorer Bind to Object functionality must be enabled in PowerPoint Viewer._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_SAFE_BINDTOOBJECT_x000D_"
