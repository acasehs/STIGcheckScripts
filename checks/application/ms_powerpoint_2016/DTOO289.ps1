<#
.SYNOPSIS
    DTOO289 - The ability to run programs from a PowerPoint presentation must be disallowed._x000D_

.DESCRIPTION
    STIG ID: DTOO289
    Rule Title: The ability to run programs from a PowerPoint presentation must be disallowed._x000D_
    Severity: medium
    Vuln ID: V-70677
    Rule ID: SV-85301r1
...
.EXAMPLE
    .\DTOO289.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO289.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO289"
    Rule_Title = "The ability to run programs from a PowerPoint presentation must be disallowed._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
