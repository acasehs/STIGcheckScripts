...
.EXAMPLE
    .\DTOO119.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO119.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\filevalidation_x000D_"
    $regValueName = "EnableOnLoad"
    $expectedValue = 1
