<#
.SYNOPSIS
    DTOO211 - ActiveX Installs must be configured for proper restriction in PowerPoint._x000D_

.DESCRIPTION
    STIG ID: DTOO211
    Rule Title: ActiveX Installs must be configured for proper restriction in PowerPoint._x000D_
    Severity: medium
    Vuln ID: V-70675
    Rule ID: SV-85297r1
...
.EXAMPLE
    .\DTOO211.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO211.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO211"
    Rule_Title = "ActiveX Installs must be configured for proper restriction in PowerPoint._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
