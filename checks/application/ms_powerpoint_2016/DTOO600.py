#!/usr/bin/env python3
"""
DTOO600 - Macros must be blocked from running in Office files from the Internet._x000D_

STIG ID: DTOO600
Rule Title: Macros must be blocked from running in Office files from the Internet._x000D_
Severity: medium
Vuln ID: V-70701
Rule ID: SV-85325r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO600",
        "Rule_Title": "Macros must be blocked from running in Office files from the Internet._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "blockcontentexecutionfrominternet"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO600 - Macros must be blocked from running in Office files from the Internet._x000D_",
