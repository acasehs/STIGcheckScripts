...
.NOTES
    ...
    Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview _x000D_
...
$result = @{
    STIG_ID = "DTOO288"
    Rule_Title = "Files in unsafe locations must be opened in Protected View."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview _x000D_"
