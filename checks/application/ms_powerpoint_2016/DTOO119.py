#!/usr/bin/env python3
"""
DTOO119 - Configuration for file validation must be enforced._x000D_

STIG ID: DTOO119
Rule Title: Configuration for file validation must be enforced._x000D_
Severity: medium
Vuln ID: V-70649
Rule ID: SV-85271r1
...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\filevalidation_x000D_
    Value: EnableOnLoad
    Type: REG_DWORD
    Expected: 1
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO119",
        "Rule_Title": "Configuration for file validation must be enforced._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\filevalidation_x000D_"
        value_name = "EnableOnLoad"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO119 - Configuration for file validation must be enforced._x000D_",
