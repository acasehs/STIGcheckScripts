#!/usr/bin/env python3
"""
DTOO304 - Warning Bar settings for VBA macros must be configured._x000D_

STIG ID: DTOO304
Rule Title: Warning Bar settings for VBA macros must be configured._x000D_
Severity: medium
Vuln ID: V-70681
Rule ID: SV-85305r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO304",
        "Rule_Title": "Warning Bar settings for VBA macros must be configured._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO304 - Warning Bar settings for VBA macros must be configured._x000D_",
