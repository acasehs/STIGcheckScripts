#!/usr/bin/env python3
"""
DTOO131 - Trust Bar Notifications for unsigned application add-ins must be blocked._x000D_

STIG ID: DTOO131
Rule Title: Trust Bar Notifications for unsigned application add-ins must be blocked._x000D_
Severity: medium
Vuln ID: V-70659
Rule ID: SV-85281r1
...
Registry Check:
    Key: HKCU\software\policies\Microsoft\office\16.0\powerpoint\security_x000D_
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO131",
        "Rule_Title": "Trust Bar Notifications for unsigned application add-ins must be blocked._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\powerpoint\security_x000D_"
        value_name = "notbpromptunsignedaddin"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO131 - Trust Bar Notifications for unsigned application add-ins must be blocked._x000D_",
