<#
.SYNOPSIS
    DTOO209 - Protection from zone elevation must be enforced in PowerPoint._x000D_

.DESCRIPTION
    STIG ID: DTOO209
    Rule Title: Protection from zone elevation must be enforced in PowerPoint._x000D_
    Severity: medium
    Vuln ID: V-70673
    Rule ID: SV-85295r1
...
.EXAMPLE
    .\DTOO209.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO209.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO209"
    Rule_Title = "Protection from zone elevation must be enforced in PowerPoint._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
