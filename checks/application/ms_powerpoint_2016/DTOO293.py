#!/usr/bin/env python3
"""
DTOO293 - Attachments opened from Outlook must be in Protected View._x000D_

STIG ID: DTOO293
Rule Title: Attachments opened from Outlook must be in Protected View._x000D_
Severity: medium
Vuln ID: V-70679
Rule ID: SV-85303r1
...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview_x000D_
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO293",
        "Rule_Title": "Attachments opened from Outlook must be in Protected View._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview_x000D_"
        value_name = "DisableAttachmentsInPV"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO293 - Attachments opened from Outlook must be in Protected View._x000D_",
