<#
.SYNOPSIS
    DTOO126 - Add-on Management functionality must be allowed in PowerPoint._x000D_

.DESCRIPTION
    STIG ID: DTOO126
    Rule Title: Add-on Management functionality must be allowed in PowerPoint._x000D_
    Severity: medium
    Vuln ID: V-70653
    Rule ID: SV-85275r1
...
.EXAMPLE
    .\DTOO126.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO126.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO126"
    Rule_Title = "Add-on Management functionality must be allowed in PowerPoint._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
