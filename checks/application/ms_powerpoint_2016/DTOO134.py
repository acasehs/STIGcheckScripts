#!/usr/bin/env python3
"""
DTOO134 - Disallowance of trusted locations on the network must be enforced._x000D_

STIG ID: DTOO134
Rule Title: Disallowance of trusted locations on the network must be enforced._x000D_
Severity: medium
Vuln ID: V-70665
Rule ID: SV-85287r1
...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\trusted locations_x000D_
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO134",
        "Rule_Title": "Disallowance of trusted locations on the network must be enforced._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\trusted locations_x000D_"
        value_name = "AllowNetworkLocations"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO134 - Disallowance of trusted locations on the network must be enforced._x000D_",
