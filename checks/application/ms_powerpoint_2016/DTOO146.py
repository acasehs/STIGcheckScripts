#!/usr/bin/env python3
"""
DTOO146 - Trust access for VBA must be disallowed._x000D_

STIG ID: DTOO146
Rule Title: Trust access for VBA must be disallowed._x000D_
Severity: medium
Vuln ID: V-70671
Rule ID: SV-85293r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO146",
        "Rule_Title": "Trust access for VBA must be disallowed._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO146 - Trust access for VBA must be disallowed._x000D_",
