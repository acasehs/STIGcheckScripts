<#
.SYNOPSIS
    DTOO142 - The scanning of encrypted macros in open XML documents must be enforced._x000D_

.DESCRIPTION
    STIG ID: DTOO142
    Rule Title: The scanning of encrypted macros in open XML documents must be enforced._x000D_
    Severity: medium
    Vuln ID: V-70669
    Rule ID: SV-85291r1
...
$result = @{
    STIG_ID = "DTOO142"
    Rule_Title = "The scanning of encrypted macros in open XML documents must be enforced._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
