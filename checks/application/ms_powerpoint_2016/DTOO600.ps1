...
.EXAMPLE
    .\DTOO600.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO600.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\powerpoint\security_x000D_"
    $regValueName = "blockcontentexecutionfrominternet"
    $expectedValue = 1
