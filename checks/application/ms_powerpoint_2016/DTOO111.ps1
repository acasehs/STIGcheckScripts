<#
.SYNOPSIS
    DTOO111 - The Internet Explorer Bind to Object functionality must be enabled in PowerPoint._x000D_

.DESCRIPTION
    STIG ID: DTOO111
    Rule Title: The Internet Explorer Bind to Object functionality must be enabled in PowerPoint._x000D_
    Severity: medium
    Vuln ID: V-70645
    Rule ID: SV-85267r1
...
.EXAMPLE
    .\DTOO111.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO111.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO111"
    Rule_Title = "The Internet Explorer Bind to Object functionality must be enabled in PowerPoint._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
