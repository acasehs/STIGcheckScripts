#!/usr/bin/env python3
"""
DTOO133 - All automatic loading from trusted locations must be disabled._x000D_

STIG ID: DTOO133
Rule Title: All automatic loading from trusted locations must be disabled._x000D_
Severity: medium
Vuln ID: V-70663
Rule ID: SV-85285r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO133",
        "Rule_Title": "All automatic loading from trusted locations must be disabled._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "AllLocationsDisabled"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO133 - All automatic loading from trusted locations must be disabled._x000D_",
