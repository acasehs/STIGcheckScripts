<#
.SYNOPSIS
    DTOO126 - Add-on Management functionality must be allowed._x000D_

.DESCRIPTION
    STIG ID: DTOO126
    Rule Title: Add-on Management functionality must be allowed._x000D_
    Severity: medium
    Vuln ID: V-71057
    Rule ID: SV-85681r1
...
$result = @{
    STIG_ID = "DTOO126"
    Rule_Title = "Add-on Management functionality must be allowed._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
