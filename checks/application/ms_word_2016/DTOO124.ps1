<#
.SYNOPSIS
    DTOO124 - Scripted Window Security must be enforced._x000D_

.DESCRIPTION
    STIG ID: DTOO124
    Rule Title: Scripted Window Security must be enforced._x000D_
    Severity: medium
    Vuln ID: V-71055
    Rule ID: SV-85679r1
...
.EXAMPLE
    .\DTOO124.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO124.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO124"
    Rule_Title = "Scripted Window Security must be enforced._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
