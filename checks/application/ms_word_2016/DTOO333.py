#!/usr/bin/env python3
"""
DTOO333 - Word 2 and earlier binary documents and templates must be blocked for open/save._x000D_

STIG ID: DTOO333
Rule Title: Word 2 and earlier binary documents and templates must be blocked for open/save._x000D_
Severity: medium
Vuln ID: V-71093
Rule ID: SV-85717r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO333",
        "Rule_Title": "Word 2 and earlier binary documents and templates must be blocked for open/save._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO333 - Word 2 and earlier binary documents and templates must be blocked for open/save._x000D_",
