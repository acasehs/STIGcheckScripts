<#
.SYNOPSIS
    DTOO211 - ActiveX Installs must be configured for proper restriction._x000D_

.DESCRIPTION
    STIG ID: DTOO211
    Rule Title: ActiveX Installs must be configured for proper restriction._x000D_
    Severity: medium
    Vuln ID: V-71079
    Rule ID: SV-85703r1
...
$result = @{
    STIG_ID = "DTOO211"
    Rule_Title = "ActiveX Installs must be configured for proper restriction._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
