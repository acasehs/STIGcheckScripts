#!/usr/bin/env python3
"""
DTOO337 - Word 95 binary documents and templates must be configured to edit in protected view._x000D_

STIG ID: DTOO337
Rule Title: Word 95 binary documents and templates must be configured to edit in protected view._x000D_
Severity: medium
Vuln ID: V-71099
Rule ID: SV-85723r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO337",
        "Rule_Title": "Word 95 binary documents and templates must be configured to edit in protected view._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO337 - Word 95 binary documents and templates must be configured to edit in protected view._x000D_",
