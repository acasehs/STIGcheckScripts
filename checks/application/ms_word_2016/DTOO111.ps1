<#
.SYNOPSIS
    DTOO111 - The Internet Explorer Bind to Object functionality must be enabled._x000D_

.DESCRIPTION
    STIG ID: DTOO111
    Rule Title: The Internet Explorer Bind to Object functionality must be enabled._x000D_
    Severity: medium
    Vuln ID: V-71045
    Rule ID: SV-85669r1
...
$result = @{
    STIG_ID = "DTOO111"
    Rule_Title = "The Internet Explorer Bind to Object functionality must be enabled._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
