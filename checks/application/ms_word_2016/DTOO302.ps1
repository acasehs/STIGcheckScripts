...
.EXAMPLE
    .\DTOO302.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO302.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\word\options_x000D_"
    $regValueName = "DontUpdateLinks"
    $expectedValue = 1
