<#
.SYNOPSIS
    DTOO132 - File Downloads must be configured for proper restrictions._x000D_

.DESCRIPTION
    STIG ID: DTOO132
    Rule Title: File Downloads must be configured for proper restrictions._x000D_
    Severity: medium
    Vuln ID: V-71065
    Rule ID: SV-85689r1
...
$result = @{
    STIG_ID = "DTOO132"
    Rule_Title = "File Downloads must be configured for proper restrictions._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
