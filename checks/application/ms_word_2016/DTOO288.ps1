...
.EXAMPLE
    .\DTOO288.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO288.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\word\security\protectedview _x000D_"
    $regValueName = "DisableUnsafeLocationsInPV"
    $expectedValue = 0
