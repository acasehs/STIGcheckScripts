#!/usr/bin/env python3
"""
DTOO288 - Files in unsafe locations must be opened in Protected View._x000D_

STIG ID: DTOO288
Rule Title: Files in unsafe locations must be opened in Protected View._x000D_
Severity: medium
Vuln ID: V-71081
Rule ID: SV-85705r1
...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\word\security\protectedview _x000D_
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO288",
        "Rule_Title": "Files in unsafe locations must be opened in Protected View._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\word\security\protectedview _x000D_"
        value_name = "DisableUnsafeLocationsInPV"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO288 - Files in unsafe locations must be opened in Protected View._x000D_",
