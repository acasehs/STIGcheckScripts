#!/usr/bin/env python3
"""
DTOO339 - Word XP binary documents and templates must be configured to edit in protected view._x000D_

STIG ID: DTOO339
Rule Title: Word XP binary documents and templates must be configured to edit in protected view._x000D_
Severity: medium
Vuln ID: V-71103
Rule ID: SV-85727r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO339",
        "Rule_Title": "Word XP binary documents and templates must be configured to edit in protected view._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO339 - Word XP binary documents and templates must be configured to edit in protected view._x000D_",
