<#
.SYNOPSIS
    DTOO117 - Saved from URL mark to assure Internet zone processing must be enforced._x000D_

.DESCRIPTION
    STIG ID: DTOO117
    Rule Title: Saved from URL mark to assure Internet zone processing must be enforced._x000D_
    Severity: medium
    Vuln ID: V-71047
    Rule ID: SV-85671r1
...
$result = @{
    STIG_ID = "DTOO117"
    Rule_Title = "Saved from URL mark to assure Internet zone processing must be enforced._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
