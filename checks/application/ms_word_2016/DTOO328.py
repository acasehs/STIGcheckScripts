#!/usr/bin/env python3
"""
DTOO328 - Online translation dictionaries must not be used._x000D_

STIG ID: DTOO328
Rule Title: Online translation dictionaries must not be used._x000D_
Severity: medium
Vuln ID: V-71091
Rule ID: SV-85715r1
...
Registry Check:
    Key: HKCU\software\policies\Microsoft\office\16.0\common\research\translation_x000D_
    Value: useonline
    Type: REG_DWORD
    Expected: 0
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO328",
        "Rule_Title": "Online translation dictionaries must not be used._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\common\research\translation_x000D_"
        value_name = "useonline"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO328 - Online translation dictionaries must not be used._x000D_",
