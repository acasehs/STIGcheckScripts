#!/usr/bin/env python3
"""
DTOO110 - Blocking as default file block opening behavior must be enforced._x000D_

STIG ID: DTOO110
Rule Title: Blocking as default file block opening behavior must be enforced._x000D_
Severity: medium
Vuln ID: V-71043
Rule ID: SV-85667r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO110",
        "Rule_Title": "Blocking as default file block opening behavior must be enforced._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "OpenInProtectedView"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO110 - Blocking as default file block opening behavior must be enforced._x000D_",
