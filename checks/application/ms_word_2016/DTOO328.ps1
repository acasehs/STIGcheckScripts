...
.EXAMPLE
    .\DTOO328.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO328.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\software\policies\Microsoft\office\16.0\common\research\translation_x000D_"
    $regValueName = "useonline"
    $expectedValue = 0
