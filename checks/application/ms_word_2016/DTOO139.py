...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\word\options _x000D_
    Value: DefaultFormat
    Type: REG_SZ
    Expected: (blank)
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\word\options _x000D_"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO139 - The Save commands default file format must be configured._x000D_",
