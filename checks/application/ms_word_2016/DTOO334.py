#!/usr/bin/env python3
"""
DTOO334 - Word 2000 binary documents and templates must be configured to edit in protected view._x000D_

STIG ID: DTOO334
Rule Title: Word 2000 binary documents and templates must be configured to edit in protected view._x000D_
Severity: medium
Vuln ID: V-71095
Rule ID: SV-85719r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO334",
        "Rule_Title": "Word 2000 binary documents and templates must be configured to edit in protected view._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO334 - Word 2000 binary documents and templates must be configured to edit in protected view._x000D_",
