<#
.SYNOPSIS
    DTOO129 - Links that invoke instances of Internet Explorer from within an Office product must be blocked._x000D_

.DESCRIPTION
    STIG ID: DTOO129
    Rule Title: Links that invoke instances of Internet Explorer from within an Office product must be blocked._x000D_
    Severity: medium
    Vuln ID: V-71061
    Rule ID: SV-85685r1
...
$result = @{
    STIG_ID = "DTOO129"
    Rule_Title = "Links that invoke instances of Internet Explorer from within an Office product must be blocked._x000D_"
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
