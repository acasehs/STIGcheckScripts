#!/usr/bin/env python3
"""
DTOO336 - Word 6.0 binary documents and templates must be configured for block open/save actions._x000D_

STIG ID: DTOO336
Rule Title: Word 6.0 binary documents and templates must be configured for block open/save actions._x000D_
Severity: medium
Vuln ID: V-71097
Rule ID: SV-85721r1
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO336",
        "Rule_Title": "Word 6.0 binary documents and templates must be configured for block open/save actions._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\word\security\fileblock_x000D_"
        value_name = "Word60Files"
        expected_value = 2
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO336 - Word 6.0 binary documents and templates must be configured for block open/save actions._x000D_",
