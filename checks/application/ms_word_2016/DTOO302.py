#!/usr/bin/env python3
"""
DTOO302 - The automatically update links feature must be disabled._x000D_

STIG ID: DTOO302
Rule Title: The automatically update links feature must be disabled._x000D_
Severity: medium
Vuln ID: V-71087
Rule ID: SV-85711r1
...
Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\word\options_x000D_
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO302",
        "Rule_Title": "The automatically update links feature must be disabled._x000D_",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\word\options_x000D_"
        value_name = "DontUpdateLinks"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO302 - The automatically update links feature must be disabled._x000D_",
