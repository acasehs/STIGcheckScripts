...
Although there is some latitude concerning the settings, they should follow DoD-recommended values, but the settings should be configurable to allow for future DoD direction. While the DoD will specify recommended values, the value
...
try {
    ...
    Write-Output "Rule: The Apache web server must limit the number of allowed simultaneous session requests."
