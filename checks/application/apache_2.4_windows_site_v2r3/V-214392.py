...
def run_check(config=None):
    ...
    # Add or modify the "Timeout" directive in the Apache configuration to have a value of "60" seconds or less.  "Timeout 60"
