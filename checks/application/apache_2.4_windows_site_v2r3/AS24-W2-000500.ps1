...
By being able to guess session IDs, an attacker can easily perform a man-in-the-middle a
...
try {
    ...
    Write-Output "Rule: The Apache web server must generate unique session identifiers that cannot be reliably reproduced."
