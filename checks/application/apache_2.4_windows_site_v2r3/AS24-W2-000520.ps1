...
By generating session IDs that contain as much of the character set as possible, 
...
try {
    ...
    Write-Output "Rule: The Apache web server must generate a session ID using as much of the character set as possible to reduce the risk of brute force."
