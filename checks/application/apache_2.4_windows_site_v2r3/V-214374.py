...
STIG ID: AS24-W2-000450
Rule ID: SV-214374r961095

Description:
    The separation of user functionality from web server management can be accomplished by moving management functions to a separate IP address or port. To further separate the management functions, separate authentication methods and certificates should be used.  By moving the management functionality,...
...
# Check metadata
VULN_ID = "V-214374"
STIG_ID = "AS24-W2-000450"
SEVERITY = "medium"
RULE_TITLE = """The Apache web server must separate the hosted applications from hosted Apache web server management functionality."""
