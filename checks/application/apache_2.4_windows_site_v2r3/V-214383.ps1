...
# Show help
if ($Help) {
    Write-Host "Usage: .\V-214383.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
