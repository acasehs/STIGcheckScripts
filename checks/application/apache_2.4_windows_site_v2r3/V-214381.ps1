...
#
# Description:
# The web server may host applications that display information that cannot be disrupted, such as information that is time critical or life threatening. In these cases, a web server that shuts down or ceases to be accessible when there is a failure is not acceptable. In these types of cases, clusterin...
#
...
# Configuration
$VulnID = "V-214381"
$StigID = "AS24-W2-000560"
$Severity = "medium"
$RuleTitle = "The Apache web server must be configured to provide clustering."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214381.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
