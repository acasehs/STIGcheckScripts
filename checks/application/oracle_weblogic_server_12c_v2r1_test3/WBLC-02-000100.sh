...
# STIG ID: WBLC-02-000100
# Rule ID: SV-235959r628655_rule
#
# Description:
...
It is, therefore, imperative that access to audit tools be controlled and protected from unauthorized modification. If an attacker were to delete audit tools the application server administrators would have no way of man
#
# Check Content:
#     1. Access AC
