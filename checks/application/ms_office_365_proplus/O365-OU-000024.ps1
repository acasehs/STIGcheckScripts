...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: When an untrusted program attempts to gain access to a recipient field...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Security Form Settings >> Programmatic Security >> Configure Outlook object model prompt when reading address information is set to "Enabled (Automatically Deny)"."
$ExpectedValue = "1"
