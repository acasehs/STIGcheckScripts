...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Publisher must automatically disable unsigned add-ins without informin...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\publisher\security"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Publisher 2016 >> Security >> Trust Center >> Disable Trust Bar Notification for unsigned application add-ins is set to "Enabled"."
$ExpectedValue = "1"
