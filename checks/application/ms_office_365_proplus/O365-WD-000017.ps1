...
.EXAMPLE
    .\O365-WD-000017.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000017.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000017"
    Rule_Title = "Trusted Locations on the network must be disabled in Word."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\word\security\trusted locations"
