...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\word\security\trusted"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Word 2016 >> Word Options >> Security >> Trust Center >> Trusted Locations >> Allow Trusted Locations on the network is set to "Disabled"."
$ExpectedValue = "1"
