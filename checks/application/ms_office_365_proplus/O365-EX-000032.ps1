...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files from unsafe locations must be opened in Excel in Protected View ...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> Protected View >> Do not open files in unsafe locations in Protected View is set to "Disabled"."
$ExpectedValue = "1"
