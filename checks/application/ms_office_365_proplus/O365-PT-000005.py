...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000005",
        "Rule_Title": "Encrypted macros in PowerPoint Open XML presentations must be scanned.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000005 - Encrypted macros in PowerPoint Open XML presentations must be scanned.",
