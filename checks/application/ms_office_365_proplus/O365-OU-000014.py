...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000014",
        "Rule_Title": "The Outlook Security Mode must be enabled to always use the Outlook Security Group Policy.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000014 - The Outlook Security Mode must be enabled to always use the Outlook Security Group Policy.",
