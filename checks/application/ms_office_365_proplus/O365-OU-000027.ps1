...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Outlook must be configured to not allow hyperlinks in suspected phishi...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Trust Center "Allow hyperlinks in suspected phishing e-mail messages" is set to "Disabled"."
$ExpectedValue = "1"
