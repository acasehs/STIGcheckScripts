...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files downloaded from the Internet must be opened in Protected view in...
...
$RegPath = "HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft PowerPoint 2016 >> PowerPoint Options >> Security >> Trust Center >> Protected View "Do not open files from the Internet zone in Protected View" is set to "Disabled"."
$ExpectedValue = "1"
