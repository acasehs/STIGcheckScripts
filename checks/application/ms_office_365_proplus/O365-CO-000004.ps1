...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Custom user interface (UI) code must be blocked from loading in all Of...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Global Options >> Customize >> Disable UI extending from documents and templates is set to Enabled: Disallow in Word; Excel; PowerPoint; Access; Outlook; Publisher; Project; Visio; InfoPath"
$ExpectedValue = "1"
