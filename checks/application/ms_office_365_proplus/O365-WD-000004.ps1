...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files located in unsafe locations must be opened in Protected view in ...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\word\security\protectedview."
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Word 2016 >> Word Options >> Security >> Trust Center >> Protected View >> Do not open files in unsafe locations in Protected View is set to "Disabled"."
$ExpectedValue = "1"
