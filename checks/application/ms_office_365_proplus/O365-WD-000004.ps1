...
.EXAMPLE
    .\O365-WD-000004.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000004.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000004"
    Rule_Title = "Files located in unsafe locations must be opened in Protected view in Word."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
