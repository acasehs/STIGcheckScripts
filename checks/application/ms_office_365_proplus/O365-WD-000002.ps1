...
.EXAMPLE
    .\O365-WD-000002.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000002.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000002"
    Rule_Title = "In Word, encrypted macros must be scanned."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
