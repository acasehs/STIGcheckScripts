...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000007",
        "Rule_Title": "Active X One-Off forms must only be enabled to load with Outlook Controls.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000007 - Active X One-Off forms must only be enabled to load with Outlook Controls.",
