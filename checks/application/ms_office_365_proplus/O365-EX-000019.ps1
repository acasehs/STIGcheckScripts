...
.EXAMPLE
    .\O365-EX-000019.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000019.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\excel\options\binaryoptions_x000D_
#>
...
$result = @{
    STIG_ID = "O365-EX-000019"
    Rule_Title = "Updating of links in Excel must be prompted and not automatic."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\excel\options\binaryoptions_x000D_"
