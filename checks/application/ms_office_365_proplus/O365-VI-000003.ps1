...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Visio must automatically disable unsigned add-ins without informing us...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Visio 2016 >> Visio Options >> Security >> Trust Center >> Disable Trust Bar Notification for unsigned application add-ins and block them is set to Enabled."
$ExpectedValue = "1"
