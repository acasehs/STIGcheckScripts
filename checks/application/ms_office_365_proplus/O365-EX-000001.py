...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000001",
        "Rule_Title": "Trusted Locations on the network must be disabled in Excel.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\excel\security\trusted locations"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000001 - Trusted Locations on the network must be disabled in Excel.",
