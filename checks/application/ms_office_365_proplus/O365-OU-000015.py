...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000015",
        "Rule_Title": "The ability to demote attachments from Level 2 to Level 1 must be disabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000015 - The ability to demote attachments from Level 2 to Level 1 must be disabled.",
