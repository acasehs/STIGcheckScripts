...
.EXAMPLE
    .\O365-EX-000021.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000021.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000021"
    Rule_Title = "AutoRepublish in Excel must be disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
