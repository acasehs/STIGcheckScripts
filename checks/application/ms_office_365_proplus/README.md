# Microsoft Office 365 ProPlus STIG Automation Framework

## Overview

This directory contains automated compliance check scripts for the Microsoft Office 365 ProPlus Security Technical Implementation Guide (STIG).
...
- **Office Version:** Office 365 ProPlus
- **PowerShell:** 5.1 or higher (for .ps1 scripts)
- **Python:** 3.6 or higher (for .py fallback scripts)

## Office Installation Detection

Before running checks, ensure that Office 365 ProPlus is installed on the system. Checks primarily validate:
...
Most Office 365 ProPlus STIG checks validate Windows Registry settings. Common registry locations include:
...
Most Office 365 ProPlus STIG checks are **highly automatable** because they primarily involve:
