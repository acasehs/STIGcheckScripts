...
Registry Check:
    ...
    Value: OpenXMLEncryption
    Type: REG_SZ
    Expected: "Microsoft Enhanced RSA and AES Cryptographic Provider
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-CO-000009",
        "Rule_Title": "Office applications must be configured to specify encryption type in password-protected Office Open XML files.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\common\security"
        value_name = "OpenXMLEncryption"
        expected_value = "Microsoft Enhanced RSA and AES Cryptographic Provider
        value_type = "SZ"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-CO-000009 - Office applications must be configured to specify encryption type in password-protected Office Open XML files.",
