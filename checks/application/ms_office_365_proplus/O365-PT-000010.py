...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000010",
        "Rule_Title": "PowerPoint attachments opened from Outlook must be in Protected View.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000010 - PowerPoint attachments opened from Outlook must be in Protected View.",
