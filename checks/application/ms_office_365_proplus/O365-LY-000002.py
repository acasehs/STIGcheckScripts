...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-LY-000002",
        "Rule_Title": "The HTTP fallback for SIP connection in Lync must be disabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKLM\Software\Policies\Microsoft\office\16.0\lync"
        value_name = "disablehttpconnect"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-LY-000002 - The HTTP fallback for SIP connection in Lync must be disabled.",
