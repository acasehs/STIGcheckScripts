...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The ability to demote attachments from Level 2 to Level 1 must be disa...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Security Form Settings >> Attachment Security >> Allow users to demote attachments to Level 2 is set to "Disabled"."
$ExpectedValue = "1"
