...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Trust Bar notifications must be configured to display information in t...
...
$RegValue = "for User Configuration >> Microsoft Office 2016 >> Security Settings >> Disable all Trust Bar notifications for security issues is set to "Disabled"."
$ExpectedValue = "1"
