...
.EXAMPLE
    .\O365-CO-000007.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000007.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\common\trustcenter"
    $regValueName = "trustbar"
    $expectedValue = 0
