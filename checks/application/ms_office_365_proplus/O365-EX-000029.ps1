...
.EXAMPLE
    .\O365-EX-000029.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000029.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\Software\Policies\Microsoft\Office\16.0\excel\security\external content._x000D_
#>
...
$result = @{
    STIG_ID = "O365-EX-000029"
    Rule_Title = "Untrusted Microsoft Query files must be blocked from opening in Excel."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\excel\security\external content._x000D_"
