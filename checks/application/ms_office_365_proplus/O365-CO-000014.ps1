...
.EXAMPLE
    .\O365-CO-000014.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000014.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000014"
    Rule_Title = "Add-on Management must be enabled for all Office 365 ProPlus programs."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
