...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000034",
        "Rule_Title": "File attachments from Outlook must be opened in Excel in Protected mode.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000034 - File attachments from Outlook must be opened in Excel in Protected mode.",
