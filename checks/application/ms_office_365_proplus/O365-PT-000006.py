...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000006",
        "Rule_Title": "File validation in PowerPoint must be enabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\filevalidation"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000006 - File validation in PowerPoint must be enabled.",
