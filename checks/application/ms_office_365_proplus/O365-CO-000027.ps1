...
.EXAMPLE
    .\O365-CO-000027.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000027.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000027"
    Rule_Title = "Flash player activation must be disabled in all Office programs."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\SOFTWARE\Microsoft\Office\Common\COM Compatibility"
