...
$RegPath = "HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\trusted"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft PowerPoint 2016 >> PowerPoint Options >> Security >> Trust Center >> Trusted Locations "Allow Trusted Locations on the network" is set to "Disabled"."
$ExpectedValue = "1"
