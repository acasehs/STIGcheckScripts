...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: File attachments from Outlook must be opened in Excel in Protected mod...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\excel\security\protectedview"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> Protected View >> Turn off Protected View for attachments opened from Outlook is set to "Disabled"."
$ExpectedValue = "1"
