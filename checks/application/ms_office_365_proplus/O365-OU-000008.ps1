...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Outlook must be configured to prevent users overriding attachment secu...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\outlook"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Prevent users from customizing attachment security settings is set to "Enabled"."
$ExpectedValue = "1"
