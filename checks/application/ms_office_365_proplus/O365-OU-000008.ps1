...
.EXAMPLE
    .\O365-OU-000008.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000008.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-OU-000008"
    Rule_Title = "Outlook must be configured to prevent users overriding attachment security settings."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
