...
.EXAMPLE
    .\O365-CO-000001.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000001.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\common\security_x000D_
#>
...
$result = @{
    STIG_ID = "O365-CO-000001"
    Rule_Title = "The Macro Runtime Scan Scope must be enabled for all documents."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\common\security_x000D_"
