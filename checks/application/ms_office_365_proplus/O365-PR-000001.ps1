...
.EXAMPLE
    .\O365-PR-000001.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-PR-000001.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\ms project\security\trusted locations"
