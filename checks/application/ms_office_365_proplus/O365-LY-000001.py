...
Registry Check:
    ...
    Value: enablesiphighsecuritymode
    Type: REG_DWORD
    Expected: 1
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-LY-000001",
        "Rule_Title": "The SIP security mode in Lync must be enabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "enablesiphighsecuritymode"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-LY-000001 - The SIP security mode in Lync must be enabled.",
