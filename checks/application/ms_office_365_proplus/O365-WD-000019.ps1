...
.EXAMPLE
    .\O365-WD-000019.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000019.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000019"
    Rule_Title = "File validation in Word must be enabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
