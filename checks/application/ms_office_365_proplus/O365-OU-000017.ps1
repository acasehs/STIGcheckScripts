...
.EXAMPLE
    .\O365-OU-000017.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000017.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\outlook\security\FileExtensionsRemoveLevel1
#>
...
$result = @{
    STIG_ID = "O365-OU-000017"
    Rule_Title = "Level 1 file attachments must be blocked from being delivered."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\outlook\security\FileExtensionsRemoveLevel1"
