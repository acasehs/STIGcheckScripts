...
.EXAMPLE
    .\O365-VI-000002.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-VI-000002.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-VI-000002"
    Rule_Title = "Trusted Locations on the network must be disabled in Visio."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\visio\security\trusted locations"
