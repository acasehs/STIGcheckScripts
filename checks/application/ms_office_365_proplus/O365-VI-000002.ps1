...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\visio\security\trusted"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Visio 2016 >> Visio Options >> Security >> Trust Center >> Allow Trusted Locations on the network is set to "Disabled"."
$ExpectedValue = "1"
