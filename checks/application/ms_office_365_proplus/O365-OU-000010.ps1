...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The Publish to Global Address List (GAL) button must be disabled in Ou...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Cryptography >> Do not display 'Publish to GAL' button is set to "Enabled"."
$ExpectedValue = "1"
