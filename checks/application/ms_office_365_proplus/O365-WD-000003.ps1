...
.EXAMPLE
    .\O365-WD-000003.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000003.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000003"
    Rule_Title = "Files downloaded from the Internet must be opened in Protected view in Word."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
