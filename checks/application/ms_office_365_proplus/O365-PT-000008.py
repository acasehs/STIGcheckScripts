...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000008",
        "Rule_Title": "Unsigned add-ins in PowerPoint must be blocked with no Trust Bar Notification to the user.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\powerpoint\security"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000008 - Unsigned add-ins in PowerPoint must be blocked with no Trust Bar Notification to the user.",
