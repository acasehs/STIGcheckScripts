...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: When an untrusted program attempts to programmatically send e-mail in ...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Security Form Settings >> Programmatic Security >> Configure Outlook object model prompt when responding to meeting and task requests is set to "Enabled (Automatically Deny)""
$ExpectedValue = "1"
