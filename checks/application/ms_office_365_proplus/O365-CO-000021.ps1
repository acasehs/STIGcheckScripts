...
.EXAMPLE
    .\O365-CO-000021.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000021.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000021"
    Rule_Title = "Object Caching Protection must be enabled in all Office programs."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\software\microsoft\internet explorer\main\featurecontrol\feature_object_caching"
