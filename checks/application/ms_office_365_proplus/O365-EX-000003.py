...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000003",
        "Rule_Title": "Dynamic Data Exchange (DDE) server launch in Excel must be blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000003 - Dynamic Data Exchange (DDE) server launch in Excel must be blocked.",
