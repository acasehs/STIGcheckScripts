...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000011",
        "Rule_Title": "Files in unsafe locations must be opened in Protected view in PowerPoint.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\protectedview"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000011 - Files in unsafe locations must be opened in Protected view in PowerPoint.",
