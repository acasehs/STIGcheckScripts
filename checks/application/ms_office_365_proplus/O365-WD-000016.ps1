...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: In Word, macros must be blocked from running, even if Enable all macro...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Word 2016 >> Word Options >> Security >> Trust Center "Block macros from running in Office files from the Internet" is set to "Enabled"."
$ExpectedValue = "1"
