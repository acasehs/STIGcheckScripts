...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PU-000002",
        "Rule_Title": "Publisher must automatically disable unsigned add-ins without informing users.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\publisher\security"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PU-000002 - Publisher must automatically disable unsigned add-ins without informing users.",
