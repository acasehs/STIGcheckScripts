...
.EXAMPLE
    .\O365-CO-000010.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000010.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000010"
    Rule_Title = "Users must be prevented from creating new trusted locations in the Trust Center."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
