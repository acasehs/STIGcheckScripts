...
.EXAMPLE
    .\O365-EX-000022.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000022.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\excel\options_x000D_
#>
...
$result = @{
    STIG_ID = "O365-EX-000022"
    Rule_Title = "AutoRepublish warning alert in Excel must be enabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\excel\options_x000D_"
