...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Extraction options must be blocked when opening corrupt Excel workbook...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\excel\options"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Data Recovery >> Do not show data extraction options when opening corrupt workbooks is set to "Enabled"."
$ExpectedValue = "1"
