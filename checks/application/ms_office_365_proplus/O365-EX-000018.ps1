...
.EXAMPLE
    .\O365-EX-000018.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000018.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000018"
    Rule_Title = "Extraction options must be blocked when opening corrupt Excel workbooks."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
