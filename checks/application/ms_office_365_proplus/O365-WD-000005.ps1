...
.EXAMPLE
    .\O365-WD-000005.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000005.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000005"
    Rule_Title = "If file validation fails, files must be opened in Protected view in Word with ability to edit disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
