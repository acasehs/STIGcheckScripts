...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000007",
        "Rule_Title": "Macros from the Internet must be blocked from running in PowerPoint.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000007 - Macros from the Internet must be blocked from running in PowerPoint.",
