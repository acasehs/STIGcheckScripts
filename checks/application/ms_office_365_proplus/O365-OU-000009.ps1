...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Internet must not be included in Safe Zone for picture download in Out...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\outlook\options\mail"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Automatic Picture Download Settings >> Include Internet in Safe Zones for Automatic Picture Download is set to "Disabled"."
$ExpectedValue = "1"
