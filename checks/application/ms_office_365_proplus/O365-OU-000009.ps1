...
.EXAMPLE
    .\O365-OU-000009.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000009.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-OU-000009"
    Rule_Title = "Internet must not be included in Safe Zone for picture download in Outlook."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
