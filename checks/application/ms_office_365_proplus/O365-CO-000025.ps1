...
.EXAMPLE
    .\O365-CO-000025.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000025.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000025"
    Rule_Title = "The Save from URL feature must be enabled in all Office programs."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
