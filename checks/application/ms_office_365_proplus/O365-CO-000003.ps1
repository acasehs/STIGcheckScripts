...
.EXAMPLE
    .\O365-CO-000003.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000003.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\common\portal_x000D_
#>
...
$result = @{
    STIG_ID = "O365-CO-000003"
    Rule_Title = "The Office client must be prevented from polling the SharePoint Server for published links."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
