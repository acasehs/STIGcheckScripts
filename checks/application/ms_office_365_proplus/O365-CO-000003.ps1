...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The Office client must be prevented from polling the SharePoint Server...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\common\portal_x000D_"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Server Settings >> Disable the Office client from polling the SharePoint Server for published links is set to "Enabled"._x000D_"
$ExpectedValue = "1"
