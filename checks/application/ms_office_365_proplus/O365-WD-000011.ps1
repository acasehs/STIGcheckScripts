...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Open/Save of Word 2007 and later binary documents and templates must b...
...
$RegPath = "HKCU\Software\Policies\Microsoft\Office\16.0\word\security\fileblock"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Word 2016 >> Word Options >> Security >> Trust Center >> File Block Settings "Word 2007 and later binary documents and templates" is set to "Enabled: Open/Save blocked, use open policy"."
$ExpectedValue = "1"
