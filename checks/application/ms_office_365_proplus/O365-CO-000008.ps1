...
.EXAMPLE
    .\O365-CO-000008.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000008.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000008"
    Rule_Title = "Office applications must be configured to specify encryption type in password-protected Office 97-2003 files."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
