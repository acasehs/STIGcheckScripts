...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-CO-000006",
        "Rule_Title": "Macros in all Office applications that are opened programmatically by another application must be opened based upon macro security level.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\Common\Security"
        value_name = "AutomationSecurity"
        expected_value = 2
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-CO-000006 - Macros in all Office applications that are opened programmatically by another application must be opened based upon macro security level.",
