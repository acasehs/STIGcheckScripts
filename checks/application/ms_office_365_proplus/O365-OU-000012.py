...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000012",
        "Rule_Title": "The warning about invalid digital signatures must be enabled to warn Outlook users.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000012 - The warning about invalid digital signatures must be enabled to warn Outlook users.",
