...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000016",
        "Rule_Title": "The display of Level 1 attachments must be disabled in Outlook.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000016 - The display of Level 1 attachments must be disabled in Outlook.",
