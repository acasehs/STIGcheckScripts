...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000024",
        "Rule_Title": "Scan of encrypted macros in Excel Open XML workbooks must be enabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000024 - Scan of encrypted macros in Excel Open XML workbooks must be enabled.",
