...
.EXAMPLE
    .\O365-PT-000012.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-PT-000012.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-PT-000012"
    Rule_Title = "If file validation fails, files must be opened in Protected view in PowerPoint with ability to edit disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
