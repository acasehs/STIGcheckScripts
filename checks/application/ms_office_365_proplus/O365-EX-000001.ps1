...
$RegPath = "HKCU\Software\Policies\Microsoft\Office\16.0\excel\security\trusted"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> Trusted Locations "Allow Trusted Locations on the network" is set to "Disabled"."
$ExpectedValue = "1"
