...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files in unsafe locations must be opened in Protected view in PowerPoi...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft PowerPoint 2016 >> PowerPoint Options >> Security >> Trust Center >> Protected View "Do not open files in unsafe locations in Protected View" is set to "Disabled"."
$ExpectedValue = "1"
