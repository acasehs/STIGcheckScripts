...
.EXAMPLE
    .\O365-CO-000012.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000012.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000012"
    Rule_Title = "Office applications must not load XML expansion packs with Smart Documents."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
