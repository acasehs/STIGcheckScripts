...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Office applications must not load XML expansion packs with Smart Docum...
...
$RegPath = "HKCU\software\policies\microsoft\office\common\smart"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Smart Documents (Word, Excel) >> Disable Smart Document's use of manifests is set to "Enabled"."
$ExpectedValue = "1"
