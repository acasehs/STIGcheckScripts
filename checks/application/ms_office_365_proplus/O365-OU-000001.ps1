...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The Exchange client authentication with Exchange servers must be enabl...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Account Settings >> Exchange >> Authentication with Exchange Server is set to Kerberos Password Authentication."
$ExpectedValue = "1"
