...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: When an untrusted program attempts to send e-mail programmatically usi...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Security Form Settings >> Programmatic Security >> Configure Outlook object model prompt when sending mail is set to "Enabled (Automatically Deny)"."
$ExpectedValue = "1"
