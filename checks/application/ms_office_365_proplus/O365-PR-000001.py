...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PR-000001",
        "Rule_Title": "Trusted Locations on the network must be disabled in Project.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\ms project\security\trusted locations"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PR-000001 - Trusted Locations on the network must be disabled in Project.",
