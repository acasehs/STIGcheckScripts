...
Registry Check:
    ...
    Value: XL9597WorkbooksandTemplates
    Type: REG_DWORD
    Expected: 2
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000015",
        "Rule_Title": "Open/save of Excel 95-97 workbooks and templates must be blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "XL9597WorkbooksandTemplates"
        expected_value = 2
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000015 - Open/save of Excel 95-97 workbooks and templates must be blocked.",
