...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-CO-000007",
        "Rule_Title": "Trust Bar notifications must be configured to display information in the Message Bar about the content that has been automatically blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\common\trustcenter"
        value_name = "trustbar"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-CO-000007 - Trust Bar notifications must be configured to display information in the Message Bar about the content that has been automatically blocked.",
