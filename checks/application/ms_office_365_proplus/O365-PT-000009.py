...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000009",
        "Rule_Title": "Files downloaded from the Internet must be opened in Protected view in PowerPoint.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000009 - Files downloaded from the Internet must be opened in Protected view in PowerPoint.",
