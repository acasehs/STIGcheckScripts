...
.EXAMPLE
    .\O365-OU-000003.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000003.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-OU-000003"
    Rule_Title = "Scripts associated with public folders must be prevented from execution in Outlook."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
