...
.EXAMPLE
    .\O365-LY-000002.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-LY-000002.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKLM:\Software\Policies\Microsoft\office\16.0\lync"
    $regValueName = "disablehttpconnect"
    $expectedValue = 1
