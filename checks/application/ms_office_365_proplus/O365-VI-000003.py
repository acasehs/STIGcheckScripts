...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-VI-000003",
        "Rule_Title": "Visio must automatically disable unsigned add-ins without informing users.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\visio\security"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-VI-000003 - Visio must automatically disable unsigned add-ins without informing users.",
