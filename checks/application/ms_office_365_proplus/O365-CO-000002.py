...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-CO-000002",
        "Rule_Title": "Document metadata for rights managed Office Open XML files must be protected.",
        "Severity": "high",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-CO-000002 - Document metadata for rights managed Office Open XML files must be protected.",
