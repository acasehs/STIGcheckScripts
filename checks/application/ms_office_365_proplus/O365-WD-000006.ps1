...
.EXAMPLE
    .\O365-WD-000006.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-WD-000006.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-WD-000006"
    Rule_Title = "Word attachments opened from Outlook must be in Protected View."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
