...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000013",
        "Rule_Title": "The use of network locations must be ignored in PowerPoint.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\trusted locations"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000013 - The use of network locations must be ignored in PowerPoint.",
