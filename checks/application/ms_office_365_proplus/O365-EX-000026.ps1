...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: WEBSERVICE Function Notification in Excel must be configured to disabl...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> WEBSERVICE Function Notification Settings is set to "Enabled" and "Disable all with notification"."
$ExpectedValue = "1"
