...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PT-000004",
        "Rule_Title": "The default file block behavior must be set to not open blocked files in PowerPoint.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\PowerPoint\security\fileblock"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PT-000004 - The default file block behavior must be set to not open blocked files in PowerPoint.",
