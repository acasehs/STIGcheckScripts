...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-WD-000008",
        "Rule_Title": "Open/Save of Word 2 and earlier binary documents and templates must be blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-WD-000008 - Open/Save of Word 2 and earlier binary documents and templates must be blocked.",
