...
.EXAMPLE
    .\O365-EX-000020.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000020.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000020"
    Rule_Title = "Loading of pictures from Web pages not created in Excel must be disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
