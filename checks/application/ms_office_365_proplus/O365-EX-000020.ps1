...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Loading of pictures from Web pages not created in Excel must be disabl...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\excel\internet"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Advanced >> Web Options... >> General."
$ExpectedValue = "1"
