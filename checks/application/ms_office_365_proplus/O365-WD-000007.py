...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-WD-000007",
        "Rule_Title": "The default file block behavior must be set to not open blocked files in Word.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\word\security\fileblock"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-WD-000007 - The default file block behavior must be set to not open blocked files in Word.",
