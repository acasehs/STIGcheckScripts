...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-PR-000002",
        "Rule_Title": "Project must automatically disable unsigned add-ins without informing users.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\ms project\security"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-PR-000002 - Project must automatically disable unsigned add-ins without informing users.",
