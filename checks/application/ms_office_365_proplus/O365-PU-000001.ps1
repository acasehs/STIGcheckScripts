...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Publisher must be configured to prompt the user when another applicati...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Publisher 2016 >> Security >> Publisher Automation Security Level is set to "Enabled" "By UI (prompted)"."
$ExpectedValue = "1"
