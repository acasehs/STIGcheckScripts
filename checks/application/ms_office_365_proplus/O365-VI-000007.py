...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-VI-000007",
        "Rule_Title": "Macros must be blocked from running in Visio files from the Internet.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-VI-000007 - Macros must be blocked from running in Visio files from the Internet.",
