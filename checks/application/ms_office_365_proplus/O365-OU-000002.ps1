...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Outlook must use remote procedure call (RPC) encryption to communicate...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Account Settings >> Exchange >> Enable RPC encryption is set to "Enabled"."
$ExpectedValue = "1"
