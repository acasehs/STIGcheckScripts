...
.EXAMPLE
    .\O365-OU-000002.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000002.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-OU-000002"
    Rule_Title = "Outlook must use remote procedure call (RPC) encryption to communicate with Microsoft Exchange servers."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
