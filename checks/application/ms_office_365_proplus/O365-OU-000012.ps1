...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The warning about invalid digital signatures must be enabled to warn O...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Cryptography >> Signature Warning is set to "Enabled" "Always warn about invalid signatures"."
$ExpectedValue = "1"
