...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Open/Save of PowerPoint 97-2003 presentations, shows, templates, and a...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\powerpoint\security\fileblock_x000D_"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft PowerPoint 2016 >> PowerPoint Options >> Security >> Trust Center >> File Block Settings >> PowerPoint 97-2003 presentations, shows, templates and add-in files is set to "Enabled" "Open/Save blocked, use open policy"._x000D_"
$ExpectedValue = "1"
