...
.EXAMPLE
    .\O365-PT-000003.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-PT-000003.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\powerpoint\security\fileblock_x000D_
#>
...
$result = @{
    STIG_ID = "O365-PT-000003"
    Rule_Title = "Open/Save of PowerPoint 97-2003 presentations, shows, templates, and add-in files must be blocked."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
