...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Scripts associated with shared folders must be prevented from executio...
...
$RegValue = "for sharedfolderscript is set to REG_DWORD = 0, this is not a finding."
$ExpectedValue = "1"
