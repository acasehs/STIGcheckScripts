...
.EXAMPLE
    .\O365-OU-000004.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000004.ps1 -OutputJson
...
.NOTES
    ...
    Registry Check:
    Key: HKCU\software\policies\microsoft\office\16.0\outlook\security_x000D_
#>
...
$result = @{
    STIG_ID = "O365-OU-000004"
    Rule_Title = "Scripts associated with shared folders must be prevented from execution in Outlook."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\office\16.0\outlook\security_x000D_"
