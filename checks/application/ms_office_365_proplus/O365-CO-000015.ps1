...
.EXAMPLE
    .\O365-CO-000015.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-CO-000015.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-CO-000015"
    Rule_Title = "Consistent MIME handling must be enabled for all Office 365 ProPlus programs."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\software\microsoft\internet explorer\main\featurecontrol\feature_mime_handling"
