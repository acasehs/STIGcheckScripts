...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000017",
        "Rule_Title": "Open/save of Web pages and Excel 2003 XML spreadsheets must be blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000017 - Open/save of Web pages and Excel 2003 XML spreadsheets must be blocked.",
