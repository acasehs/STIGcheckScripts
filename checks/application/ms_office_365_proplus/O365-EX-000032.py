...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-EX-000032",
        "Rule_Title": "Files from unsafe locations must be opened in Excel in Protected View mode.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\microsoft\office\16.0\excel\security\protectedview"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-EX-000032 - Files from unsafe locations must be opened in Excel in Protected View mode.",
