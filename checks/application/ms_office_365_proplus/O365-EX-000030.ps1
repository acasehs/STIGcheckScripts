...
.EXAMPLE
    .\O365-EX-000030.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000030.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000030"
    Rule_Title = "Untrusted database files must be opened in Excel in Protected View mode."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
