...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Untrusted database files must be opened in Excel in Protected View mod...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> Protected View >> Always open untrusted database files in Protected View is set to "Enabled"."
$ExpectedValue = "1"
