...
.EXAMPLE
    .\O365-EX-000033.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000033.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000033"
    Rule_Title = "Files failing file validation must be opened in Excel in Protected view mode and disallow edits."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
