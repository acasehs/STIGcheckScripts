...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-WD-000001",
        "Rule_Title": "Word must automatically disable unsigned add-ins without informing users.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-WD-000001 - Word must automatically disable unsigned add-ins without informing users.",
