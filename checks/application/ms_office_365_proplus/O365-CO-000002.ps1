...
.DESCRIPTION
    ...
    Severity: high
    Rule Title: Document metadata for rights managed Office Open XML files must be pro...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Security Settings "Protect document metadata for rights managed Office Open XML Files" is set to "Enabled"."
$ExpectedValue = "1"
