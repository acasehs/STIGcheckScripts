...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000011",
        "Rule_Title": "The minimum encryption key length in Outlook must be at least 168.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000011 - The minimum encryption key length in Outlook must be at least 168.",
