...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Macros in all Office applications that are opened programmatically by ...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Security Settings "Automation Security" is set to "Enabled (Use application macro security level)"."
$ExpectedValue = "1"
