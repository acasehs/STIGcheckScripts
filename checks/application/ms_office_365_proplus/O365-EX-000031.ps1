...
.EXAMPLE
    .\O365-EX-000031.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-EX-000031.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-EX-000031"
    Rule_Title = "Files from Internet zone must be opened in Excel in Protected View mode."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
