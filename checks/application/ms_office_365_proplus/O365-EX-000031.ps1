...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files from Internet zone must be opened in Excel in Protected View mod...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> Protected View >> Do not open files from the Internet zone in Protected View is set to "Disabled"."
$ExpectedValue = "1"
