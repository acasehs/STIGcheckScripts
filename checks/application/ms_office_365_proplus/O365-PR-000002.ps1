...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Project must automatically disable unsigned add-ins without informing ...
...
$RegPath = "HKCU\software\policies\Microsoft\office\16.0\ms"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Project 2016 >> Project Options >> Security >> Trust Center >> "Disable Trust Bar Notification for unsigned application add-ins and block them" is set to "Enabled"."
$ExpectedValue = "1"
