...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-AC-000001",
        "Rule_Title": "Macros must be blocked from running in Access files from the Internet.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-AC-000001 - Macros must be blocked from running in Access files from the Internet.",
