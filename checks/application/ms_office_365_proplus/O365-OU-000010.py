...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    """
    result = {
        "STIG_ID": "O365-OU-000010",
        "Rule_Title": "The Publish to Global Address List (GAL) button must be disabled in Outlook.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="O365-OU-000010 - The Publish to Global Address List (GAL) button must be disabled in Outlook.",
