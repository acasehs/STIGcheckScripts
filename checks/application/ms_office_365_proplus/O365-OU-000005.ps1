...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Files dragged from an Outlook e-mail to the file system must be create...
...
$RegPath = "HKCU\software\policies\microsoft\office\16.0\outlook\options\general"
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Outlook Options >> Other >> Advanced >> Use Unicode format when dragging e-mail message to file system is set to "Disabled"."
$ExpectedValue = "1"
