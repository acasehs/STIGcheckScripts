...
.EXAMPLE
    .\O365-OU-000005.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-OU-000005.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-OU-000005"
    Rule_Title = "Files dragged from an Outlook e-mail to the file system must be created in ANSI format."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
