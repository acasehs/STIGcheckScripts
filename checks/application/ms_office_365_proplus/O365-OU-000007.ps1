...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: Active X One-Off forms must only be enabled to load with Outlook Contr...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Allow Active X One Off Forms is set to "Enabled" "Load only Outlook Controls"."
$ExpectedValue = "1"
