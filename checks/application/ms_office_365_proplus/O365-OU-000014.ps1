...
.DESCRIPTION
    ...
    Severity: medium
    Rule Title: The Outlook Security Mode must be enabled to always use the Outlook Se...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Security >> Security Form Settings >> Outlook Security Mode is set to "Enabled (Use Outlook Security Group Policy)"."
$ExpectedValue = "1"
