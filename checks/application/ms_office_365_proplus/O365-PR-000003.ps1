...
.EXAMPLE
    .\O365-PR-000003.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\O365-PR-000003.ps1 -OutputJson
...
$result = @{
    STIG_ID = "O365-PR-000003"
    Rule_Title = "VBA Macros not digitally signed must be blocked in Project."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
