...
# STIG Check: V-221293
# Severity: medium
# Rule Title: OHS must have the log rotation parameter set to allow generated information to be used by external applications or entities to monitor and control remote access.
# STIG ID: OH12-1X-000023
# Rule ID: SV-221293r960765
#
# Description:
...
echo "TODO: Implement check for V-221293"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the log rotation parameter set to allow generated information to be used by external applications or entities to monitor and control remote access.",
  "status": "$STATUS",
