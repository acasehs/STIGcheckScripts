...
# Severity: medium
# Rule Title: OHS must have the Directory directive accompanying the DocumentRoot di...
#
...
# Check for directive
DIRECTIVE="<Directory ${ORACLE_INSTANCE}/config/fmwconfig/components/${COMPONENT_TYPE}/instances/${COMPONENT_NAME}/htdocs"
