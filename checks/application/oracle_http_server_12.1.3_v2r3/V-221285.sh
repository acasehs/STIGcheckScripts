...
# STIG Check: V-221285
# Severity: medium
# Rule Title: OHS must have the SecureProxy directive enabled to protect the integrity of remote sessions when integrated with WebLogic in accordance with the categorization of data hosted by the web server.
# STIG ID: OH12-1X-000015
# Rule ID: SV-221285r960762
#
# Description:
...
echo "TODO: Implement check for V-221285"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the SecureProxy directive enabled to protect the integrity of remote sessions when integrated with WebLogic in accordance with the categorization of data hosted by the web server.",
  "status": "$STATUS",
