...
# STIG Check: V-221292
# Severity: medium
# Rule Title: OHS must have the OraLogSeverity directive defined to generate adequate information to be used by external applications or entities to monitor and control remote access.
# STIG ID: OH12-1X-000022
# Rule ID: SV-221292r960765
#
# Description:
...
echo "TODO: Implement check for V-221292"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the OraLogSeverity directive defined to generate adequate information to be used by external applications or entities to monitor and control remote access.",
  "status": "$STATUS",
