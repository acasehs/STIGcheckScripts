...
Description:
    Protection of log data includes assuring log data is not accidentally lost or deleted. Backing up log records to an unrelated system or onto separate media than the system the web server is actually running on helps to assure that, in the event of a catastrophic system failure, the log records will ...
...
SEVERITY = "medium"
RULE_TITLE = """The log data and records from OHS must be backed up onto a different system or media."""
