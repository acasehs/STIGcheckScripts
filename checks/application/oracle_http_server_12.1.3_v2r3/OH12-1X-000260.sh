...
# STIG Check: V-221493
# Severity: medium
# Rule Title: OHS must have the SSLCipherSuite directive enabled to meet the requirements of applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance for such authentica
...
The web server must provide FIPS-compliant encryption modules when authentica
#
# Check Content:
...
main() {
    ...
    echo "Rule: OHS must have the SSLCipherSuite directive enabled to meet the requirements of applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance for such authentica"
