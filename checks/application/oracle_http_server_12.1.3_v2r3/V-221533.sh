...
# STIG Check: V-221533
# Severity: medium
# Rule Title: OHS must have the SSLFIPS directive enabled to maintain the confidentiality and integrity of information during preparation for transmission.
# STIG ID: OH12-1X-000325
# Rule ID: SV-221533r961638
#
# Description:
...
echo "TODO: Implement check for V-221533"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the SSLFIPS directive enabled to maintain the confidentiality and integrity of information during preparation for transmission.",
  "status": "$STATUS",
