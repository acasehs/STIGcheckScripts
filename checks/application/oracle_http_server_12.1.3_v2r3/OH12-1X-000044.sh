...
# STIG Check: V-221307
# Severity: medium
# Rule Title: OHS must have the log rotation parameter set to allow for the generation log records for system startup and shutdown, system access, and system authentication events.
# STIG ID: OH12-1X-000044
# Rule ID: SV-221307r960879
#
# Description:
...
main() {
    ...
    echo "Rule: OHS must have the log rotation parameter set to allow for the generation log records for system startup and shutdown, system access, and system authentication events."
