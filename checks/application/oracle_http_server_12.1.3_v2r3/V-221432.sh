...
# STIG Check: V-221432
# Severity: medium
# Rule Title: OHS must be set to evaluate deny directives first when considering whether to serve a file.
# STIG ID: OH12-1X-000194
# Rule ID: SV-221432r961863
#
# Description:
...
echo "TODO: Implement check for V-221432"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must be set to evaluate deny directives first when considering whether to serve a file.",
  "status": "$STATUS",
