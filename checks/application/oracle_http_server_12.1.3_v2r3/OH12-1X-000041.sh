...
# STIG Check: V-221304
# Severity: medium
# Rule Title: OHS must have OraLogMode set to Oracle Diagnostic Logging text mode to generate log records for system startup and shutdown, system access, and system authentication logging.
# STIG ID: OH12-1X-000041
# Rule ID: SV-221304r960879
#
# Description:
...
main() {
    ...
    echo "Rule: OHS must have OraLogMode set to Oracle Diagnostic Logging text mode to generate log records for system startup and shutdown, system access, and system authentication logging."
