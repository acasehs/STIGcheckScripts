...
# STIG ID: OH12-1X-000150
# Rule ID: SV-221397r960963
#
# Description:
...
#
# Check Content:
#     If the AO-approved system security plan for the web server configuration specifies using proxy_module directive in order to meet application architecture requirements, this requirement is NA._x000D_
_x000D_
1. Open $DOMAIN_HOME/config/fmwconfig/components/OHS/<componentName>/httpd.conf with an editor._x000D_
_x000D_
2. Search for the \"LoadModule proxy_module\" directive at the OHS server configuration scope._x000D_
_x000D_
