...
The web server must protect the log data from unauthorized deletion. This can be done by the web se
#
# Check Content:
...
main() {
    ...
    echo "Rule: The log information from OHS must be protected from unauthorized deletion."
