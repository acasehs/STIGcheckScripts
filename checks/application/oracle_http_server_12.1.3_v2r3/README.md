# Oracle HTTP Server 12.1.3 v2r3 - STIG Automation Framework

## Overview

Automated STIG compliance checks for **Oracle HTTP Server 12.1.3 Version 2 Release 3**.
...
# With JSON output
bash V-221272.sh --output-json results.json

# With configuration file
bash V-221272.sh --config stig-config.json
```
...
1. Domain expertise for Oracle HTTP Server 12.1.3
...
1. Open the check script (V-221272.sh or V-221272.py)
...
```
oracle_http_server_12.1.3_v2r3/
├── README.md (this file)
├── V-221272.sh (bash check)
├── V-221272.py (python check)
└── ... (280 checks total)
```
