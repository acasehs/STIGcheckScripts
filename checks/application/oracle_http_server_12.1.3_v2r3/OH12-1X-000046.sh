...
# STIG Check: V-221309
# Severity: medium
# Rule Title: OHS must have a SSL log format defined to generate adequate logs by system startup and shutdown, system access, and system authentication events.
# STIG ID: OH12-1X-000046
# Rule ID: SV-221309r960879
#
# Description:
...
main() {
    ...
    echo "Rule: OHS must have a SSL log format defined to generate adequate logs by system startup and shutdown, system access, and system authentication events."
