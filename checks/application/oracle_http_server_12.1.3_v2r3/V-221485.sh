...
# STIG Check: V-221485
# Severity: medium
# Rule Title: OHS must be integrated with a tool such as Oracle Access Manager to enforce a client-side certificate revocation check through the OCSP protocol.
# STIG ID: OH12-1X-000251
# Rule ID: SV-221485r961038
#
# Description:
...
echo "TODO: Implement check for V-221485"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must be integrated with a tool such as Oracle Access Manager to enforce a client-side certificate revocation check through the OCSP protocol.",
  "status": "$STATUS",
