...
# STIG Check: V-221374
# Severity: medium
# Rule Title: OHS must have the LoadModule userdir_module directive disabled.
# STIG ID: OH12-1X-000127
# Rule ID: SV-221374r960963
#
# Description:
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the LoadModule userdir_module directive disabled.",
  "status": "$STATUS",
