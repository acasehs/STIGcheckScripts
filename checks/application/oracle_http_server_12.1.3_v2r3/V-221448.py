...
Description:
    Private web servers, which host sites that serve controlled access data, must be protected from outside threats in addition to insider threats. Insider threat may be accidental or intentional but, in either case, can cause a disruption in service of the web server. To protect the private web server ...
...
SEVERITY = "medium"
RULE_TITLE = """A private OHS installation must be located on a separate controlled access subnet."""
