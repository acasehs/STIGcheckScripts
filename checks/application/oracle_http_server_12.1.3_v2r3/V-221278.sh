...
# STIG Check: V-221278
# Severity: high
# Rule Title: OHS must have the SSLFIPS directive enabled to encrypt remote connections in accordance with the categorization of data hosted by the web server.
# STIG ID: OH12-1X-000008
# Rule ID: SV-221278r960759
#
# Description:
...
echo "TODO: Implement check for V-221278"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must have the SSLFIPS directive enabled to encrypt remote connections in accordance with the categorization of data hosted by the web server.",
  "status": "$STATUS",
