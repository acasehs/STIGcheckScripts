...
# STIG Check: V-221479
# Severity: medium
# Rule Title: OHS must use FIPS modules to perform RFC 5280-compliant certification path validation.
# STIG ID: OH12-1X-000245
# Rule ID: SV-221479r961038
#
# Description:
...
echo "TODO: Implement check for V-221479"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "OHS must use FIPS modules to perform RFC 5280-compliant certification path validation.",
  "status": "$STATUS",
