...
STIG Check: V-221495
Severity: high
Rule Title: OHS accounts accessing the directory tree, the shell, or other operating system functions and utilities must only be administrative accounts.
STIG ID: OH12-1X-000266
Rule ID: SV-221495r961095
...
# Check metadata
VULN_ID = "V-221495"
STIG_ID = "OH12-1X-000266"
SEVERITY = "high"
RULE_TITLE = """OHS accounts accessing the directory tree, the shell, or other operating system functions and utilities must only be administrative accounts."""
