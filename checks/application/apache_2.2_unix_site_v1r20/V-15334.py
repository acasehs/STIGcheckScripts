...
Description:
    Failure to comply with DoD ports, protocols, and services (PPS) requirements can result_x000D_ in compromise of enclave boundary protections and/or functionality of the AIS._x000D_ _x000D_ The IAM will ensure web servers are configured to use only authorized PPS in accordance with the Network Infras...
