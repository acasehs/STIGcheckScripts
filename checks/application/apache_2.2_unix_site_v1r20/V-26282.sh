...
#
# Check Content:
#     Enter the following command:_x000D_ _x000D_ grep \"LogLevel\" /usr/local/apache2/conf/httpd.conf_x000D_ _x000D_ The command should return the following value: _x000D_ _x000D_ LogLevel warn_x000D_ _x000D_ If the above value is not returned, this is a finding._x000D_ Note:  If LogLevel is set to error, crit, alert, or emerg which are higher thresholds this is not a finding._x000D_
#
# Exit Codes:
...
echo "TODO: Implement Apache check for V-26282"
