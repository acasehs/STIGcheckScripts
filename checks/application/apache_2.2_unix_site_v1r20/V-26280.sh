...
#
# Check Content:
#     Enter the following command:_x000D_ _x000D_ grep \"LogFormat\" /usr/local/apache2/conf/httpd.conf._x000D_ _x000D_ The command should return the following value: _x000D_ _x000D_ LogFormat \"%a %A %h %H %l %m %s %t %u %U \\\"%{Referer}i\\\" \" combined._x000D_ _x000D_ If the above value is not returned, this is a finding.
#
# Exit Codes:
...
echo "TODO: Implement Apache check for V-26280"
