...
#
# Description:
#     Transport Layer Security (TLS) encryption is a required security setting for a private web server.  Encryption of private information is essential to ensuring data confidentiality.  If private information is not encrypted, it can be intercepted and easily read by an unauthorized party.  A private we...
#
# Check Content:
#     Enter the following command:_x000D_ _x000D_ /usr/local/apache2/bin/httpd â€“M |grep -i ssl_x000D_ _x000D_ This will provide a list of all the loaded modules. Verify that the â€œssl_moduleâ€ is loaded. If this module is not found, determine if it is loaded as a dynamic module. Enter the following command:_x000D_ _x000D_ grep ^LoadModule /usr/local/apache2/conf/httpd.conf_x000D_ _x000D_ If the SSL ...
#
# Exit Codes:
...
# Enter the following command:_x000D_ _x000D_ /usr/local/apache2/bin/httpd â€“M |grep -i ssl_x000D_ _x000D_ This will provide a list of all the loaded modules. Verify that the â€œssl_moduleâ€ is loaded. If this module is not found, determine if it is loaded as a dynamic module. Enter the following command:_x000D_ _x000D_ grep ^LoadModule /usr/local/apache2/conf/httpd.conf_x000D_ _x000D_ If the SSL module is not enabled this is a finding. _x000D_ _x000D_ After determining that the ssl module is ac...
#
...
echo "TODO: Implement Apache check for V-2262"
