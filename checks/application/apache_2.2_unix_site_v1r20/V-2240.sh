...
#
# Check Content:
#     To view the MaxKeepAliveRequests value, enter the following command: _x000D_ _x000D_ grep \"MaxKeepAliveRequests\" /usr/local/apache2/conf/httpd.conf _x000D_ _x000D_ If the returned value of MaxKeepAliveRequests is not set to 100 or greater, this is a finding. _x000D_
#
# Exit Codes:
...
echo "TODO: Implement Apache check for V-2240"
