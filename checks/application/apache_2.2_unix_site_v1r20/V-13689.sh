...
#
# Description:
#     A major tool in exploring the web site use, attempted use, unusual conditions, and problems are the access and error logs. In the event of a security incident, these logs can provide the SA and the web administrator with valuable information. Because of the information that is captured in the logs, ...
#
# Check Content:
#     Look for the presence of log files at:_x000D_ _x000D_ /usr/local/apache/logs/access_log _x000D_ _x000D_ To ensure the correct location of the log files, examine the \"ServerRoot\" directive in the htttpd.conf file and then navigate to that directory where you will find a subdirectory for the logs. _x000D_ _x000D_ Determine permissions for log files, from the command line: cd to the directory where t...
#
# Exit Codes:
...
# Look for the presence of log files at:_x000D_ _x000D_ /usr/local/apache/logs/access_log _x000D_ _x000D_ To ensure the correct location of the log files, examine the \"ServerRoot\" directive in the htttpd.conf file and then navigate to that directory where you will find a subdirectory for the logs. _x000D_ _x000D_ Determine permissions for log files, from the command line: cd to the directory where the log files are located and enter the command: _x000D_ _x000D_ ls â€“al *log and note the owner and...
#
...
echo "TODO: Implement Apache check for V-13689"
