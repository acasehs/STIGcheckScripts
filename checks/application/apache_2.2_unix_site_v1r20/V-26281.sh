...
#
# Description:
#     The server error logs are invaluable because they can also be used to identify potential problems and enable proactive remediation. Log data can reveal anomalous behavior such as â€œnot foundâ€ or â€œunauthorizedâ€ errors that may be an evidence of attack attempts.   Failure to enable error loggin...
#
# Check Content:
#     Enter the following command:_x000D_ _x000D_ grep \"CustomLog\" /usr/local/apache2/conf/httpd.conf_x000D_ _x000D_ The command should return the following value:._x000D_ _x000D_ CustomLog \"Logs/access_log\" common_x000D_ _x000D_ If the above value is not returned, this is a finding._x000D_
#
# Exit Codes:
...
echo "TODO: Implement Apache check for V-26281"
