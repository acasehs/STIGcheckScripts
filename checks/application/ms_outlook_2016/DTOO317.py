...
Registry Check:
    ...
    Value: NoCheckOnSessionSecurity
    Type: REG_DWORD
    Expected: 1
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO317",
        "Rule_Title": "Replies or forwards to signed/encrypted messages must be signed/encrypted.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "NoCheckOnSessionSecurity"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO317 - Replies or forwards to signed/encrypted messages must be signed/encrypted.",
