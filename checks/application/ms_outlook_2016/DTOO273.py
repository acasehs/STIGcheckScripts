#!/usr/bin/env python3
"""
DTOO273 - IE Trusted Zones assumed trusted must be blocked.

STIG ID: DTOO273
Rule Title: IE Trusted Zones assumed trusted must be blocked.
Severity: medium
Vuln ID: V-228461
Rule ID: SV-228461r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO273",
        "Rule_Title": "IE Trusted Zones assumed trusted must be blocked.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO273 - IE Trusted Zones assumed trusted must be blocked.",
