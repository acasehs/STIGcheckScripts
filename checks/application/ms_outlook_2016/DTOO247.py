...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO247",
        "Rule_Title": "Custom Outlook Object Model (OOM) action execution prompts must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO247 - Custom Outlook Object Model (OOM) action execution prompts must be configured.",
