#!/usr/bin/env python3
"""
DTOO266 - Automatic sending  s/Mime receipt requests must be disallowed.

STIG ID: DTOO266
Rule Title: Automatic sending  s/Mime receipt requests must be disallowed.
Severity: medium
Vuln ID: V-228456
Rule ID: SV-228456r508021
...
Registry Check:
    ...
    Value: RespondToReceiptRequests
    Type: REG_DWORD
    Expected: 2
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO266",
        "Rule_Title": "Automatic sending  s/Mime receipt requests must be disallowed.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "RespondToReceiptRequests"
        expected_value = 2
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO266 - Automatic sending  s/Mime receipt requests must be disallowed.",
