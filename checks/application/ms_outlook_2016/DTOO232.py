...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO232",
        "Rule_Title": "Outlook Object Model scripts must be disallowed to run for shared folders.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO232 - Outlook Object Model scripts must be disallowed to run for shared folders.",
