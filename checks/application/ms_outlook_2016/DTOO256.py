#!/usr/bin/env python3
"""
DTOO256 - Trusted add-ins behavior for email must be configured.

STIG ID: DTOO256
Rule Title: Trusted add-ins behavior for email must be configured.
Severity: medium
Vuln ID: V-228451
Rule ID: SV-228451r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO256",
        "Rule_Title": "Trusted add-ins behavior for email must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO256 - Trusted add-ins behavior for email must be configured.",
