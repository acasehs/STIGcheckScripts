...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\outlook\options\autoformat_x000D_"
        value_name = "pgrfafo_25_1"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO425 - Text in Outlook that represents internet and network paths must not be automatically turned into hyperlinks.",
