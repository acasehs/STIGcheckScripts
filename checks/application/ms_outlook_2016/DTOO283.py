#!/usr/bin/env python3
"""
DTOO283 - Disabling download full text of articles as HTML must be configured.

STIG ID: DTOO283
Rule Title: Disabling download full text of articles as HTML must be configured.
Severity: medium
Vuln ID: V-228468
Rule ID: SV-228468r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO283",
        "Rule_Title": "Disabling download full text of articles as HTML must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\outlook\options\rss"
        value_name = "EnableFullTextHTML"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO283 - Disabling download full text of articles as HTML must be configured.",
