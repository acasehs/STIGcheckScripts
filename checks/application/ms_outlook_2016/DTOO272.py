#!/usr/bin/env python3
"""
DTOO272 - Permit download of content from safe zones must be configured.

STIG ID: DTOO272
Rule Title: Permit download of content from safe zones must be configured.
Severity: medium
Vuln ID: V-228460
Rule ID: SV-228460r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO272",
        "Rule_Title": "Permit download of content from safe zones must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO272 - Permit download of content from safe zones must be configured.",
