<#
.SYNOPSIS
    DTOO284 - Automatic download of Internet Calendar appointment attachments must be disallowed.
...
.EXAMPLE
    .\DTOO284.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO284.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO284"
    Rule_Title = "Automatic download of Internet Calendar appointment attachments must be disallowed."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\outlook\options\webcal"
    $regValueName = "EnableAttachments"
    $expectedValue = 0
