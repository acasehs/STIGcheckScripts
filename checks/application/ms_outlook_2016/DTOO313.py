#!/usr/bin/env python3
"""
DTOO313 - Automatically downloading enclosures on RSS must be disallowed.

STIG ID: DTOO313
Rule Title: Automatically downloading enclosures on RSS must be disallowed.
Severity: medium
Vuln ID: V-228472
Rule ID: SV-228472r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO313",
        "Rule_Title": "Automatically downloading enclosures on RSS must be disallowed.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO313 - Automatically downloading enclosures on RSS must be disallowed.",
