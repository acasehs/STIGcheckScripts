...
Registry Check:
    ...
    Value: PromptOOMAddressInformationAccess
    Type: REG_DWORD
    Expected: 0
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO251",
        "Rule_Title": "Object Model Prompt behavior for programmatic access of user address data must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "PromptOOMAddressInformationAccess"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO251 - Object Model Prompt behavior for programmatic access of user address data must be configured.",
