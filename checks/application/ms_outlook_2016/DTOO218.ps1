...
.EXAMPLE
    .\DTOO218.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO218.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\outlook\options\pubcal"
    $regValueName = "PublishCalendarDetailsPolicy"
    $expectedValue = 4000 (hex) or 16384 (Decimal)
