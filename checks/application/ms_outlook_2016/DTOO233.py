...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO233",
        "Rule_Title": "Outlook Object Model scripts must be disallowed to run for public folders.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO233 - Outlook Object Model scripts must be disallowed to run for public folders.",
