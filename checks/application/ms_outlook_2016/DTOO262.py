#!/usr/bin/env python3
"""
DTOO262 - Run in FIPS compliant mode must be enforced.

STIG ID: DTOO262
Rule Title: Run in FIPS compliant mode must be enforced.
Severity: medium
Vuln ID: V-228454
Rule ID: SV-228454r559729
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO262",
        "Rule_Title": "Run in FIPS compliant mode must be enforced.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO262 - Run in FIPS compliant mode must be enforced.",
