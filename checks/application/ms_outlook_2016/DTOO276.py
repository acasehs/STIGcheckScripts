#!/usr/bin/env python3
"""
DTOO276 - Always warn on untrusted macros must be enforced.

STIG ID: DTOO276
Rule Title: Always warn on untrusted macros must be enforced.
Severity: medium
Vuln ID: V-228464
Rule ID: SV-228464r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO276",
        "Rule_Title": "Always warn on untrusted macros must be enforced.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO276 - Always warn on untrusted macros must be enforced.",
