#!/usr/bin/env python3
"""
DTOO279 - RPC encryption between Outlook and Exchange server must be enforced.

STIG ID: DTOO279
Rule Title: RPC encryption between Outlook and Exchange server must be enforced.
Severity: medium
Vuln ID: V-228466
Rule ID: SV-228466r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO279",
        "Rule_Title": "RPC encryption between Outlook and Exchange server must be enforced.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\outlook\rpc"
        value_name = "EnableRPCEncryption"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO279 - RPC encryption between Outlook and Exchange server must be enforced.",
