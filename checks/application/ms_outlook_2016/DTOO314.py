...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO314",
        "Rule_Title": "The default message format must be set to use Plain Text.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\outlook\options\mail_x000D_"
        value_name = "EditorPreference"
        expected_value = 65536 (dec)
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO314 - The default message format must be set to use Plain Text.",
