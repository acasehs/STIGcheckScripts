...
.EXAMPLE
    .\DTOO283.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO283.ps1 -OutputJson
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\outlook\options\rss"
    $regValueName = "EnableFullTextHTML"
    $expectedValue = 0
