#!/usr/bin/env python3
"""
DTOO270 - External content and pictures in HTML email must be displayed.

STIG ID: DTOO270
Rule Title: External content and pictures in HTML email must be displayed.
Severity: medium
Vuln ID: V-228458
Rule ID: SV-228458r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO270",
        "Rule_Title": "External content and pictures in HTML email must be displayed.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO270 - External content and pictures in HTML email must be displayed.",
