...
Registry Check:
    ...
    Value: PromptOOMMeetingTaskRequestResponse
    Type: REG_DWORD
    Expected: 0
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO252",
        "Rule_Title": "Object Model Prompt behavior for Meeting and Task Responses must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        value_name = "PromptOOMMeetingTaskRequestResponse"
        expected_value = 0
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO252 - Object Model Prompt behavior for Meeting and Task Responses must be configured.",
