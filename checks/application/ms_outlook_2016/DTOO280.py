#!/usr/bin/env python3
"""
DTOO280 - Outlook must be configured to force authentication when connecting to an Exchange server.

STIG ID: DTOO280
Rule Title: Outlook must be configured to force authentication when connecting to an Exchange server.
Severity: medium
Vuln ID: V-228467
Rule ID: SV-228467r508021
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO280",
        "Rule_Title": "Outlook must be configured to force authentication when connecting to an Exchange server.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        expected_value = 16 (decimal) or 10 (hex)
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO280 - Outlook must be configured to force authentication when connecting to an Exchange server.",
