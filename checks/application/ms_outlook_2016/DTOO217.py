...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO217",
        "Rule_Title": "Publishing to a Web Distributed and Authoring (DAV) server must be prevented.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO217 - Publishing to a Web Distributed and Authoring (DAV) server must be prevented.",
