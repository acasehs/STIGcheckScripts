...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO320",
        "Rule_Title": "Check e-mail addresses against addresses of certificates being used must be disallowed.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO320 - Check e-mail addresses against addresses of certificates being used must be disallowed.",
