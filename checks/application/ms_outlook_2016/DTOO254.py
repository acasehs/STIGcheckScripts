...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO254",
        "Rule_Title": "Object Model Prompt behavior for accessing User Property Formula must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO254 - Object Model Prompt behavior for accessing User Property Formula must be configured.",
