...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO239",
        "Rule_Title": "Outlook Security Mode must be configured to use Group Policy settings.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO239 - Outlook Security Mode must be configured to use Group Policy settings.",
