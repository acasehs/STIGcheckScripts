...
Registry Check:
    ...
    Value: PublishCalendarDetailsPolicy
    Type: REG_DWORD
    Expected: 4000 (hex) or 16384 (Decimal)
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO218",
        "Rule_Title": "Level of calendar details that a user can publish must be restricted.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\outlook\options\pubcal"
        value_name = "PublishCalendarDetailsPolicy"
        expected_value = 4000 (hex) or 16384 (Decimal)
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO218 - Level of calendar details that a user can publish must be restricted.",
