...
.EXAMPLE
    .\DTOO410.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO410.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO410"
    Rule_Title = "When using the Office Feedback tool, the ability to include a screenshot must be disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\Microsoft\office\16.0\common\feedback"
