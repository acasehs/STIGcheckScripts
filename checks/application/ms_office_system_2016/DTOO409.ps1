...
.DESCRIPTION
    STIG ID: DTOO409
    Severity: medium
    Rule Title: The ability to create an online presentation programmatically must be ...
...
$RegValue = "for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Present Online -> "Restrict programmatic access for creating online presentations in PowerPoint and Word" is set to "Enabled"."
$ExpectedValue = "1"
