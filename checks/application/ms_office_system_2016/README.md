# Microsoft Office System 2016 STIG Automation Framework

## Overview

This directory contains automated compliance check scripts for the Microsoft Office System 2016 Security Technical Implementation Guide (STIG).
...
Before running checks, ensure that Office 2016 is installed on the system. Checks primarily validate:
...
Most Office 2016 STIG checks validate Windows Registry settings. Common registry locations include:
...
Most Office 2016 STIG checks are **highly automatable** because they primarily involve:
