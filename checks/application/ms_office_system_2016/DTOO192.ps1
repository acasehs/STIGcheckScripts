...
.EXAMPLE
    .\DTOO192.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO192.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO192"
    Rule_Title = "Load controls in forms3 must be disabled from loading."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\microsoft\vba\security"
