...
.EXAMPLE
    .\DTOO201.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO201.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO201"
    Rule_Title = "Connection verification of permissions must be enforced."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\common\drm"
    $regValueName = "RequireConnection"
    $expectedValue = 1
