...
.EXAMPLE
    .\DTOO189.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO189.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO189"
    Rule_Title = "The encryption type for password protected Open XML files must be set."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
