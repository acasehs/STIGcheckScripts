...
.DESCRIPTION
    ...
    Severity: medium
    Vuln ID: V-238029
    Rule ID: SV-238029r961128

    This script checks Microsoft Office System 2016 configuration compliance.
...
.EXAMPLE
    .\DTOO190.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO190.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO190"
    Rule_Title = "The encryption type for password protected Office 97 thru Office 2003 must be set."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\common\security"
    $regValueName = "DefaultEncryption12"
    $expectedValue = "Microsoft Enhanced RSA and AES Cryptographic Provider
