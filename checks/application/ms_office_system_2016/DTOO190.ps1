...
.DESCRIPTION
    STIG ID: DTOO190
    Severity: medium
    Rule Title: The encryption type for password protected Office 97 thru Office 2003 ...
...
$RegValue = "for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Security Settings "Encryption type for password protected Office 97-2003 files" is set to "Enabled (Microsoft Enhanced RSA and AES Cryptographic Provider,AES 256,256)"."
$ExpectedValue = "1"
