...
.DESCRIPTION
    STIG ID: DTOO416
    Severity: medium
    Rule Title: The Office Telemetry Agent must be configured to obfuscate the file na...
...
$RegValue = "for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Telemetry Dashboard >> "Turn on privacy setting in Office Telemetry Agent" is set to "Enabled"."
$ExpectedValue = "1"
