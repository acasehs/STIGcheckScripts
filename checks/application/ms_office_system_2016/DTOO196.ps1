...
.EXAMPLE
    .\DTOO196.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO196.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO196"
    Rule_Title = "A mix of policy and user locations for Office Products must be disallowed."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\common\security\trusted locations"
