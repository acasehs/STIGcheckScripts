...
.EXAMPLE
    .\DTOO197.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO197.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO197"
    Rule_Title = "Smart Documents use of Manifests in Office must be disallowed."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\Common\Smart Tag"
    $regValueName = "NeverLoadManifests"
    $expectedValue = 1
