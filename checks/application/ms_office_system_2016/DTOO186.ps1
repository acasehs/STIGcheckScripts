...
.EXAMPLE
    .\DTOO186.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO186.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO186"
    Rule_Title = "Trust Bar notifications for Security messages must be enforced."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
