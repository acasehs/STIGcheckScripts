...
.DESCRIPTION
    STIG ID: DTOO206
    Severity: medium
    Rule Title: Inclusion of document properties for PDF and XPS output must be disall...
...
$RegValue = "for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Microsoft Save As PDF and XPS add-ins "Disable inclusion of document properties in PDF and XPS output" is set to "Enabled"."
$ExpectedValue = "1"
