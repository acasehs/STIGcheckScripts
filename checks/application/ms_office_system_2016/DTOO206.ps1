...
.EXAMPLE
    .\DTOO206.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO206.ps1 -OutputJson
...
.NOTES
    ...
    Value: DisableFixedFormatDocProperties
    Type: REG_DWORD
    Expected: 1
#>
...
$result = @{
    STIG_ID = "DTOO206"
    Rule_Title = "Inclusion of document properties for PDF and XPS output must be disallowed."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\common\fixedformat"
    $regValueName = "DisableFixedFormatDocProperties"
    $expectedValue = 1
