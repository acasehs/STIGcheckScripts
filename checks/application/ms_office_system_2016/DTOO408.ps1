...
.EXAMPLE
    .\DTOO408.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO408.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO408"
    Rule_Title = "Office Presentation Service must be removed as an option for presenting PowerPoint and Word online."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\Microsoft\office\16.0\common\broadcast "
    $regValueName = "disabledefaultservice"
    $expectedValue = 1
