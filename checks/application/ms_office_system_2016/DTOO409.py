...
Registry Check:
    ...
    Value: disableprogrammaticaccess
    Type: REG_DWORD
    Expected: 1
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO409",
        "Rule_Title": "The ability to create an online presentation programmatically must be disabled.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\software\policies\Microsoft\office\16.0\common\broadcast "
        value_name = "disableprogrammaticaccess"
        expected_value = 1
        value_type = "DWORD"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO409 - The ability to create an online presentation programmatically must be disabled.",
