...
.EXAMPLE
    .\DTOO187.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO187.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO187"
    Rule_Title = "Rights managed Office Open XML files must be protected."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regValueName = "DRMEncryptProperty"
    $expectedValue = 1
