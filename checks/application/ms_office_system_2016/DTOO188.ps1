...
.EXAMPLE
    .\DTOO188.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO188.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO188"
    Rule_Title = "Document metadata for password protected files must be protected."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regValueName = "OpenXMLEncryptProperty"
    $expectedValue = 1
