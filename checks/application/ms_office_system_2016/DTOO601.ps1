...
.EXAMPLE
    .\DTOO601.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO601.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO601"
    Rule_Title = "The ability to send personal information to Office must be disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\Microsoft\office\16.0\common"
    $regValueName = "sendcustomerdata"
    $expectedValue = 0
