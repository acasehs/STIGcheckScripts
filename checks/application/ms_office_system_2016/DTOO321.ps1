...
.EXAMPLE
    .\DTOO321.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO321.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO321"
    Rule_Title = "Encrypt document properties must be configured for OLE documents."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
