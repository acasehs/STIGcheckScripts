...
.DESCRIPTION
    STIG ID: DTOO412
    Severity: medium
    Rule Title: The ability to run unsecure Office web add-ins and Catalogs must be di...
...
$RegValue = "for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Security Settings -> Trust Center -> Trusted Catalogs "Allow Unsecure web add-ins and Catalogs" is set to "Disabled"."
$ExpectedValue = "1"
