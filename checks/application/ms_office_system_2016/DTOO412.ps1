...
.EXAMPLE
    .\DTOO412.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO412.ps1 -OutputJson
...
.NOTES
    ...
    Value: requireserververification
    Type: REG_DWORD
    Expected: 1
#>
...
$result = @{
    STIG_ID = "DTOO412"
    Rule_Title = "The ability to run unsecure Office web add-ins and Catalogs must be disabled."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\software\policies\Microsoft\office\16.0\wef\trustedcatalogs"
    $regValueName = "requireserververification"
    $expectedValue = 1
