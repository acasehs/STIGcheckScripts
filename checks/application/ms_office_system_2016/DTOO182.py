...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO182",
        "Rule_Title": "The Help Improve Proofing Tools feature for Office must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\common\ptwatson"
        value_name = "PTWOptIn"
        expected_value = 0
        value_type = "DWORD"
