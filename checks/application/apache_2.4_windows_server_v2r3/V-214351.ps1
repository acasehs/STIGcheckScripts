...
#
# Description:
# If time stamps are not consistently applied and there is no common time reference, it is difficult to perform forensic analysis across multiple devices and log records._x000D_ _x000D_ Time stamps generated by the Apache web server include date and time. Time is commonly expressed in UTC, a modern co...
#
...
# Configuration
$VulnID = "V-214351"
$StigID = "AS24-W1-000760"
$Severity = "medium"
$RuleTitle = "The Apache web server must generate log records that can be mapped to Coordinated Universal Time (UTC) or Greenwich Mean Time (GMT) with a minimum granularity of one second."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214351.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
