...
#
# Description:
# When accounts used for web server features such as documentation, sample code, example applications, tutorials, utilities, and services are created even though the feature is not installed, they become an exploitable threat to a web server.  These accounts become inactive, are not monitored through ...
#
...
# Configuration
$VulnID = "V-214322"
$StigID = "AS24-W1-000280"
$Severity = "high"
$RuleTitle = "Apache web server application directories,  libraries, and configuration files must only be accessible to privileged users."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214322.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
