...
#
# Description:
# Reviewing log data allows an investigator to recreate the path of an attacker and to capture forensic data for later use. Log data is also essential to system administrators in their daily administrative duties on the hosted system or within the hosted applications.  If the logging system begins to ...
#
...
# Configuration
$VulnID = "V-214313"
$StigID = "AS24-W1-000160"
$Severity = "medium"
$RuleTitle = "The Apache web server must use a logging mechanism that is configured to alert the (ISSO) and System Administrator (SA) in the event of a processing failure."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214313.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
