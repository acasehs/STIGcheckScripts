...
#
# Description:
# Apache web server can limit the ability of the web server being used in a DoS attack through several methods. The methods employed will depend upon the hosted applications and their resource needs for proper operation.  An example setting that could be used to limit the ability of the web server bei...
#
...
# Configuration
$VulnID = "V-214338"
$StigID = "AS24-W1-000590"
$Severity = "medium"
$RuleTitle = "The Apache web server must restrict the ability of users to launch denial-of-service (DoS) attacks against other information systems or networks."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214338.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
