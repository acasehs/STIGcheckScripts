...
# Configuration
$VulnID = "V-214353"
$StigID = "AS24-W1-000820"
$Severity = "medium"
$RuleTitle = "The Apache web server must be protected from being stopped by a non-privileged user."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214353.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
