...
# Configuration
$VulnID = "V-214308"
$StigID = "AS24-W1-000030"
$Severity = "medium"
$RuleTitle = "The Apache web server must use encryption strength in accordance with the categorization of data hosted by the Apache web server when remote connections are provided."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214308.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
