...
# Check metadata
VULN_ID = "V-214346"
STIG_ID = "AS24-W1-000700"
SEVERITY = "medium"
RULE_TITLE = """An Apache web server that is part of a web server cluster must route all remote management through a centrally managed access control point."""
