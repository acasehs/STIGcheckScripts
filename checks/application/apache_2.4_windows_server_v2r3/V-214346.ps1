...
#
# Description:
# A web server cluster is a group of independent Apache web servers that are managed as a single system for higher availability, easier manageability, and greater scalability. Without having centralized control of the web server cluster, management of the cluster becomes difficult. It is critical that...
#
...
# Configuration
$VulnID = "V-214346"
$StigID = "AS24-W1-000700"
$Severity = "medium"
$RuleTitle = "An Apache web server that is part of a web server cluster must route all remote management through a centrally managed access control point."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214346.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
