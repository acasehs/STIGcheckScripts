...
# Configuration
$VulnID = "V-214335"
$StigID = "AS24-W1-000530"
$Severity = "medium"
$RuleTitle = "The Apache web server must generate unique session identifiers with definable entropy."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214335.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
