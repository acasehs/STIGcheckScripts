...
#
# Description:
# During an attack on the Apache web server or any of the hosted applications, the system administrator may need to disconnect or disable access by users to stop the attack.  The Apache web server must be configured to disconnect users to a hosted application without compromising other hosted applicat...
#
...
# Configuration
$VulnID = "V-214344"
$StigID = "AS24-W1-000680"
$Severity = "medium"
$RuleTitle = "The Apache web server must be configured to immediately disconnect or disable remote access to the hosted applications."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214344.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
