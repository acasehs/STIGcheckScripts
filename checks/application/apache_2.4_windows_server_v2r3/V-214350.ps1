...
#
# Description:
# It is critical for the appropriate personnel to be aware if a system is at risk of failing to process logs as required. Log processing failures include software/hardware errors, failures in the log capturing mechanisms, and log storage capacity being reached or exceeded. _x000D_ _x000D_ If log capac...
#
...
# Configuration
$VulnID = "V-214350"
$StigID = "AS24-W1-000740"
$Severity = "medium"
$RuleTitle = "The Apache web server must use a logging mechanism that is configured to provide a warning to the Information System Security Officer (ISSO) and System Administrator (SA) when allocated record storage volume reaches 75 percent of maximum log record storage capacity."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214350.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
