...
#
# Description:
# The server error logs are invaluable because they can also be used to identify potential problems and enable proactive remediation. Log data can reveal anomalous behavior such as `"not found`" or `"unauthorized`" errors that may be an evidence of attack attempts. Failure to enable error logging can sign...
#
...
# Configuration
$VulnID = "V-214309"
$StigID = "AS24-W1-000065"
$Severity = "medium"
$RuleTitle = "System logging must be enabled."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214309.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
