...
# Configuration
$VulnID = "V-214348"
$StigID = "AS24-W1-000720"
$Severity = "medium"
$RuleTitle = "The Apache web server must not impede the ability to write specified log record content to an audit log server."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214348.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
