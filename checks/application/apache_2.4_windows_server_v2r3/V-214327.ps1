...
#
# Description:
# Data used to authenticate, especially passwords, needs to be protected at all times, and encryption is the standard method for protecting authentication data during transmission. Data used to authenticate can be passed to and from the web server for many reasons.  Examples include data passed from a...
#
...
# Configuration
$VulnID = "V-214327"
$StigID = "AS24-W1-000370"
$Severity = "medium"
$RuleTitle = "The Apache web server must encrypt passwords during transmission."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214327.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
