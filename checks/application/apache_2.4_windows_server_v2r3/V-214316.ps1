...
# Configuration
$VulnID = "V-214316"
$StigID = "AS24-W1-000210"
$Severity = "medium"
$RuleTitle = "The log data and records from the Apache web server must be backed up onto a different system or media."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214316.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
