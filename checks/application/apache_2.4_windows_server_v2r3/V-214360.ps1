# STIG Check: V-214360
# STIG ID: AS24-W1-000970
# Severity: medium
# Rule Title: The Apache web server must alert the ISSO and SA (at a minimum) in the event of an audit processing failure.
#
# Description:
# It is critical for the appropriate personnel to be aware if a system is at risk of failing to process audit logs as required. Without this notification, the security personnel may be unaware of an impending failure of the audit capability and system operation may be adversely affected.  Audit proces...
#
...
# Configuration
$VulnID = "V-214360"
$StigID = "AS24-W1-000970"
$Severity = "medium"
$RuleTitle = "The Apache web server must alert the ISSO and SA (at a minimum) in the event of an audit processing failure."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214360.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
