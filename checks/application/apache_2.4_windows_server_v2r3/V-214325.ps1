...
#
# Description:
# A web server can be installed with functionality that, just by its nature, is not secure. WebDAV is an extension to the HTTP protocol that, when developed, was meant to allow users to create, change, and move documents on a server, typically a web server or web share. Allowing this functionality, de...
#
...
# Configuration
$VulnID = "V-214325"
$StigID = "AS24-W1-000330"
$Severity = "medium"
$RuleTitle = "The Apache web server must have Web Distributed Authoring (WebDAV) disabled."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214325.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
