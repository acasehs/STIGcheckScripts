...
# Check metadata
VULN_ID = "V-214360"
STIG_ID = "AS24-W1-000970"
SEVERITY = "medium"
RULE_TITLE = """The Apache web server must alert the ISSO and SA (at a minimum) in the event of an audit processing failure."""
