...
# Configuration
$VulnID = "V-214319"
$StigID = "AS24-W1-000250"
$Severity = "medium"
$RuleTitle = "The Apache web server must only contain services and functions necessary for operation."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214319.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
