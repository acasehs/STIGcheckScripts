...
# Configuration
$VulnID = "V-214321"
$StigID = "AS24-W1-000270"
$Severity = "high"
$RuleTitle = "The Apache web server must provide install options to exclude the installation of documentation, sample code, example applications, and tutorials."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214321.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
