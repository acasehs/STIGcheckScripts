...
# Configuration
$VulnID = "V-214315"
$StigID = "AS24-W1-000200"
$Severity = "medium"
$RuleTitle = "The log information from the Apache web server must be protected from unauthorized deletion and modification."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214315.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
