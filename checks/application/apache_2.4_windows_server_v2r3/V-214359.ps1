...
#
# Description:
# Many vulnerabilities are associated with olderÂ versions of web server software. As hot fixes and patches are issued, these solutions are included in the nextÂ versionÂ of the server software. Maintaining the web server at a current version makes the efforts of a malicious user to exploit the web se...
#
...
# Configuration
$VulnID = "V-214359"
$StigID = "AS24-W1-000960"
$Severity = "high"
$RuleTitle = "The Apache web server software must be a vendor-supported version."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-214359.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
