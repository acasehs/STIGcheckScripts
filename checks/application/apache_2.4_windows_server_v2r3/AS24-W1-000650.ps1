...
For SSL virtual hosts, the handshake timeout values is the time needed t
...
try {
    ...
    Write-Output "Rule: The Apache web server must set an inactive timeout for completing the TLS handshake"
