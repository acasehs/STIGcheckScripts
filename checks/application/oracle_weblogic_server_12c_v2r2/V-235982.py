...
STIG ID: WBLC-08-000218
Rule ID: SV-235982r961620
...
Check Content:
    1. Access AC  2. From 'Domain Structure', select 'Deployments'  3. Select a deployed component which contains publicly available information and/or applications 4. Select 'Targets' tab 5. Ensure one or more of the selected targets for this deployment is a cluster of managed servers  If the informati...
...
# Check metadata
VULN_ID = "V-235982"
STIG_ID = "WBLC-08-000218"
SEVERITY = "medium"
RULE_TITLE = """Oracle WebLogic must protect the integrity and availability of publicly available information and applications."""
