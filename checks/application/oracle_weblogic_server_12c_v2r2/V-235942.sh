...
# STIG ID: WBLC-02-000073
# Rule ID: SV-235942r960891
#
# Description:
...
echo "TODO: Implement check for V-235942"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must produce process events and severity levels to establish what type of HTTPD-related events and severity levels occurred.",
  "status": "$STATUS",
