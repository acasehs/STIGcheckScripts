...
# STIG ID: WBLC-02-000098
# Rule ID: SV-235957r960939
#
# Description:
...
echo "TODO: Implement check for V-235957"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must protect audit tools from unauthorized access.",
  "status": "$STATUS",
