...
# STIG ID: WBLC-05-000168
# Rule ID: SV-235971r961029
#
# Description:
#     Passwords need to be protected at all times, and encryption is the standard method for protecting passwords during transmission.   Application servers have the capability to utilize either certificates (tokens) or user IDs and passwords in order to authenticate. When the application server transmits...
#
# Check Content:
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must encrypt passwords during transmission.",
  "status": "$STATUS",
