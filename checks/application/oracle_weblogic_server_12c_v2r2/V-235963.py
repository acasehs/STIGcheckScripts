...
STIG ID: WBLC-03-000129
Rule ID: SV-235963r961863

Description:
    The application server must provide a capability to halt or otherwise disable the automatic execution of deployed applications until such time that the application is considered part of the established application server baseline. Deployment to the application server should not provide a means for a...
...
# Check metadata
VULN_ID = "V-235963"
STIG_ID = "WBLC-03-000129"
SEVERITY = "low"
RULE_TITLE = """Oracle WebLogic must utilize automated mechanisms to prevent program execution on the information system."""
