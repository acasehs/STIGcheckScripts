...
# Rule ID: SV-235999r961863
#
# Description:
#     Multifactor authentication is defined as: using two or more factors to achieve authentication.   Factors include:  (i) something a user knows (e.g., password/PIN);  (ii) something a user has (e.g., cryptographic identification device, token); or  (iii) something a user is (e.g., biometric). A CAC me...
#
# Check Content:
...
echo "TODO: Implement check for V-235999"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must be integrated with a tool to implement multi-factor user authentication.",
  "status": "$STATUS",
