...
echo "TODO: Implement check for V-235970"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must enforce password complexity by the number of special characters used.",
  "status": "$STATUS",
