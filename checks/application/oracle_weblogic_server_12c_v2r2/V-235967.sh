...
# STIG ID: WBLC-05-000162
# Rule ID: SV-235967r961863
#
# Description:
...
echo "TODO: Implement check for V-235967"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must enforce password complexity by the number of upper-case characters used.",
  "status": "$STATUS",
