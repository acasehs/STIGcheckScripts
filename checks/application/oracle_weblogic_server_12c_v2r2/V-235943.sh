...
# STIG ID: WBLC-02-000074
# Rule ID: SV-235943r960891
#
# Description:
...
echo "TODO: Implement check for V-235943"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "Oracle WebLogic must produce audit records containing sufficient information to establish what type of JVM-related events and severity levels occurred.",
  "status": "$STATUS",
