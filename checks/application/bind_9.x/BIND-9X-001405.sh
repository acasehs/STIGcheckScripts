...
echo "TODO: Implement BIND 9.x check for BIND-9X-001405"
...
Severity: ${SEVERITY^^}
================================================================================
Rule: A BIND 9.x implementation operating in a split DNS configuration must be approved by the organizations Authorizing Official.
Status: $STATUS
Timestamp: $TIMESTAMP
