...
If the â€œnotify explicitâ€ statement is missing, this is a finding.
If the \"also-notify\" statement is missing, this is a
#
# Exit Codes:
...
main() {
    ...
    echo "Rule: The master servers in a BIND 9.x implementation must notify authorized secondary name servers when zone files are updated."
