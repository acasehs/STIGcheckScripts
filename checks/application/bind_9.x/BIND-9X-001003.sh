...
#
# Description:
#     Failure to provide logical access restrictions associated with changes to application configuration may have significant effects on the overall security of the system. When dealing with access restrictions pertaining to change control, it should be noted that any changes to the hardware, software, a...
#
# Check Content:
...
echo "TODO: Implement BIND 9.x check for BIND-9X-001003"
    ...
    cat > "$OUTPUT_JSON" << EOF_JSON
{
  ...
  "stig_id": "$STIG_ID",
  "severity": "$SEVERITY",
  "rule_title": "The BIND 9.x server software must run with restricted privileges.",
  "status": "$STATUS",
...
Severity: ${SEVERITY^^}
================================================================================
Rule: The BIND 9.x server software must run with restricted privileges.
Status: $STATUS
Timestamp: $TIMESTAMP
