...
echo "TODO: Implement BIND 9.x check for BIND-9X-001042"
...
Severity: ${SEVERITY^^}
================================================================================
Rule: The BIND 9.x server implementation must maintain at least 3 file versions of the local log file.
Status: $STATUS
Timestamp: $TIMESTAMP
