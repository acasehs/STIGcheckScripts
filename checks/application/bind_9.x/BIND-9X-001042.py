...
Check Content:
    Verify that the BIND 9.x server is configured to retain at least 3 versions of the local log file.  Inspect the "named.conf" file for the following:  logging { channel local_file_channel { file "path_name" versions 3; };  If the "versions" variable is not defined, this is a finding.  If the "version...
...
# Check metadata
VULN_ID = "V-207548"
STIG_ID = "BIND-9X-001042"
SEVERITY = "low"
RULE_TITLE = """The BIND 9.x server implementation must maintain at least 3 file versions of the local log file."""
