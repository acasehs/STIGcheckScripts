...
$StigID = "WG140 W22"
$Severity = "medium"
$RuleTitle = "Private web servers must require certificates issued from a DoD-authorized Certificate Authority."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-6531.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
