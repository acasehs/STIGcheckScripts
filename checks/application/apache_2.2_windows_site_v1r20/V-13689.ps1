...
$StigID = "WG255 W22"
$Severity = "medium"
$RuleTitle = "Access to the web server log files must be restricted to Administrators, the user assigned to run the web server software, Web Manager, and Auditors."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-13689.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
