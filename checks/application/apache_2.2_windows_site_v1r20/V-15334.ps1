...
#
# Description:
# Failure to comply with DoD ports, protocols, and services (PPS) requirements can result in compromise of enclave boundary protections and/or functionality of the automated information system (AIS)._x000D_ _x000D_ The IAM will ensure web servers are configured to use only authorized PPS in accordance...
#
...
$StigID = "WG610 W22"
$Severity = "low"
$RuleTitle = "Web sites must utilize ports, protocols, and services according to PPSM guidelines."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-15334.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
