...
STIG_ID = "WG290 W22"
SEVERITY = "high"
RULE_TITLE = """The web client account access to the content and scripts directories must be limited to read and execute."""
...
def run_check(config=None):
    ...
    # Locate the Apache httpd.conf file._x000D_ _x000D_ If unable to locate the file, perform a search of the system to find the location of the file._x000D_ _x000D_ Open the httpd.conf file with an editor such as Notepad, and search for the following uncommented directives:  DocumentRoot, Alias, ScriptAlias, & ScriptAliasMatch _x000D_ _x000D_ Navigate to the locations specified after each enabled DocumentRoot, Alias, ScriptAlias, & ScriptAliasMatch directives. _x000D_ Right click on the file or direc...
    #
