...
$StigID = "WG235 W22"
$Severity = "high"
$RuleTitle = "Web Administrators must only use encrypted connections for Document Root directory uploads."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-13686.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
