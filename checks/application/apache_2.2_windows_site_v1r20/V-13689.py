...
Description:
    A major tool in exploring the web site use, attempted use, unusual conditions and problems are the access and error logs. In the event of a security incident, these logs can provide the SA and Web Manager with valuable information. Because of the information that is captured in the logs, it is criti...

Check Content:
    Determine permissions for log files_x000D_ _x000D_ Find the httpd.conf configuration file to determine the location of the log files. The location is indicated at the "ServerRoot" directive. The log directory is a sub-directory under the ServerRoot. _x000D_ _x000D_ ex. :\Apache Group\Apache2\logs or :\Apache Software Foundation\Apache2.2\logs_x000D_ _x000D_ After locating the logs, use the Explore...
...
STIG_ID = "WG255 W22"
SEVERITY = "medium"
RULE_TITLE = """Access to the web server log files must be restricted to Administrators, the user assigned to run the web server software, Web Manager, and Auditors."""
...
def run_check(config=None):
    ...
    # Determine permissions for log files_x000D_ _x000D_ Find the httpd.conf configuration file to determine the location of the log files. The location is indicated at the "ServerRoot" directive. The log directory is a sub-directory under the ServerRoot. _x000D_ _x000D_ ex. :\Apache Group\Apache2\logs or :\Apache Software Foundation\Apache2.2\logs_x000D_ _x000D_ After locating the logs, use the Explorer to move to these files and examine their properties: _x000D_ _x000D_ Properties >> Security >> Per...
    #
