...
$StigID = "WG205 W22"
$Severity = "medium"
$RuleTitle = "The web document (home) directory must be in a separate partition from the web serverâ€™s system files."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-3333.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
