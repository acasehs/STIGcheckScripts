...
#
# Description:
# The server error logs are invaluable because they can also be used to identify potential problems and enable proactive remediation.  Log data can reveal anomalous behavior such as  â€œnot foundâ€ or â€œunauthorizedâ€ errors that may be an evidence of attack attempts.   Failure to enable error logg...
#
...
$StigID = "WA00620 W22"
$Severity = "medium"
$RuleTitle = "The LogLevel directive must be enabled."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-26282.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
