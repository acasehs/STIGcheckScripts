...
#
# Description:
# The use of CGI scripts represent one of the most common and exploitable means of compromising a web server. By definition, CGI scripts are executable by the operating system of the host server. While access control is provided via the web service, the execution of CGI programs is not limited unless ...
#
...
$StigID = "WG410 W22"
$Severity = "medium"
$RuleTitle = "Interactive scripts used on a web server must have proper access controls."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2229.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
