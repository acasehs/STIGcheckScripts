...
#
# Description:
# A major tool in exploring the web site use, attempted use, unusual conditions and problems are the access and error logs. In the event of a security incident, these logs can provide the SA and Web_x000D_ Manager with valuable information. To ensure the integrity of the log files and protect the SA a...
#
...
$StigID = "WG250 W22"
$Severity = "medium"
$RuleTitle = "Log file access must be restricted to System Administrators, Web Administrators or Auditors."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2252.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
