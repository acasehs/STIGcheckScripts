...
$StigID = "WG400 W22"
$Severity = "medium"
$RuleTitle = "All interactive programs must be placed in a designated directory with appropriate permissions."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2228.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
