...
$StigID = "WG310 W22"
$Severity = "medium"
$RuleTitle = "A web site must not contain a robots.txt file."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2260.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
