...
$StigID = "WG230 W22"
$Severity = "high"
$RuleTitle = "Web server administration must be performed over a secure path or at the local console."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2249.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
