...
$StigID = "WA00605 W22"
$Severity = "medium"
$RuleTitle = "Error logging must be enabled."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-26279.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
