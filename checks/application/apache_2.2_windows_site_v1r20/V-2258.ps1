...
$StigID = "WG290 W22"
$Severity = "high"
$RuleTitle = "The web client account access to the content and scripts directories must be limited to read and execute."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2258.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
