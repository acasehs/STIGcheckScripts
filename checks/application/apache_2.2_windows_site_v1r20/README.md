# Apache 2.2 Windows Site v1r20 - STIG Automation Framework

## Overview

Automated STIG compliance checks for **Apache 2.2 Windows Site Version 1 Release 20**.
...
.\V-13686.ps1 -OutputJson results.json

# Run with configuration file
.\V-13686.ps1 -ConfigFile apache-config.json
...
# Run with JSON output
python V-13686.py --output-json results.json

# Run with configuration file
python V-13686.py --config apache-config.json
```
...
1. Open the check script (V-13686.ps1 or V-13686.py)
...
```
apache_2.2_windows_site_v1r20/
├── README.md (this file)
├── V-13686.ps1 (PowerShell check - primary)
├── V-13686.py (Python check - fallback)
└── ... (28 checks total)
```
