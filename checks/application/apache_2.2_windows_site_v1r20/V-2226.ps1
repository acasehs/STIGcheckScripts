...
$StigID = "WG210 W22"
$Severity = "medium"
$RuleTitle = "Web content directories must not be anonymously shared."

# Show help
if ($Help) {
    Write-Host "Usage: .\V-2226.ps1 [-ConfigFile FILE] [-OutputJson FILE] [-Help]"
    Write-Host ""
    Write-Host "Options:"
