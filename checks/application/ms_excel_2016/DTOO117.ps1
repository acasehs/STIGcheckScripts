...
$result = @{
    STIG_ID = "DTOO117"
    Rule_Title = "Saved from URL mark to assure Internet zone processing must be enforced."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_UNC_SAVEDFILECHECK"
