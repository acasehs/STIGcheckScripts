...
.EXAMPLE
    .\DTOO145.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO145.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO145"
    Rule_Title = "Macro storage must be in personal macro workbooks."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKCU:\Software\Policies\Microsoft\Office\16.0\excel\options\binaryoptions"
    $regValueName = "fGlobalSheet_37_1"
    $expectedValue = 1
