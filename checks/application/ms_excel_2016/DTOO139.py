...
Registry Check:
    ...
    Value: DefaultFormat
    Type: REG_DWORD
    Expected: 0x00000033(hex) or 51 (Decimal)
"""
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO139",
        "Rule_Title": "The Save commands default file format must be configured.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\excel\options"
        value_name = "DefaultFormat"
        expected_value = 0x00000033(hex) or 51 (Decimal)
        value_type = "DWORD"
