...
.EXAMPLE
    .\DTOO419.ps1 -Config custom_config.json
    Run the check with custom configuration

.EXAMPLE
    .\DTOO419.ps1 -OutputJson
...
$result = @{
    STIG_ID = "DTOO419"
    Rule_Title = "Corrupt workbook options must be disallowed."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regValueName = "extractdatadisableui"
    $expectedValue = 1
