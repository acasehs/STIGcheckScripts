...
Severity: medium
Vuln ID: V-238194
Rule ID: SV-238194r879630

This script checks Microsoft Excel 2016 configuration compliance.
...
def perform_check(config: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    result = {
        "STIG_ID": "DTOO600",
        "Rule_Title": "Macros must be blocked from running in Office files from the Internet.",
        "Severity": "medium",
        "Status": "Not_Reviewed",
        "Finding_Details": "",
        "Comments": ""
    ...
    try:
        ...
        key_path = r"HKCU\Software\Policies\Microsoft\Office\16.0\excel\security"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DTOO600 - Macros must be blocked from running in Office files from the Internet.",
