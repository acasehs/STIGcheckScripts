...
$result = @{
    STIG_ID = "DTOO111"
    Rule_Title = "Enabling IE Bind to Object functionality must be present."
    Severity = "medium"
    Status = "Not_Reviewed"
    Finding_Details = ""
    Comments = ""
...
try {
    ...
    $regPath = "HKLM:\Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_SAFE_BINDTOOBJECT"
