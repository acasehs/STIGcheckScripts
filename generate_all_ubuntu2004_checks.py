#!/usr/bin/env python3
"""
Generate all Ubuntu 20.04 LTS v1r9 STIG check scripts
...
Usage:
    python3 generate_all_ubuntu2004_checks.py
    python3 generate_all_ubuntu2004_checks.py --dry-run
    python3 generate_all_ubuntu2004_checks.py --limit 10  # Generate only first 10
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate all Ubuntu 20.04 LTS v1r9 STIG checks',
    ...
    parser.add_argument('--output-dir', default='checks/os/ubuntu_20.04_lts_v1r9',
