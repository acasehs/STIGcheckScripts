#!/usr/bin/env python3
"""
Batch Oracle STIG Framework Generator
Processes all 5 Oracle products from their extracted JSON files.
"""
...
# Define all Oracle STIG products
ORACLE_STIGS = [
    {
        "name": "Oracle Linux 8",
        "version": "2",
        "release": "5",
        "json_file": "oracle_linux_8_v2r5_checks.json",
        "category": "os",
        "dir_name": "oracle_linux_8_v2r5",
        "total_checks": 374
    },
    {
        "name": "Oracle Linux 9",
        "version": "1",
        "release": "2",
        "json_file": "oracle_linux_9_v1r2_checks.json",
        "category": "os",
        "dir_name": "oracle_linux_9_v1r2",
        "total_checks": 456
    },
    {
        ...
        "version": "2",
        "release": "2",
        "json_file": "oracle_weblogic_12c_v2r2_checks.json",
        "category": "application",
        "dir_name": "oracle_weblogic_server_12c_v2r2",
        "total_checks": 73
    },
    {
        "name": "Oracle HTTP Server 12.1.3",
        "version": "2",
        "release": "3",
        "json_file": "oracle_http_server_12.1.3_v2r3_checks.json",
        "category": "application",
        "dir_name": "oracle_http_server_12.1.3_v2r3",
        "total_checks": 280
    },
    {
        ...
        "version": "1",
        "release": "2",
        "json_file": "oracle_database_19c_v1r2_checks.json",
        "category": "database",
        "dir_name": "oracle_database_19c_v1r2",
        "total_checks": 96
    }
]
...
def main():
    ...
    print("="*80)
    print("Oracle STIG Automation Framework Generator")
    print("="*80)
    print(f"Base directory: {base_dir}")
    print(f"Processing {len(ORACLE_STIGS)} Oracle products")

    summary = []
    total_checks = 0

    for stig in ORACLE_STIGS:
