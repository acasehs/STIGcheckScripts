#!/usr/bin/env python3
"""
Generate all Oracle Linux 8 v2r2 STIG check scripts
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate all Oracle Linux 8 v2r2 STIG checks',
    ...
    parser.add_argument('--output-dir', default='checks/os/oracle_linux_8_v2r2',
