#!/usr/bin/env python3
"""
Generate all Windows Server 2022 v1r3 STIG check scripts
...
Usage:
    python3 generate_all_ws2022_checks.py
    python3 generate_all_ws2022_checks.py --dry-run
    python3 generate_all_ws2022_checks.py --limit 10  # Generate only first 10
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate all Windows Server 2022 v1r3 STIG checks',
    ...
    parser.add_argument('--output-dir', default='checks/os/windows_server_2022_v1r3',
